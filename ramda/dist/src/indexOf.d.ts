...
type indexOf_00 = {
    ...
    <T$1, T$2 extends T$1 = T$1>(target: T$1, list: List<T$2>): indexOf_11;
    <$SEL extends "11">(): <T$1, T$2 extends T$1 = T$1>(target: T$1, list: List<T$2>) => indexOf_11;
    <$SEL extends "1">(): <T>(target: T) => indexOf_10<T>;
    <$SEL extends "01">(): <T>(_target: PH, list: List<T>) => indexOf_01<T>;
    <T>(target: T): indexOf_10<T>;
};
type indexOf_10<T> = {
    <T$1 extends T = T>(list: List<T$1>): indexOf_11;
};
type indexOf_01<T> = {
    (target: T): indexOf_11;
};
