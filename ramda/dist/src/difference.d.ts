...
type difference_00 = {
    ...
    <T$1, T$2 extends T$1 = T$1>(a: List<T$1>, b: List<T$2>): difference_11<T$2>;
    <$SEL extends "11">(): <T$1, T$2 extends T$1 = T$1>(a: List<T$1>, b: List<T$2>) => difference_11<T$2>;
...
type difference_10<T> = {
    <T$1 extends T = T>(b: List<T$1>): difference_11<T$1>;
};
