...
type any_00 = {
    ...
    <T$1, T$2 extends T$1 = T$1>(fn: Predicate<T$1>, list: List<T$2>): any_11;
    <$SEL extends "11">(): <T$1, T$2 extends T$1 = T$1>(fn: Predicate<T$1>, list: List<T$2>) => any_11;
    <$SEL extends "1">(): <T>(fn: Predicate<T>) => any_10<T>;
    <$SEL extends "01">(): <T>(_fn: PH, list: List<T>) => any_01<T>;
    <T>(fn: Predicate<T>): any_10<T>;
};
type any_10<T> = {
    <T$1 extends T = T>(list: List<T$1>): any_11;
};
type any_01<T> = {
