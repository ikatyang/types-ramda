...
type startsWith_00 = {
    ...
    <T$1 extends List<any>, T$2 extends T$1 = T$1>(prefix: T$1, list: T$2): startsWith_11;
    <$SEL extends "11">(): <T$1 extends List<any>, T$2 extends T$1 = T$1>(prefix: T$1, list: T$2) => startsWith_11;
...
type startsWith_10<T extends List<any>> = {
    <T$1 extends T = T>(list: T$1): startsWith_11;
};
