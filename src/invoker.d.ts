...
type invoker_00 = {
    ...
    <N extends string, R>(arity: number, method: N): invoker_variadic_11<N, R>;
    ...
    <$SEL extends "11", $KIND extends "variadic">(): <N extends string, R>(arity: number, method: N) => invoker_variadic_11<N, R>;
...
type invoker_01<N extends string> = {
    ...
    <$SEL extends "1", $KIND extends "variadic">(): <R>(arity: number) => invoker_variadic_11<N, R>;
    <R>(arity: number): invoker_variadic_11<N, R>;
};
...
type invoker_variadic_10 = {
    <N extends string, R>(method: N): invoker_variadic_11<N, R>;
};
...
type invoker_variadic_11<N extends string, R> = Variadic<R>;
export = invoker;
