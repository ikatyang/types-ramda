...
type endsWith_00 = {
    <T extends List<any>>(suffix: T, list: T): endsWith_11<T>;
    <$SEL extends "11">(): <T extends List<any>>(suffix: T, list: T) => endsWith_11<T>;
...
type endsWith_10<T extends List<any>> = {
    (list: T): endsWith_11<T>;
};
type endsWith_01<T extends List<any>> = {
    (suffix: T): endsWith_11<T>;
};
type endsWith_11<T extends List<any>> = boolean;
export = endsWith;
