...
type props_00 = {
    ...
    (_keys: PH, object: any): props_manual_01;
    ...
    <$SEL extends "01", $KIND extends "keyof">(): <T>(_keys: PH, object: T) => props_keyof_01<T>;
    ...
    <$SEL extends "01", $KIND extends "manual">(): (_keys: PH, object: any) => props_manual_01;
