...
type countBy_00 = {
    <T>(fn: Morphism<T, Property>, list: List<T>): countBy_11<T>;
    <$SEL extends "11">(): <T>(fn: Morphism<T, Property>, list: List<T>) => countBy_11<T>;
...
type countBy_01<T> = {
    (fn: Morphism<T, Property>): countBy_11<T>;
};
type countBy_11<T> = Dictionary<number>;
export = countBy;
