...
type findLastIndex_00 = {
    ...
    <T>(fn: Predicate<T>, list: List<T>): findLastIndex_11<T>;
    <$SEL extends "11">(): <T>(fn: Predicate<T>, list: List<T>) => findLastIndex_11<T>;
...
type findLastIndex_01<T> = {
    (fn: Predicate<T>): findLastIndex_11<T>;
};
type findLastIndex_11<T> = number;
