...
type map_00 = {
    ...
    <$SEL extends "11", $KIND extends "object">(): <T, U, K extends string>(fn: Morphism<T, U>, object: Record<K, T>) => map_object_11<T, U, K>;
...
type map_10<T, U> = {
    ...
    <$SEL extends "1", $KIND extends "object">(): <K extends string>(object: Record<K, T>) => map_object_11<T, U, K>;
