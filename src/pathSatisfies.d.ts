...
type pathSatisfies_000 = {
    <T>(fn: Predicate<T>, path: Path, object: any): pathSatisfies_111<T>;
    <T>(fn: Predicate<T>, path: Path): pathSatisfies_110<T>;
    <$SEL extends "111">(): <T>(fn: Predicate<T>, path: Path, object: any) => pathSatisfies_111<T>;
...
type pathSatisfies_100<T> = {
    (path: Path, object: any): pathSatisfies_111<T>;
    <$SEL extends "11">(): (path: Path, object: any) => pathSatisfies_111<T>;
    <$SEL extends "1">(): (path: Path) => pathSatisfies_110<T>;
    (path: Path): pathSatisfies_110<T>;
};
type pathSatisfies_010 = {
    <T>(fn: Predicate<T>, object: any): pathSatisfies_111<T>;
    <$SEL extends "11">(): <T>(fn: Predicate<T>, object: any) => pathSatisfies_111<T>;
    <$SEL extends "1">(): <T>(fn: Predicate<T>) => pathSatisfies_110<T>;
    <T>(fn: Predicate<T>): pathSatisfies_110<T>;
};
type pathSatisfies_110<T> = {
    (object: any): pathSatisfies_111<T>;
};
type pathSatisfies_001 = {
    <T>(fn: Predicate<T>, path: Path): pathSatisfies_111<T>;
    <$SEL extends "11">(): <T>(fn: Predicate<T>, path: Path) => pathSatisfies_111<T>;
    <$SEL extends "1">(): <T>(fn: Predicate<T>) => pathSatisfies_101<T>;
    <T>(fn: Predicate<T>): pathSatisfies_101<T>;
};
type pathSatisfies_101<T> = {
    (path: Path): pathSatisfies_111<T>;
};
type pathSatisfies_011 = {
    <T>(fn: Predicate<T>): pathSatisfies_111<T>;
};
type pathSatisfies_111<T> = boolean;
