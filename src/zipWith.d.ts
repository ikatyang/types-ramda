...
type zipWith_000 = {
    ...
    <T, U, R>(fn: (x: T, y: U) => R, a: List<T>, b: List<U>): zipWith_111<T, U, R>;
    <T>(_fn: PH, a: List<T>): zipWith_010<T>;
    <T, U, R>(fn: (x: T, y: U) => R, a: List<T>): zipWith_110<T, U, R>;
    <$SEL extends "111">(): <T, U, R>(fn: (x: T, y: U) => R, a: List<T>, b: List<U>) => zipWith_111<T, U, R>;
...
type zipWith_100<T, U, R> = {
    ...
    (a: List<T>, b: List<U>): zipWith_111<T, U, R>;
    <$SEL extends "11">(): (a: List<T>, b: List<U>) => zipWith_111<T, U, R>;
...
type zipWith_010<T> = {
    ...
    <U, R>(fn: (x: T, y: U) => R, b: List<U>): zipWith_111<T, U, R>;
    <$SEL extends "11">(): <U, R>(fn: (x: T, y: U) => R, b: List<U>) => zipWith_111<T, U, R>;
...
type zipWith_110<T, U, R> = {
    (b: List<U>): zipWith_111<T, U, R>;
};
type zipWith_001<U> = {
    <T>(_fn: PH, a: List<T>): zipWith_011<T, U>;
    <T, R>(fn: (x: T, y: U) => R, a: List<T>): zipWith_111<T, U, R>;
    <$SEL extends "11">(): <T, R>(fn: (x: T, y: U) => R, a: List<T>) => zipWith_111<T, U, R>;
...
type zipWith_101<T, U, R> = {
    (a: List<T>): zipWith_111<T, U, R>;
};
type zipWith_011<T, U> = {
    <R>(fn: (x: T, y: U) => R): zipWith_111<T, U, R>;
};
type zipWith_111<T, U, R> = R[];
export = zipWith;
