...
type dissoc_00 = {
    ...
    <$SEL extends "01", $KIND extends "remain">(): <T>(_property: PH, object: T) => dissoc_remain_01<T>;
    <$SEL extends "11", $KIND extends "manual">(): <T>(property: Property, object: object) => dissoc_manual_11<T>;
    <$SEL extends "01", $KIND extends "manual">(): (_property: PH, object: object) => dissoc_manual_01;
