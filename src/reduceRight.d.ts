...
type reduceRight_000 = {
    ...
    <$SEL extends "111">(): <T, U>(fn: (value: T, accumulator: U) => Reduced<U> | U, initial: U, values: List<T>) => reduceRight_111<T, U>;
...
type reduceRight_100<T, U> = {
    ...
    <$SEL extends "11">(): (initial: U, values: List<T>) => reduceRight_111<T, U>;
...
type reduceRight_010<U> = {
    ...
    <$SEL extends "11">(): <T>(fn: (value: T, accumulator: U) => Reduced<U> | U, values: List<T>) => reduceRight_111<T, U>;
...
type reduceRight_001<T> = {
    ...
    <$SEL extends "11">(): <U>(fn: (value: T, accumulator: U) => Reduced<U> | U, initial: U) => reduceRight_111<T, U>;
