...
type mergeDeepWith_000 = {
    ...
    <$SEL extends "111">(): <V, T>(fn: (a: V, b: V) => any, left: object, right: object) => mergeDeepWith_111<V, T>;
...
type mergeDeepWith_100<V> = {
    ...
    <$SEL extends "11">(): <T>(left: object, right: object) => mergeDeepWith_111<V, T>;
...
type mergeDeepWith_010 = {
    ...
    <$SEL extends "11">(): <V, T>(fn: (a: V, b: V) => any, right: object) => mergeDeepWith_111<V, T>;
...
type mergeDeepWith_001 = {
    ...
    <$SEL extends "11">(): <V, T>(fn: (a: V, b: V) => any, left: object) => mergeDeepWith_111<V, T>;
