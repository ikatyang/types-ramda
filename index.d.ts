...
export type adjust_000 = {
    ...
    <X extends "111">(): <T>(fn: (a: T) => T, index: number, list: List<T>) => adjust_111<T>;
    <X extends "11">(): <T>(fn: (a: T) => T, index: number) => adjust_110<T>;
    <X extends "101">(): <T>(fn: (a: T) => T, _index: PH, list: List<T>) => adjust_101<T>;
    <X extends "1">(): <T>(fn: (a: T) => T) => adjust_100<T>;
...
export type adjust_100<T> = {
    ...
    <X extends "11">(): (index: number, list: List<T>) => adjust_111<T>;
    <X extends "1">(): (index: number) => adjust_110<T>;
    <X extends "01">(): (_index: PH, list: List<T>) => adjust_101<T>;
    (index: number): adjust_110<T>;
};
export type adjust_010 = {
    <T>(_fn: PH, list: List<T>): adjust_011<T>;
    <T>(fn: (a: T) => T, list: List<T>): adjust_111<T>;
    <X extends "11">(): <T>(fn: (a: T) => T, list: List<T>) => adjust_111<T>;
    <X extends "1">(): <T>(fn: (a: T) => T) => adjust_110<T>;
...
export type adjust_001<T> = {
    ...
    <X extends "11">(): (fn: (a: T) => T, index: number) => adjust_111<T>;
    <X extends "1">(): (fn: (a: T) => T) => adjust_101<T>;
...
export type all_00 = {
    ...
    <X extends "11">(): <T>(pred: Pred<T>, list: List<T>) => all_11<T>;
    <X extends "1">(): <T>(pred: Pred<T>) => all_10<T>;
    <X extends "01">(): <T>(_pred: PH, list: List<T>) => all_01<T>;
...
export type and_00 = {
    ...
    <X extends "11", K extends "dispatch_to_some__and__method_">(): <T extends {
            and?: Function;
        }>(fn1: T, val2: boolean | any) => and_dispatch_to_some__and__method__11<T>;
    <X extends "1", K extends "dispatch_to_some__and__method_">(): <T extends {
            and?: Function;
        }>(fn1: T) => and_dispatch_to_some__and__method__10<T>;
    <X extends "01", K extends "dispatch_to_some__and__method_">(): (_fn1: PH, val2: boolean | any) => and_dispatch_to_some__and__method__01;
    <X extends "11", K extends "no_generics">(): (v1: any, v2: any) => and_no_generics_11;
    <X extends "1", K extends "no_generics">(): (v1: any) => and_no_generics_10;
    <X extends "01", K extends "no_generics">(): (_v1: PH, v2: any) => and_no_generics_01;
...
export type any_00 = {
    ...
    <X extends "11">(): <T>(pred: Pred<T>, list: List<T>) => any_11<T>;
    <X extends "1">(): <T>(pred: Pred<T>) => any_10<T>;
    <X extends "01">(): <T>(_pred: PH, list: List<T>) => any_01<T>;
...
export type ap_00 = {
    ...
    <X extends "11">(): <T, U>(fns: ((a: T) => U)[], xs: List<T>) => ap_11<T, U>;
    <X extends "1">(): <T, U>(fns: ((a: T) => U)[]) => ap_10<T, U>;
    <X extends "01">(): <T>(_fns: PH, xs: List<T>) => ap_01<T>;
...
export type aperture_00 = {
    ...
    <X extends "11">(): <T>(n: number, list: List<T>) => aperture_11<T>;
    <X extends "1">(): (n: number) => aperture_10;
    <X extends "01">(): <T>(_n: PH, list: List<T>) => aperture_01<T>;
...
export type append_00 = {
    ...
    <X extends "11">(): <T, U>(el: U, list: List<T>) => append_11<T, U>;
    <X extends "1">(): <U>(el: U) => append_10<U>;
    <X extends "01">(): <T>(_el: PH, list: List<T>) => append_01<T>;
    <U>(el: U): append_10<U>;
};
...
export type apply_00 = {
    ...
    <X extends "11">(): <TResult>(fn: (...args: any[]) => TResult, args: any[]) => apply_11<TResult>;
    <X extends "1">(): <TResult>(fn: (...args: any[]) => TResult) => apply_10<TResult>;
    <X extends "01">(): (_fn: PH, args: any[]) => apply_01;
...
export type ascend_000 = {
    ...
    <X extends "111", K extends "base">(): <T, U extends Struct<any>, K extends keyof U>(prop: K, val: T, obj: U) => ascend_base_111<T, U, K>;
    <X extends "11", K extends "base">(): <T, K extends keyof U>(prop: K, val: T) => ascend_base_110<T, K>;
    <X extends "101", K extends "base">(): <U extends Struct<any>, K extends keyof U>(prop: K, _val: PH, obj: U) => ascend_base_101<U, K>;
    <X extends "1", K extends "base">(): <K extends keyof U>(prop: K) => ascend_base_100<K>;
    <X extends "011", K extends "base">(): <T, U extends Struct<any>>(_prop: PH, val: T, obj: U) => ascend_base_011<T, U>;
    <X extends "01", K extends "base">(): <T>(_prop: PH, val: T) => ascend_base_010<T>;
    <X extends "001", K extends "base">(): <U extends Struct<any>>(_prop: PH, _val: PH, obj: U) => ascend_base_001<U>;
    <X extends "111", K extends "any_object_as_long_as_the_type_remains_unchanged">(): <T>(prop: Prop, val: any, obj: T) => ascend_any_object_as_long_as_the_type_remains_unchanged_111<T>;
    <X extends "11", K extends "any_object_as_long_as_the_type_remains_unchanged">(): (prop: Prop, val: any) => ascend_any_object_as_long_as_the_type_remains_unchanged_110;
    <X extends "101", K extends "any_object_as_long_as_the_type_remains_unchanged">(): <T>(prop: Prop, _val: PH, obj: T) => ascend_any_object_as_long_as_the_type_remains_unchanged_101<T>;
    <X extends "1", K extends "any_object_as_long_as_the_type_remains_unchanged">(): (prop: Prop) => ascend_any_object_as_long_as_the_type_remains_unchanged_100;
    <X extends "011", K extends "any_object_as_long_as_the_type_remains_unchanged">(): <T>(_prop: PH, val: any, obj: T) => ascend_any_object_as_long_as_the_type_remains_unchanged_011<T>;
    <X extends "01", K extends "any_object_as_long_as_the_type_remains_unchanged">(): (_prop: PH, val: any) => ascend_any_object_as_long_as_the_type_remains_unchanged_010;
    <X extends "001", K extends "any_object_as_long_as_the_type_remains_unchanged">(): <T>(_prop: PH, _val: PH, obj: T) => ascend_any_object_as_long_as_the_type_remains_unchanged_001<T>;
...
export type ascend_base_100<K extends keyof U> = {
    ...
    <X extends "11">(): <T, U extends Struct<any>>(val: T, obj: U) => ascend_base_111<T, U, K>;
    <X extends "1">(): <T>(val: T) => ascend_base_110<T, K>;
    <X extends "01">(): <U extends Struct<any>>(_val: PH, obj: U) => ascend_base_101<U, K>;
...
export type ascend_any_object_as_long_as_the_type_remains_unchanged_100 = {
    ...
    <X extends "11">(): <T>(val: any, obj: T) => ascend_any_object_as_long_as_the_type_remains_unchanged_111<T>;
    <X extends "1">(): (val: any) => ascend_any_object_as_long_as_the_type_remains_unchanged_110;
    <X extends "01">(): <T>(_val: PH, obj: T) => ascend_any_object_as_long_as_the_type_remains_unchanged_101<T>;
...
export type ascend_base_010<T> = {
    ...
    <X extends "11">(): <U extends Struct<any>, K extends keyof U>(prop: K, obj: U) => ascend_base_111<T, U, K>;
    <X extends "1">(): <K extends keyof U>(prop: K) => ascend_base_110<T, K>;
    <X extends "01">(): <U extends Struct<any>>(_prop: PH, obj: U) => ascend_base_011<T, U>;
...
export type ascend_any_object_as_long_as_the_type_remains_unchanged_010 = {
    ...
    <X extends "11">(): <T>(prop: Prop, obj: T) => ascend_any_object_as_long_as_the_type_remains_unchanged_111<T>;
    <X extends "1">(): (prop: Prop) => ascend_any_object_as_long_as_the_type_remains_unchanged_110;
    <X extends "01">(): <T>(_prop: PH, obj: T) => ascend_any_object_as_long_as_the_type_remains_unchanged_011<T>;
...
export type ascend_base_001<U extends Struct<any>> = {
    ...
    <X extends "11">(): <T, K extends keyof U>(prop: K, val: T) => ascend_base_111<T, U, K>;
    <X extends "1">(): <K extends keyof U>(prop: K) => ascend_base_101<U, K>;
    <X extends "01">(): <T>(_prop: PH, val: T) => ascend_base_011<T, U>;
...
export type ascend_any_object_as_long_as_the_type_remains_unchanged_001<T> = {
    ...
    <X extends "11">(): (prop: Prop, val: any) => ascend_any_object_as_long_as_the_type_remains_unchanged_111<T>;
    <X extends "1">(): (prop: Prop) => ascend_any_object_as_long_as_the_type_remains_unchanged_101<T>;
    <X extends "01">(): (_prop: PH, val: any) => ascend_any_object_as_long_as_the_type_remains_unchanged_011<T>;
...
export type assoc_000 = {
    ...
    <X extends "111", K extends "extend_object_with_new_property">(): <T, U extends Struct<any>, K extends string>(prop: K, val: T, obj: U) => assoc_extend_object_with_new_property_111<T, U, K>;
    <X extends "11", K extends "extend_object_with_new_property">(): <T, K extends string>(prop: K, val: T) => assoc_extend_object_with_new_property_110<T, K>;
    <X extends "101", K extends "extend_object_with_new_property">(): <U extends Struct<any>, K extends string>(prop: K, _val: PH, obj: U) => assoc_extend_object_with_new_property_101<U, K>;
    <X extends "1", K extends "extend_object_with_new_property">(): <K extends string>(prop: K) => assoc_extend_object_with_new_property_100<K>;
    <X extends "011", K extends "extend_object_with_new_property">(): <T, U extends Struct<any>>(_prop: PH, val: T, obj: U) => assoc_extend_object_with_new_property_011<T, U>;
    <X extends "01", K extends "extend_object_with_new_property">(): <T>(_prop: PH, val: T) => assoc_extend_object_with_new_property_010<T>;
    <X extends "001", K extends "extend_object_with_new_property">(): <U extends Struct<any>>(_prop: PH, _val: PH, obj: U) => assoc_extend_object_with_new_property_001<U>;
    <X extends "111", K extends "any_object_as_long_as_the_type_remains_unchanged">(): <T>(prop: Prop, val: any, obj: T) => assoc_any_object_as_long_as_the_type_remains_unchanged_111<T>;
    <X extends "11", K extends "any_object_as_long_as_the_type_remains_unchanged">(): (prop: Prop, val: any) => assoc_any_object_as_long_as_the_type_remains_unchanged_110;
    <X extends "101", K extends "any_object_as_long_as_the_type_remains_unchanged">(): <T>(prop: Prop, _val: PH, obj: T) => assoc_any_object_as_long_as_the_type_remains_unchanged_101<T>;
    <X extends "1", K extends "any_object_as_long_as_the_type_remains_unchanged">(): (prop: Prop) => assoc_any_object_as_long_as_the_type_remains_unchanged_100;
    <X extends "011", K extends "any_object_as_long_as_the_type_remains_unchanged">(): <T>(_prop: PH, val: any, obj: T) => assoc_any_object_as_long_as_the_type_remains_unchanged_011<T>;
    <X extends "01", K extends "any_object_as_long_as_the_type_remains_unchanged">(): (_prop: PH, val: any) => assoc_any_object_as_long_as_the_type_remains_unchanged_010;
    <X extends "001", K extends "any_object_as_long_as_the_type_remains_unchanged">(): <T>(_prop: PH, _val: PH, obj: T) => assoc_any_object_as_long_as_the_type_remains_unchanged_001<T>;
...
export type assoc_extend_object_with_new_property_100<K extends string> = {
    ...
    <X extends "11">(): <T, U extends Struct<any>>(val: T, obj: U) => assoc_extend_object_with_new_property_111<T, U, K>;
    <X extends "1">(): <T>(val: T) => assoc_extend_object_with_new_property_110<T, K>;
    <X extends "01">(): <U extends Struct<any>>(_val: PH, obj: U) => assoc_extend_object_with_new_property_101<U, K>;
...
export type assoc_any_object_as_long_as_the_type_remains_unchanged_100 = {
    ...
    <X extends "11">(): <T>(val: any, obj: T) => assoc_any_object_as_long_as_the_type_remains_unchanged_111<T>;
    <X extends "1">(): (val: any) => assoc_any_object_as_long_as_the_type_remains_unchanged_110;
    <X extends "01">(): <T>(_val: PH, obj: T) => assoc_any_object_as_long_as_the_type_remains_unchanged_101<T>;
...
export type assoc_extend_object_with_new_property_010<T> = {
    ...
    <X extends "11">(): <U extends Struct<any>, K extends string>(prop: K, obj: U) => assoc_extend_object_with_new_property_111<T, U, K>;
    <X extends "1">(): <K extends string>(prop: K) => assoc_extend_object_with_new_property_110<T, K>;
    <X extends "01">(): <U extends Struct<any>>(_prop: PH, obj: U) => assoc_extend_object_with_new_property_011<T, U>;
...
export type assoc_any_object_as_long_as_the_type_remains_unchanged_010 = {
    ...
    <X extends "11">(): <T>(prop: Prop, obj: T) => assoc_any_object_as_long_as_the_type_remains_unchanged_111<T>;
    <X extends "1">(): (prop: Prop) => assoc_any_object_as_long_as_the_type_remains_unchanged_110;
    <X extends "01">(): <T>(_prop: PH, obj: T) => assoc_any_object_as_long_as_the_type_remains_unchanged_011<T>;
...
export type assoc_extend_object_with_new_property_001<U extends Struct<any>> = {
    ...
    <X extends "11">(): <T, K extends string>(prop: K, val: T) => assoc_extend_object_with_new_property_111<T, U, K>;
    <X extends "1">(): <K extends string>(prop: K) => assoc_extend_object_with_new_property_101<U, K>;
    <X extends "01">(): <T>(_prop: PH, val: T) => assoc_extend_object_with_new_property_011<T, U>;
...
export type assoc_any_object_as_long_as_the_type_remains_unchanged_001<T> = {
    ...
    <X extends "11">(): (prop: Prop, val: any) => assoc_any_object_as_long_as_the_type_remains_unchanged_111<T>;
    <X extends "1">(): (prop: Prop) => assoc_any_object_as_long_as_the_type_remains_unchanged_101<T>;
    <X extends "01">(): (_prop: PH, val: any) => assoc_any_object_as_long_as_the_type_remains_unchanged_011<T>;
...
export type assocPath_000 = {
    ...
    <X extends "111">(): <T, U>(path: Path, val: T, obj: U) => assocPath_111<T, U>;
    <X extends "11">(): <T>(path: Path, val: T) => assocPath_110<T>;
    <X extends "101">(): <U>(path: Path, _val: PH, obj: U) => assocPath_101<U>;
    <X extends "1">(): (path: Path) => assocPath_100;
    <X extends "011">(): <T, U>(_path: PH, val: T, obj: U) => assocPath_011<T, U>;
    <X extends "01">(): <T>(_path: PH, val: T) => assocPath_010<T>;
    <X extends "001">(): <U>(_path: PH, _val: PH, obj: U) => assocPath_001<U>;
    (path: Path): assocPath_100;
};
export type assocPath_100 = {
    <U>(_val: PH, obj: U): assocPath_101<U>;
    <T, U>(val: T, obj: U): assocPath_111<T, U>;
    <X extends "11">(): <T, U>(val: T, obj: U) => assocPath_111<T, U>;
    <X extends "1">(): <T>(val: T) => assocPath_110<T>;
    <X extends "01">(): <U>(_val: PH, obj: U) => assocPath_101<U>;
    <T>(val: T): assocPath_110<T>;
};
export type assocPath_010<T> = {
    <U>(_path: PH, obj: U): assocPath_011<T, U>;
    <U>(path: Path, obj: U): assocPath_111<T, U>;
    <X extends "11">(): <U>(path: Path, obj: U) => assocPath_111<T, U>;
    <X extends "1">(): (path: Path) => assocPath_110<T>;
    <X extends "01">(): <U>(_path: PH, obj: U) => assocPath_011<T, U>;
...
export type assocPath_001<U> = {
    ...
    <X extends "11">(): <T>(path: Path, val: T) => assocPath_111<T, U>;
    <X extends "1">(): (path: Path) => assocPath_101<U>;
    <X extends "01">(): <T>(_path: PH, val: T) => assocPath_011<T, U>;
...
export type binary_0 = {
    ...
    <X extends "1", K extends "base">(): <T, A>(fn: (a: A, b: T, ...args: any[]) => T) => binary_base_1<T, A>;
    <X extends "1", K extends "non_generics_for_return_func">(): <T>(fn: Variadic<T>) => binary_non_generics_for_return_func_1<T>;
...
export type bind_00 = {
    ...
    <X extends "11">(): <T>(fn: Variadic<T>, thisObj: {}) => bind_11<T>;
    <X extends "1">(): <T>(fn: Variadic<T>) => bind_10<T>;
    <X extends "01">(): (_fn: PH, thisObj: {}) => bind_01;
...
export type both_00 = {
    ...
    <X extends "11">(): <T>(pred1: Pred<T>, pred2: Pred<T>) => both_11<T>;
    <X extends "1">(): <T>(pred1: Pred<T>) => both_10<T>;
    <X extends "01">(): <T>(_pred1: PH, pred2: Pred<T>) => both_01<T>;
...
export type call_00 = {
    ...
    <X extends "11">(): <T>(fn: Variadic<T>, ...args: any[]) => call_11<T>;
    <X extends "1">(): <T>(fn: Variadic<T>) => call_10<T>;
    <X extends "01">(): (_fn: PH, ...args: any[]) => call_01;
...
export type chain_00 = {
    ...
    <X extends "11", K extends "list_version">(): <T, U>(fn: (n: T) => U[], list: List<T>) => chain_list_version_11<T, U>;
    <X extends "1", K extends "list_version">(): <T, U>(fn: (n: T) => U[]) => chain_list_version_10<T, U>;
    <X extends "01", K extends "list_version">(): <T>(_fn: PH, list: List<T>) => chain_list_version_01<T>;
    <X extends "11", K extends "generic_chain_version">(): <T, U>(fn: (n: T) => Chain<U>, list: Chain<T>) => chain_generic_chain_version_11<T, U>;
    <X extends "1", K extends "generic_chain_version">(): <T, U>(fn: (n: T) => Chain<U>) => chain_generic_chain_version_10<T, U>;
    <X extends "01", K extends "generic_chain_version">(): <T>(_fn: PH, list: Chain<T>) => chain_generic_chain_version_01<T>;
    <X extends "11", K extends "function_argument">(): <T, U, V>(fn: (v: V) => (list: List<T>) => U[], monad: (list: List<T>) => V) => chain_function_argument_11<T, U, V>;
    <X extends "1", K extends "function_argument">(): <T, U, V>(fn: (v: V) => (list: List<T>) => U[]) => chain_function_argument_10<T, U, V>;
    <X extends "01", K extends "function_argument">(): <T, V>(_fn: PH, monad: (list: List<T>) => V) => chain_function_argument_01<T, V>;
...
export type clamp_000 = {
    ...
    <X extends "111">(): <T>(min: T, max: T, value: T) => clamp_111<T>;
    <X extends "11">(): <T>(min: T, max: T) => clamp_110<T>;
    <X extends "101">(): <T>(min: T, _max: PH, value: T) => clamp_101<T>;
    <X extends "1">(): <T>(min: T) => clamp_100<T>;
    <X extends "011">(): <T>(_min: PH, max: T, value: T) => clamp_011<T>;
    <X extends "01">(): <T>(_min: PH, max: T) => clamp_010<T>;
    <X extends "001">(): <T>(_min: PH, _max: PH, value: T) => clamp_001<T>;
    <T>(min: T): clamp_100<T>;
};
export type clamp_100<T> = {
    (_max: PH, value: T): clamp_101<T>;
    (max: T, value: T): clamp_111<T>;
    <X extends "11">(): (max: T, value: T) => clamp_111<T>;
    <X extends "1">(): (max: T) => clamp_110<T>;
    <X extends "01">(): (_max: PH, value: T) => clamp_101<T>;
    (max: T): clamp_110<T>;
};
export type clamp_010<T> = {
    (_min: PH, value: T): clamp_011<T>;
    (min: T, value: T): clamp_111<T>;
    <X extends "11">(): (min: T, value: T) => clamp_111<T>;
    <X extends "1">(): (min: T) => clamp_110<T>;
    <X extends "01">(): (_min: PH, value: T) => clamp_011<T>;
    (min: T): clamp_110<T>;
};
...
export type clamp_001<T> = {
    ...
    <X extends "11">(): (min: T, max: T) => clamp_111<T>;
    <X extends "1">(): (min: T) => clamp_101<T>;
    <X extends "01">(): (_min: PH, max: T) => clamp_011<T>;
    (min: T): clamp_101<T>;
};
...
export type clone_0 = {
    ...
    <X extends "1", K extends "Objects">(): <T>(value: T) => clone_Objects_1<T>;
    <X extends "1", K extends "Arrays">(): <T>(value: List<T>) => clone_Arrays_1<T>;
...
export type concat_00 = {
    ...
    <X extends "11">(): <T extends List<any>>(list1: T, list2: T) => concat_11<T>;
    <X extends "1">(): <T extends List<any>>(list1: T) => concat_10<T>;
    <X extends "01">(): <T extends List<any>>(_list1: PH, list2: T) => concat_01<T>;
...
export type constructN_00 = {
    ...
    <X extends "11">(): (n: number, fn: Function) => constructN_11;
    <X extends "1">(): (n: number) => constructN_10;
    <X extends "01">(): (_n: PH, fn: Function) => constructN_01;
...
export type contains_00 = {
    ...
    <X extends "11", K extends "base">(): (a: string, list: string) => contains_base_11;
    <X extends "1", K extends "base">(): (a: string) => contains_base_10;
    <X extends "01", K extends "base">(): (_a: PH, list: string) => contains_base_01;
    <X extends "11", K extends "generics">(): <T, R extends List<T>>(a: T, list: R) => contains_generics_11<T, R>;
    <X extends "1", K extends "generics">(): <T>(a: T) => contains_generics_10<T>;
    <X extends "01", K extends "generics">(): <R extends List<T>>(_a: PH, list: R) => contains_generics_01<R>;
...
export type converge_00 = {
    ...
    <X extends "11">(): <T>(after: Variadic<T>, fns: List<Variadic<any>>) => converge_11<T>;
    <X extends "1">(): <T>(after: Variadic<T>) => converge_10<T>;
    <X extends "01">(): (_after: PH, fns: List<Variadic<any>>) => converge_01;
...
export type countBy_00 = {
    ...
    <X extends "11">(): <T>(fn: (a: T) => Prop, list: List<T>) => countBy_11<T>;
    <X extends "1">(): <T>(fn: (a: T) => Prop) => countBy_10<T>;
    <X extends "01">(): <T>(_fn: PH, list: List<T>) => countBy_01<T>;
...
export type curryN_00 = {
    ...
    <X extends "11">(): <T>(length: number, fn: Variadic<T>) => curryN_11<T>;
    <X extends "1">(): (length: number) => curryN_10;
    <X extends "01">(): <T>(_length: PH, fn: Variadic<T>) => curryN_01<T>;
...
export type defaultTo_00 = {
    ...
    <X extends "11">(): <T, U>(a: T, b: U | null | undefined) => defaultTo_11<T, U>;
    <X extends "1">(): <T>(a: T) => defaultTo_10<T>;
    <X extends "01">(): <U>(_a: PH, b: U | null | undefined) => defaultTo_01<U>;
...
export type descend_000 = {
    ...
    <X extends "111">(): <T, V extends Ord>(comparator: (val: T) => V, a: T, b: T) => descend_111<T, V>;
    <X extends "11">(): <T, V extends Ord>(comparator: (val: T) => V, a: T) => descend_110<T, V>;
    <X extends "101">(): <T, V extends Ord>(comparator: (val: T) => V, _a: PH, b: T) => descend_101<T, V>;
    <X extends "1">(): <T, V extends Ord>(comparator: (val: T) => V) => descend_100<T, V>;
    <X extends "011">(): <T>(_comparator: PH, a: T, b: T) => descend_011<T>;
    <X extends "01">(): <T>(_comparator: PH, a: T) => descend_010<T>;
    <X extends "001">(): <T>(_comparator: PH, _a: PH, b: T) => descend_001<T>;
...
export type descend_100<T, V extends Ord> = {
    ...
    <X extends "11">(): (a: T, b: T) => descend_111<T, V>;
    <X extends "1">(): (a: T) => descend_110<T, V>;
    <X extends "01">(): (_a: PH, b: T) => descend_101<T, V>;
    (a: T): descend_110<T, V>;
};
export type descend_010<T> = {
    (_comparator: PH, b: T): descend_011<T>;
    <V extends Ord>(comparator: (val: T) => V, b: T): descend_111<T, V>;
    <X extends "11">(): <V extends Ord>(comparator: (val: T) => V, b: T) => descend_111<T, V>;
    <X extends "1">(): <V extends Ord>(comparator: (val: T) => V) => descend_110<T, V>;
    <X extends "01">(): (_comparator: PH, b: T) => descend_011<T>;
...
export type descend_001<T> = {
    ...
    <X extends "11">(): <V extends Ord>(comparator: (val: T) => V, a: T) => descend_111<T, V>;
    <X extends "1">(): <V extends Ord>(comparator: (val: T) => V) => descend_101<T, V>;
    <X extends "01">(): (_comparator: PH, a: T) => descend_011<T>;
...
export type difference_00 = {
    ...
    <X extends "11">(): <T>(list1: List<T>, list2: List<T>) => difference_11<T>;
    <X extends "1">(): <T>(list1: List<T>) => difference_10<T>;
    <X extends "01">(): <T>(_list1: PH, list2: List<T>) => difference_01<T>;
...
export type differenceWith_000 = {
    ...
    <X extends "111">(): <T>(pred: (a: T, b: T) => boolean, list1: List<T>, list2: List<T>) => differenceWith_111<T>;
    <X extends "11">(): <T>(pred: (a: T, b: T) => boolean, list1: List<T>) => differenceWith_110<T>;
    <X extends "101">(): <T>(pred: (a: T, b: T) => boolean, _list1: PH, list2: List<T>) => differenceWith_101<T>;
    <X extends "1">(): <T>(pred: (a: T, b: T) => boolean) => differenceWith_100<T>;
    <X extends "011">(): <T>(_pred: PH, list1: List<T>, list2: List<T>) => differenceWith_011<T>;
    <X extends "01">(): <T>(_pred: PH, list1: List<T>) => differenceWith_010<T>;
    <X extends "001">(): <T>(_pred: PH, _list1: PH, list2: List<T>) => differenceWith_001<T>;
...
export type differenceWith_100<T> = {
    ...
    <X extends "11">(): (list1: List<T>, list2: List<T>) => differenceWith_111<T>;
    <X extends "1">(): (list1: List<T>) => differenceWith_110<T>;
    <X extends "01">(): (_list1: PH, list2: List<T>) => differenceWith_101<T>;
...
export type differenceWith_010<T> = {
    ...
    <X extends "11">(): (pred: (a: T, b: T) => boolean, list2: List<T>) => differenceWith_111<T>;
    <X extends "1">(): (pred: (a: T, b: T) => boolean) => differenceWith_110<T>;
    <X extends "01">(): (_pred: PH, list2: List<T>) => differenceWith_011<T>;
...
export type differenceWith_001<T> = {
    ...
    <X extends "11">(): (pred: (a: T, b: T) => boolean, list1: List<T>) => differenceWith_111<T>;
    <X extends "1">(): (pred: (a: T, b: T) => boolean) => differenceWith_101<T>;
    <X extends "01">(): (_pred: PH, list1: List<T>) => differenceWith_011<T>;
...
export type dissoc_00 = {
    ...
    <X extends "11", K extends "accurate">(): <T>(prop: keyof T, obj: T) => dissoc_accurate_11<T>;
    <X extends "1", K extends "accurate">(): <T>(prop: keyof T) => dissoc_accurate_10<T>;
    <X extends "01", K extends "accurate">(): <T>(_prop: PH, obj: T) => dissoc_accurate_01<T>;
    <X extends "11", K extends "easier">(): (prop: Prop, obj: Struct<any>) => dissoc_easier_11;
    <X extends "1", K extends "easier">(): (prop: Prop) => dissoc_easier_10;
    <X extends "01", K extends "easier">(): (_prop: PH, obj: Struct<any>) => dissoc_easier_01;
...
export type dissocPath_00 = {
    ...
    <X extends "11">(): (path: Path, obj: Struct<any>) => dissocPath_11;
    <X extends "1">(): (path: Path) => dissocPath_10;
    <X extends "01">(): (_path: PH, obj: Struct<any>) => dissocPath_01;
...
export type divide_00 = {
    ...
    <X extends "11">(): (a: number, b: number) => divide_11;
    <X extends "1">(): (a: number) => divide_10;
    <X extends "01">(): (_a: PH, b: number) => divide_01;
    (a: number): divide_10;
};
...
export type drop_00 = {
    ...
    <X extends "11">(): <T extends List<any>>(n: number, xs: T) => drop_11<T>;
    <X extends "1">(): (n: number) => drop_10;
    <X extends "01">(): <T extends List<any>>(_n: PH, xs: T) => drop_01<T>;
    (n: number): drop_10;
};
export type drop_10 = {
...
export type dropLast_00 = {
    ...
    <X extends "11">(): <T extends List<any>>(n: number, xs: T) => dropLast_11<T>;
    <X extends "1">(): (n: number) => dropLast_10;
    <X extends "01">(): <T extends List<any>>(_n: PH, xs: T) => dropLast_01<T>;
...
export type dropLastWhile_00 = {
    ...
    <X extends "11">(): <T, R extends List<T>>(pred: Pred<T>, list: R) => dropLastWhile_11<T, R>;
    <X extends "1">(): <T>(pred: Pred<T>) => dropLastWhile_10<T>;
    <X extends "01">(): <R extends List<T>>(_pred: PH, list: R) => dropLastWhile_01<R>;
...
export type dropWhile_00 = {
    ...
    <X extends "11">(): <T, R extends List<T>>(pred: Pred<T>, list: R) => dropWhile_11<T, R>;
    <X extends "1">(): <T>(pred: Pred<T>) => dropWhile_10<T>;
    <X extends "01">(): <R extends List<T>>(_pred: PH, list: R) => dropWhile_01<R>;
...
export type either_00 = {
    ...
    <X extends "11">(): <T>(pred1: Pred<T>, pred2: Pred<T>) => either_11<T>;
    <X extends "1">(): <T>(pred1: Pred<T>) => either_10<T>;
    <X extends "01">(): <T>(_pred1: PH, pred2: Pred<T>) => either_01<T>;
...
export type eqBy_000 = {
    ...
    <X extends "111">(): <T>(fn: (a: T) => T, a: T, b: T) => eqBy_111<T>;
    <X extends "11">(): <T>(fn: (a: T) => T, a: T) => eqBy_110<T>;
    <X extends "101">(): <T>(fn: (a: T) => T, _a: PH, b: T) => eqBy_101<T>;
    <X extends "1">(): <T>(fn: (a: T) => T) => eqBy_100<T>;
    <X extends "011">(): <T>(_fn: PH, a: T, b: T) => eqBy_011<T>;
    <X extends "01">(): <T>(_fn: PH, a: T) => eqBy_010<T>;
    <X extends "001">(): <T>(_fn: PH, _a: PH, b: T) => eqBy_001<T>;
    <T>(fn: (a: T) => T): eqBy_100<T>;
};
export type eqBy_100<T> = {
    (_a: PH, b: T): eqBy_101<T>;
    (a: T, b: T): eqBy_111<T>;
    <X extends "11">(): (a: T, b: T) => eqBy_111<T>;
    <X extends "1">(): (a: T) => eqBy_110<T>;
    <X extends "01">(): (_a: PH, b: T) => eqBy_101<T>;
    (a: T): eqBy_110<T>;
};
export type eqBy_010<T> = {
    (_fn: PH, b: T): eqBy_011<T>;
    (fn: (a: T) => T, b: T): eqBy_111<T>;
    <X extends "11">(): (fn: (a: T) => T, b: T) => eqBy_111<T>;
    <X extends "1">(): (fn: (a: T) => T) => eqBy_110<T>;
    <X extends "01">(): (_fn: PH, b: T) => eqBy_011<T>;
    (fn: (a: T) => T): eqBy_110<T>;
};
...
export type eqBy_001<T> = {
    ...
    <X extends "11">(): (fn: (a: T) => T, a: T) => eqBy_111<T>;
    <X extends "1">(): (fn: (a: T) => T) => eqBy_101<T>;
    <X extends "01">(): (_fn: PH, a: T) => eqBy_011<T>;
    (fn: (a: T) => T): eqBy_101<T>;
};
...
export type eqProps_000 = {
    ...
    <X extends "111", K extends "base">(): <T, U>(prop: Prop, obj1: T, obj2: U) => eqProps_base_111<T, U>;
    <X extends "11", K extends "base">(): <T>(prop: Prop, obj1: T) => eqProps_base_110<T>;
    <X extends "101", K extends "base">(): <U>(prop: Prop, _obj1: PH, obj2: U) => eqProps_base_101<U>;
    <X extends "011", K extends "base">(): <T, U>(_prop: PH, obj1: T, obj2: U) => eqProps_base_011<T, U>;
    <X extends "01", K extends "base">(): <T>(_prop: PH, obj1: T) => eqProps_base_010<T>;
    <X extends "001", K extends "base">(): <U>(_prop: PH, _obj1: PH, obj2: U) => eqProps_base_001<U>;
    <X extends "111", K extends "less_generics">(): (prop: Prop, obj1: any, obj2: any) => eqProps_less_generics_111;
    <X extends "11", K extends "less_generics">(): (prop: Prop, obj1: any) => eqProps_less_generics_110;
    <X extends "101", K extends "less_generics">(): (prop: Prop, _obj1: PH, obj2: any) => eqProps_less_generics_101;
    <X extends "011", K extends "less_generics">(): (_prop: PH, obj1: any, obj2: any) => eqProps_less_generics_011;
    <X extends "01", K extends "less_generics">(): (_prop: PH, obj1: any) => eqProps_less_generics_010;
    <X extends "001", K extends "less_generics">(): (_prop: PH, _obj1: PH, obj2: any) => eqProps_less_generics_001;
    <X extends "1">(): (prop: Prop) => eqProps_100;
...
export type eqProps_100 = {
    ...
    <X extends "11", K extends "base">(): <T, U>(obj1: T, obj2: U) => eqProps_base_111<T, U>;
    <X extends "1", K extends "base">(): <T>(obj1: T) => eqProps_base_110<T>;
    <X extends "01", K extends "base">(): <U>(_obj1: PH, obj2: U) => eqProps_base_101<U>;
    <X extends "11", K extends "less_generics">(): (obj1: any, obj2: any) => eqProps_less_generics_111;
    <X extends "1", K extends "less_generics">(): (obj1: any) => eqProps_less_generics_110;
    <X extends "01", K extends "less_generics">(): (_obj1: PH, obj2: any) => eqProps_less_generics_101;
...
export type eqProps_base_010<T> = {
    ...
    <X extends "11">(): <U>(prop: Prop, obj2: U) => eqProps_base_111<T, U>;
    <X extends "1">(): (prop: Prop) => eqProps_base_110<T>;
    <X extends "01">(): <U>(_prop: PH, obj2: U) => eqProps_base_011<T, U>;
...
export type eqProps_less_generics_010 = {
    ...
    <X extends "11">(): (prop: Prop, obj2: any) => eqProps_less_generics_111;
    <X extends "1">(): (prop: Prop) => eqProps_less_generics_110;
    <X extends "01">(): (_prop: PH, obj2: any) => eqProps_less_generics_011;
...
export type eqProps_base_001<U> = {
    ...
    <X extends "11">(): <T>(prop: Prop, obj1: T) => eqProps_base_111<T, U>;
    <X extends "1">(): (prop: Prop) => eqProps_base_101<U>;
    <X extends "01">(): <T>(_prop: PH, obj1: T) => eqProps_base_011<T, U>;
...
export type eqProps_less_generics_001 = {
    ...
    <X extends "11">(): (prop: Prop, obj1: any) => eqProps_less_generics_111;
    <X extends "1">(): (prop: Prop) => eqProps_less_generics_101;
    <X extends "01">(): (_prop: PH, obj1: any) => eqProps_less_generics_011;
...
export type evolve_00 = {
    ...
    <X extends "11", K extends "base">(): <V>(transformations: NestedObj<((v: any) => any)>, obj: V) => evolve_base_11<V>;
    <X extends "1", K extends "base">(): (transformations: NestedObj<((v: any) => any)>) => evolve_base_10;
    <X extends "01", K extends "base">(): <V>(_transformations: PH, obj: V) => evolve_base_01<V>;
    <X extends "11", K extends "no_inference">(): (transformations: Obj<Function>, obj: any) => evolve_no_inference_11;
    <X extends "1", K extends "no_inference">(): (transformations: Obj<Function>) => evolve_no_inference_10;
    <X extends "01", K extends "no_inference">(): (_transformations: PH, obj: any) => evolve_no_inference_01;
...
export type filter_00 = {
    ...
    <X extends "11", K extends "base">(): <T>(pred: Pred<T>, list: List<T>) => filter_base_11<T>;
    <X extends "01", K extends "base">(): <T>(_pred: PH, list: List<T>) => filter_base_01<T>;
    <X extends "11", K extends "functor_to_functor">(): <T>(pred: Pred<T>, list: Functor<T>) => filter_functor_to_functor_11<T>;
    <X extends "01", K extends "functor_to_functor">(): <T>(_pred: PH, list: Functor<T>) => filter_functor_to_functor_01<T>;
    <X extends "11", K extends "functor_to_array">(): <T>(pred: Pred<T>, list: Functor<T>) => filter_functor_to_array_11<T>;
    <X extends "01", K extends "functor_to_array">(): <T>(_pred: PH, list: Functor<T>) => filter_functor_to_array_01<T>;
    <X extends "11", K extends "object">(): <T, U extends Obj<T>>(pred: Pred<T>, obj: U) => filter_object_11<T, U>;
    <X extends "01", K extends "object">(): <U extends Obj<T>>(_pred: PH, obj: U) => filter_object_01<U>;
    <X extends "1">(): <T>(pred: Pred<T>) => filter_10<T>;
...
export type filter_10<T> = {
    ...
    <X extends "1", K extends "base">(): (list: List<T>) => filter_base_11<T>;
    <X extends "1", K extends "functor_to_functor">(): (list: Functor<T>) => filter_functor_to_functor_11<T>;
    <X extends "1", K extends "functor_to_array">(): (list: Functor<T>) => filter_functor_to_array_11<T>;
    <X extends "1", K extends "object">(): <U extends Obj<T>>(obj: U) => filter_object_11<T, U>;
...
export type find_00 = {
    ...
    <X extends "11">(): <T>(fn: (a: T) => boolean, list: List<T>) => find_11<T>;
    <X extends "1">(): <T>(fn: (a: T) => boolean) => find_10<T>;
    <X extends "01">(): <T>(_fn: PH, list: List<T>) => find_01<T>;
...
export type findIndex_00 = {
    ...
    <X extends "11">(): <T>(fn: (a: T) => boolean, list: List<T>) => findIndex_11<T>;
    <X extends "1">(): <T>(fn: (a: T) => boolean) => findIndex_10<T>;
    <X extends "01">(): <T>(_fn: PH, list: List<T>) => findIndex_01<T>;
...
export type findLast_00 = {
    ...
    <X extends "11">(): <T>(fn: (a: T) => boolean, list: List<T>) => findLast_11<T>;
    <X extends "1">(): <T>(fn: (a: T) => boolean) => findLast_10<T>;
    <X extends "01">(): <T>(_fn: PH, list: List<T>) => findLast_01<T>;
...
export type findLastIndex_00 = {
    ...
    <X extends "11">(): <T>(fn: (a: T) => boolean, list: List<T>) => findLastIndex_11<T>;
    <X extends "1">(): <T>(fn: (a: T) => boolean) => findLastIndex_10<T>;
    <X extends "01">(): <T>(_fn: PH, list: List<T>) => findLastIndex_01<T>;
...
export type flip_0 = {
    ...
    <X extends "1", K extends "base">(): <T, U, TResult>(fn: (arg0: T, arg1: U) => TResult) => flip_base_1<T, U, TResult>;
    <X extends "1", K extends "rest_arguments">(): <T, U, Rest, TResult>(fn: (arg0: T, arg1: U, ...args: Rest[]) => TResult) => flip_rest_arguments_1<T, U, Rest, TResult>;
...
export type forEach_00 = {
    ...
    <X extends "11">(): <T>(fn: (x: T) => void, list: List<T>) => forEach_11<T>;
    <X extends "1">(): <T>(fn: (x: T) => void) => forEach_10<T>;
    <X extends "01">(): <T>(_fn: PH, list: List<T>) => forEach_01<T>;
...
export type forEachObjIndexed_00 = {
    ...
    <X extends "11">(): <T, Inp extends Struct<T>>(fn: (val: T, key: string, obj?: Inp) => void, o: Inp) => forEachObjIndexed_11<T, Inp>;
    <X extends "1">(): <T, Inp extends Struct<T>>(fn: (val: T, key: string, obj?: Inp) => void) => forEachObjIndexed_10<T, Inp>;
    <X extends "01">(): <Inp extends Struct<T>>(_fn: PH, o: Inp) => forEachObjIndexed_01<Inp>;
...
export type groupBy_00 = {
    ...
    <X extends "11">(): <T>(fn: (a: T) => prop, list: List<T>) => groupBy_11<T>;
    <X extends "1">(): <T>(fn: (a: T) => prop) => groupBy_10<T>;
    <X extends "01">(): <T>(_fn: PH, list: List<T>) => groupBy_01<T>;
...
export type groupWith_00 = {
    ...
    <X extends "11">(): <T>(fn: (a: T) => Prop, list: List<T>) => groupWith_11<T>;
    <X extends "1">(): <T>(fn: (a: T) => Prop) => groupWith_10<T>;
    <X extends "01">(): <T>(_fn: PH, list: List<T>) => groupWith_01<T>;
...
export type gt_00 = {
    ...
    <X extends "11">(): (a: number, b: number) => gt_11;
    <X extends "1">(): (a: number) => gt_10;
    <X extends "01">(): (_a: PH, b: number) => gt_01;
    (a: number): gt_10;
};
export type gt_10 = {
    (b: number): gt_11;
...
export type gte_00 = {
    ...
    <X extends "11">(): (a: number, b: number) => gte_11;
    <X extends "1">(): (a: number) => gte_10;
    <X extends "01">(): (_a: PH, b: number) => gte_01;
    (a: number): gte_10;
};
export type gte_10 = {
    (b: number): gte_11;
...
export type has_00 = {
    ...
    <X extends "11">(): (s: Prop, obj: Struct<any>) => has_11;
    <X extends "1">(): (s: Prop) => has_10;
    <X extends "01">(): (_s: PH, obj: Struct<any>) => has_01;
    (s: Prop): has_10;
};
export type has_10 = {
...
export type hasIn_00 = {
    ...
    <X extends "11">(): (s: Prop, obj: Struct<any>) => hasIn_11;
    <X extends "1">(): (s: Prop) => hasIn_10;
    <X extends "01">(): (_s: PH, obj: Struct<any>) => hasIn_01;
    (s: Prop): hasIn_10;
};
...
export type head_0 = {
    ...
    <X extends "1", K extends "triple">(): <T0, T1, T2>(list: [T0, T1, T2]) => head_triple_1<T0, T1, T2>;
    <X extends "1", K extends "tuple">(): <T0, T1>(list: [T0, T1]) => head_tuple_1<T0, T1>;
    <X extends "1", K extends "single">(): <T>(list: [T]) => head_single_1<T>;
    <X extends "1", K extends "any">(): <T extends List<any>>(list: T) => head_any_1<T>;
...
export type identical_00 = {
    ...
    <X extends "11">(): <T>(a: T, b: T) => identical_11<T>;
    <X extends "1">(): <T>(a: T) => identical_10<T>;
    <X extends "01">(): <T>(_a: PH, b: T) => identical_01<T>;
...
export type ifElse_000 = {
    ...
    <X extends "111">(): <T, U, V>(fn: Pred<T>, onTrue: (v: T) => U, onFalse: (v: T) => V) => ifElse_111<T, U, V>;
    <X extends "11">(): <T, U>(fn: Pred<T>, onTrue: (v: T) => U) => ifElse_110<T, U>;
    <X extends "101">(): <T, V>(fn: Pred<T>, _onTrue: PH, onFalse: (v: T) => V) => ifElse_101<T, V>;
    <X extends "1">(): <T>(fn: Pred<T>) => ifElse_100<T>;
    <X extends "011">(): <T, U, V>(_fn: PH, onTrue: (v: T) => U, onFalse: (v: T) => V) => ifElse_011<T, U, V>;
    <X extends "01">(): <T, U>(_fn: PH, onTrue: (v: T) => U) => ifElse_010<T, U>;
    <X extends "001">(): <T, V>(_fn: PH, _onTrue: PH, onFalse: (v: T) => V) => ifElse_001<T, V>;
...
export type ifElse_100<T> = {
    ...
    <X extends "11">(): <U, V>(onTrue: (v: T) => U, onFalse: (v: T) => V) => ifElse_111<T, U, V>;
    <X extends "1">(): <U>(onTrue: (v: T) => U) => ifElse_110<T, U>;
    <X extends "01">(): <V>(_onTrue: PH, onFalse: (v: T) => V) => ifElse_101<T, V>;
...
export type ifElse_010<T, U> = {
    ...
    <X extends "11">(): <V>(fn: Pred<T>, onFalse: (v: T) => V) => ifElse_111<T, U, V>;
    <X extends "1">(): (fn: Pred<T>) => ifElse_110<T, U>;
    <X extends "01">(): <V>(_fn: PH, onFalse: (v: T) => V) => ifElse_011<T, U, V>;
...
export type ifElse_001<T, V> = {
    ...
    <X extends "11">(): <U>(fn: Pred<T>, onTrue: (v: T) => U) => ifElse_111<T, U, V>;
    <X extends "1">(): (fn: Pred<T>) => ifElse_101<T, V>;
    <X extends "01">(): <U>(_fn: PH, onTrue: (v: T) => U) => ifElse_011<T, U, V>;
...
export type indexBy_00 = {
    ...
    <X extends "11">(): <T>(fn: (a: T) => Prop, list: List<T>) => indexBy_11<T>;
    <X extends "1">(): <T>(fn: (a: T) => Prop) => indexBy_10<T>;
    <X extends "01">(): <T>(_fn: PH, list: List<T>) => indexBy_01<T>;
...
export type indexOf_00 = {
    ...
    <X extends "11">(): <T>(target: T, list: List<T>) => indexOf_11<T>;
    <X extends "1">(): <T>(target: T) => indexOf_10<T>;
    <X extends "01">(): <T>(_target: PH, list: List<T>) => indexOf_01<T>;
...
export type insert_000 = {
    ...
    <X extends "111">(): <T>(index: number, elt: T, list: List<T>) => insert_111<T>;
    <X extends "11">(): <T>(index: number, elt: T) => insert_110<T>;
    <X extends "101">(): <T>(index: number, _elt: PH, list: List<T>) => insert_101<T>;
    <X extends "1">(): (index: number) => insert_100;
    <X extends "011">(): <T>(_index: PH, elt: T, list: List<T>) => insert_011<T>;
    <X extends "01">(): <T>(_index: PH, elt: T) => insert_010<T>;
    <X extends "001">(): <T>(_index: PH, _elt: PH, list: List<T>) => insert_001<T>;
    (index: number): insert_100;
};
export type insert_100 = {
    <T>(_elt: PH, list: List<T>): insert_101<T>;
    <T>(elt: T, list: List<T>): insert_111<T>;
    <X extends "11">(): <T>(elt: T, list: List<T>) => insert_111<T>;
    <X extends "1">(): <T>(elt: T) => insert_110<T>;
    <X extends "01">(): <T>(_elt: PH, list: List<T>) => insert_101<T>;
    <T>(elt: T): insert_110<T>;
};
export type insert_010<T> = {
    (_index: PH, list: List<T>): insert_011<T>;
    (index: number, list: List<T>): insert_111<T>;
    <X extends "11">(): (index: number, list: List<T>) => insert_111<T>;
    <X extends "1">(): (index: number) => insert_110<T>;
    <X extends "01">(): (_index: PH, list: List<T>) => insert_011<T>;
...
export type insert_001<T> = {
    ...
    <X extends "11">(): (index: number, elt: T) => insert_111<T>;
    <X extends "1">(): (index: number) => insert_101<T>;
    <X extends "01">(): (_index: PH, elt: T) => insert_011<T>;
...
export type insertAll_000 = {
    ...
    <X extends "111">(): <T, U>(index: number, elts: List<T>, list: List<U>) => insertAll_111<T, U>;
    <X extends "11">(): <T>(index: number, elts: List<T>) => insertAll_110<T>;
    <X extends "101">(): <U>(index: number, _elts: PH, list: List<U>) => insertAll_101<U>;
    <X extends "1">(): (index: number) => insertAll_100;
    <X extends "011">(): <T, U>(_index: PH, elts: List<T>, list: List<U>) => insertAll_011<T, U>;
    <X extends "01">(): <T>(_index: PH, elts: List<T>) => insertAll_010<T>;
    <X extends "001">(): <U>(_index: PH, _elts: PH, list: List<U>) => insertAll_001<U>;
...
export type insertAll_100 = {
    ...
    <X extends "11">(): <T, U>(elts: List<T>, list: List<U>) => insertAll_111<T, U>;
    <X extends "1">(): <T>(elts: List<T>) => insertAll_110<T>;
    <X extends "01">(): <U>(_elts: PH, list: List<U>) => insertAll_101<U>;
...
export type insertAll_010<T> = {
    ...
    <X extends "11">(): <U>(index: number, list: List<U>) => insertAll_111<T, U>;
    <X extends "1">(): (index: number) => insertAll_110<T>;
    <X extends "01">(): <U>(_index: PH, list: List<U>) => insertAll_011<T, U>;
...
export type insertAll_001<U> = {
    ...
    <X extends "11">(): <T>(index: number, elts: List<T>) => insertAll_111<T, U>;
    <X extends "1">(): (index: number) => insertAll_101<U>;
    <X extends "01">(): <T>(_index: PH, elts: List<T>) => insertAll_011<T, U>;
...
export type intersection_00 = {
    ...
    <X extends "11">(): <T, U>(list1: List<T>, list2: List<U>) => intersection_11<T, U>;
    <X extends "1">(): <T>(list1: List<T>) => intersection_10<T>;
    <X extends "01">(): <U>(_list1: PH, list2: List<U>) => intersection_01<U>;
...
export type intersectionWith_000 = {
    ...
    <X extends "111">(): <T>(pred: (a: T, b: T) => boolean, list1: List<T>, list2: List<T>) => intersectionWith_111<T>;
    <X extends "11">(): <T>(pred: (a: T, b: T) => boolean, list1: List<T>) => intersectionWith_110<T>;
    <X extends "101">(): <T>(pred: (a: T, b: T) => boolean, _list1: PH, list2: List<T>) => intersectionWith_101<T>;
    <X extends "1">(): <T>(pred: (a: T, b: T) => boolean) => intersectionWith_100<T>;
    <X extends "011">(): <T>(_pred: PH, list1: List<T>, list2: List<T>) => intersectionWith_011<T>;
    <X extends "01">(): <T>(_pred: PH, list1: List<T>) => intersectionWith_010<T>;
    <X extends "001">(): <T>(_pred: PH, _list1: PH, list2: List<T>) => intersectionWith_001<T>;
...
export type intersectionWith_100<T> = {
    ...
    <X extends "11">(): (list1: List<T>, list2: List<T>) => intersectionWith_111<T>;
    <X extends "1">(): (list1: List<T>) => intersectionWith_110<T>;
    <X extends "01">(): (_list1: PH, list2: List<T>) => intersectionWith_101<T>;
...
export type intersectionWith_010<T> = {
    ...
    <X extends "11">(): (pred: (a: T, b: T) => boolean, list2: List<T>) => intersectionWith_111<T>;
    <X extends "1">(): (pred: (a: T, b: T) => boolean) => intersectionWith_110<T>;
    <X extends "01">(): (_pred: PH, list2: List<T>) => intersectionWith_011<T>;
...
export type intersectionWith_001<T> = {
    ...
    <X extends "11">(): (pred: (a: T, b: T) => boolean, list1: List<T>) => intersectionWith_111<T>;
    <X extends "1">(): (pred: (a: T, b: T) => boolean) => intersectionWith_101<T>;
    <X extends "01">(): (_pred: PH, list1: List<T>) => intersectionWith_011<T>;
...
export type intersperse_00 = {
    ...
    <X extends "11">(): <T>(separator: T, list: List<T>) => intersperse_11<T>;
    <X extends "1">(): <T>(separator: T) => intersperse_10<T>;
    <X extends "01">(): <T>(_separator: PH, list: List<T>) => intersperse_01<T>;
...
export type into_000 = {
    ...
    <X extends "111">(): <T, U, V extends AccOpts<T, U>>(acc: V, xf: (list: List<T>) => U, list: List<T>) => into_111<T, U, V>;
    <X extends "11">(): <T, U, V extends AccOpts<T, U>>(acc: V, xf: (list: List<T>) => U) => into_110<T, U, V>;
    <X extends "101">(): <T, V extends AccOpts<T, U>>(acc: V, _xf: PH, list: List<T>) => into_101<T, V>;
    <X extends "1">(): <V extends AccOpts<T, U>>(acc: V) => into_100<V>;
    <X extends "011">(): <T, U>(_acc: PH, xf: (list: List<T>) => U, list: List<T>) => into_011<T, U>;
    <X extends "01">(): <T, U>(_acc: PH, xf: (list: List<T>) => U) => into_010<T, U>;
    <X extends "001">(): <T>(_acc: PH, _xf: PH, list: List<T>) => into_001<T>;
...
export type into_100<V extends AccOpts<T, U>> = {
    ...
    <X extends "11">(): <T, U>(xf: (list: List<T>) => U, list: List<T>) => into_111<T, U, V>;
    <X extends "1">(): <T, U>(xf: (list: List<T>) => U) => into_110<T, U, V>;
    <X extends "01">(): <T>(_xf: PH, list: List<T>) => into_101<T, V>;
...
export type into_010<T, U> = {
    ...
    <X extends "11">(): <V extends AccOpts<T, U>>(acc: V, list: List<T>) => into_111<T, U, V>;
    <X extends "1">(): <V extends AccOpts<T, U>>(acc: V) => into_110<T, U, V>;
    <X extends "01">(): (_acc: PH, list: List<T>) => into_011<T, U>;
...
export type into_001<T> = {
    ...
    <X extends "11">(): <U, V extends AccOpts<T, U>>(acc: V, xf: (list: List<T>) => U) => into_111<T, U, V>;
    <X extends "1">(): <V extends AccOpts<T, U>>(acc: V) => into_101<T, V>;
    <X extends "01">(): <U>(_acc: PH, xf: (list: List<T>) => U) => into_011<T, U>;
...
export type invoker_000 = {
    ...
    <X extends "111">(): <T>(len: number, name: Prop, obj: T) => invoker_111<T>;
    <X extends "11">(): (len: number, name: Prop) => invoker_110;
    <X extends "101">(): <T>(len: number, _name: PH, obj: T) => invoker_101<T>;
    <X extends "1">(): (len: number) => invoker_100;
    <X extends "011">(): <T>(_len: PH, name: Prop, obj: T) => invoker_011<T>;
    <X extends "01">(): (_len: PH, name: Prop) => invoker_010;
    <X extends "001">(): <T>(_len: PH, _name: PH, obj: T) => invoker_001<T>;
    (len: number): invoker_100;
};
export type invoker_100 = {
    <T>(_name: PH, obj: T): invoker_101<T>;
    <T>(name: Prop, obj: T): invoker_111<T>;
    <X extends "11">(): <T>(name: Prop, obj: T) => invoker_111<T>;
    <X extends "1">(): (name: Prop) => invoker_110;
    <X extends "01">(): <T>(_name: PH, obj: T) => invoker_101<T>;
    (name: Prop): invoker_110;
};
export type invoker_010 = {
    <T>(_len: PH, obj: T): invoker_011<T>;
    <T>(len: number, obj: T): invoker_111<T>;
    <X extends "11">(): <T>(len: number, obj: T) => invoker_111<T>;
    <X extends "1">(): (len: number) => invoker_110;
    <X extends "01">(): <T>(_len: PH, obj: T) => invoker_011<T>;
...
export type invoker_001<T> = {
    ...
    <X extends "11">(): (len: number, name: Prop) => invoker_111<T>;
    <X extends "1">(): (len: number) => invoker_101<T>;
    <X extends "01">(): (_len: PH, name: Prop) => invoker_011<T>;
...
export type is_00 = {
    ...
    <X extends "11">(): <T>(ctor: Type<T>, val: any) => is_11<T>;
    <X extends "1">(): <T>(ctor: Type<T>) => is_10<T>;
    <X extends "01">(): (_ctor: PH, val: any) => is_01;
...
export type join_00 = {
    ...
    <X extends "11">(): (x: Prop, xs: Array<any>) => join_11;
    <X extends "1">(): (x: Prop) => join_10;
    <X extends "01">(): (_x: PH, xs: Array<any>) => join_01;
    (x: Prop): join_10;
};
export type join_10 = {
...
export type lastIndexOf_00 = {
    ...
    <X extends "11">(): <T>(target: T, list: List<T>) => lastIndexOf_11<T>;
    <X extends "1">(): <T>(target: T) => lastIndexOf_10<T>;
    <X extends "01">(): <T>(_target: PH, list: List<T>) => lastIndexOf_01<T>;
...
export type lens_00 = {
    ...
    <X extends "11", K extends "base">(): <V, U extends Struct<any>>(getter: (s: U) => V, setter: (a: V, s: U) => U) => lens_base_11<V, U>;
    <X extends "1", K extends "base">(): <V, U extends Struct<any>>(getter: (s: U) => V) => lens_base_10<V, U>;
    <X extends "01", K extends "base">(): <V, U extends Struct<any>>(_getter: PH, setter: (a: V, s: U) => U) => lens_base_01<V, U>;
    <X extends "11", K extends "allows_setter_to_change_value_type">(): <T, U, V>(getter: (s: T) => U, setter: (a: U, s: T) => V) => lens_allows_setter_to_change_value_type_11<T, U, V>;
    <X extends "1", K extends "allows_setter_to_change_value_type">(): <T, U>(getter: (s: T) => U) => lens_allows_setter_to_change_value_type_10<T, U>;
    <X extends "01", K extends "allows_setter_to_change_value_type">(): <T, U, V>(_getter: PH, setter: (a: U, s: T) => V) => lens_allows_setter_to_change_value_type_01<T, U, V>;
...
export type lensIndex_0 = {
    ...
    <X extends "1", K extends "generics">(): (n: number) => lensIndex_generics_1;
    <X extends "1", K extends "non_generic">(): (n: number) => lensIndex_non_generic_1;
...
export type lensPath_0 = {
    ...
    <X extends "1", K extends "generics">(): (path: Path) => lensPath_generics_1;
    <X extends "1", K extends "non_generic">(): (path: Path) => lensPath_non_generic_1;
...
export type lensProp_0 = {
    ...
    <X extends "1", K extends "generics">(): (prop: Prop) => lensProp_generics_1;
    <X extends "1", K extends "non_generic">(): (prop: Prop) => lensProp_non_generic_1;
...
export type lt_00 = {
    ...
    <X extends "11">(): (a: number, b: number) => lt_11;
    <X extends "1">(): (a: number) => lt_10;
    <X extends "01">(): (_a: PH, b: number) => lt_01;
    (a: number): lt_10;
};
export type lt_10 = {
    (b: number): lt_11;
...
export type lte_00 = {
    ...
    <X extends "11">(): (a: number, b: number) => lte_11;
    <X extends "1">(): (a: number) => lte_10;
    <X extends "01">(): (_a: PH, b: number) => lte_01;
    (a: number): lte_10;
};
export type lte_10 = {
    (b: number): lte_11;
...
export type mapAccum_000 = {
    ...
    <X extends "111">(): <T, U, TResult>(fn: (acc: U, value: T) => [U, TResult], acc: U, list: List<T>) => mapAccum_111<T, U, TResult>;
    <X extends "11">(): <T, U, TResult>(fn: (acc: U, value: T) => [U, TResult], acc: U) => mapAccum_110<T, U, TResult>;
    <X extends "101">(): <T, U, TResult>(fn: (acc: U, value: T) => [U, TResult], _acc: PH, list: List<T>) => mapAccum_101<T, U, TResult>;
    <X extends "1">(): <T, U, TResult>(fn: (acc: U, value: T) => [U, TResult]) => mapAccum_100<T, U, TResult>;
    <X extends "011">(): <T, U>(_fn: PH, acc: U, list: List<T>) => mapAccum_011<T, U>;
    <X extends "01">(): <U>(_fn: PH, acc: U) => mapAccum_010<U>;
    <X extends "001">(): <T>(_fn: PH, _acc: PH, list: List<T>) => mapAccum_001<T>;
...
export type mapAccum_100<T, U, TResult> = {
    ...
    <X extends "11">(): (acc: U, list: List<T>) => mapAccum_111<T, U, TResult>;
    <X extends "1">(): (acc: U) => mapAccum_110<T, U, TResult>;
    <X extends "01">(): (_acc: PH, list: List<T>) => mapAccum_101<T, U, TResult>;
...
export type mapAccum_010<U> = {
    ...
    <X extends "11">(): <T, TResult>(fn: (acc: U, value: T) => [U, TResult], list: List<T>) => mapAccum_111<T, U, TResult>;
    <X extends "1">(): <T, TResult>(fn: (acc: U, value: T) => [U, TResult]) => mapAccum_110<T, U, TResult>;
    <X extends "01">(): <T>(_fn: PH, list: List<T>) => mapAccum_011<T, U>;
...
export type mapAccum_001<T> = {
    ...
    <X extends "11">(): <U, TResult>(fn: (acc: U, value: T) => [U, TResult], acc: U) => mapAccum_111<T, U, TResult>;
    <X extends "1">(): <U, TResult>(fn: (acc: U, value: T) => [U, TResult]) => mapAccum_101<T, U, TResult>;
    <X extends "01">(): <U>(_fn: PH, acc: U) => mapAccum_011<T, U>;
...
export type mapAccumRight_000 = {
    ...
    <X extends "111">(): <T, U, TResult>(fn: (value: T, acc: U) => [TResult, U], acc: U, list: List<T>) => mapAccumRight_111<T, U, TResult>;
    <X extends "11">(): <T, U, TResult>(fn: (value: T, acc: U) => [TResult, U], acc: U) => mapAccumRight_110<T, U, TResult>;
    <X extends "101">(): <T, U, TResult>(fn: (value: T, acc: U) => [TResult, U], _acc: PH, list: List<T>) => mapAccumRight_101<T, U, TResult>;
    <X extends "1">(): <T, U, TResult>(fn: (value: T, acc: U) => [TResult, U]) => mapAccumRight_100<T, U, TResult>;
    <X extends "011">(): <T, U>(_fn: PH, acc: U, list: List<T>) => mapAccumRight_011<T, U>;
    <X extends "01">(): <U>(_fn: PH, acc: U) => mapAccumRight_010<U>;
    <X extends "001">(): <T>(_fn: PH, _acc: PH, list: List<T>) => mapAccumRight_001<T>;
...
export type mapAccumRight_100<T, U, TResult> = {
    ...
    <X extends "11">(): (acc: U, list: List<T>) => mapAccumRight_111<T, U, TResult>;
    <X extends "1">(): (acc: U) => mapAccumRight_110<T, U, TResult>;
    <X extends "01">(): (_acc: PH, list: List<T>) => mapAccumRight_101<T, U, TResult>;
...
export type mapAccumRight_010<U> = {
    ...
    <X extends "11">(): <T, TResult>(fn: (value: T, acc: U) => [TResult, U], list: List<T>) => mapAccumRight_111<T, U, TResult>;
    <X extends "1">(): <T, TResult>(fn: (value: T, acc: U) => [TResult, U]) => mapAccumRight_110<T, U, TResult>;
    <X extends "01">(): <T>(_fn: PH, list: List<T>) => mapAccumRight_011<T, U>;
...
export type mapAccumRight_001<T> = {
    ...
    <X extends "11">(): <U, TResult>(fn: (value: T, acc: U) => [TResult, U], acc: U) => mapAccumRight_111<T, U, TResult>;
    <X extends "1">(): <U, TResult>(fn: (value: T, acc: U) => [TResult, U]) => mapAccumRight_101<T, U, TResult>;
    <X extends "01">(): <U>(_fn: PH, acc: U) => mapAccumRight_011<T, U>;
...
export type mapIndexed_000 = {
    ...
    <X extends "111">(): <T, U>(fn: (value: T, acc: U) => [TResult, U], acc: U, list: List<T>) => mapIndexed_111<T, U>;
    <X extends "11">(): <T, U>(fn: (value: T, acc: U) => [TResult, U], acc: U) => mapIndexed_110<T, U>;
    <X extends "101">(): <T, U>(fn: (value: T, acc: U) => [TResult, U], _acc: PH, list: List<T>) => mapIndexed_101<T, U>;
    <X extends "1">(): <T, U>(fn: (value: T, acc: U) => [TResult, U]) => mapIndexed_100<T, U>;
    <X extends "011">(): <T, U>(_fn: PH, acc: U, list: List<T>) => mapIndexed_011<T, U>;
    <X extends "01">(): <U>(_fn: PH, acc: U) => mapIndexed_010<U>;
    <X extends "001">(): <T>(_fn: PH, _acc: PH, list: List<T>) => mapIndexed_001<T>;
...
export type mapIndexed_100<T, U> = {
    ...
    <X extends "11">(): (acc: U, list: List<T>) => mapIndexed_111<T, U>;
    <X extends "1">(): (acc: U) => mapIndexed_110<T, U>;
    <X extends "01">(): (_acc: PH, list: List<T>) => mapIndexed_101<T, U>;
...
export type mapIndexed_010<U> = {
    ...
    <X extends "11">(): <T>(fn: (value: T, acc: U) => [TResult, U], list: List<T>) => mapIndexed_111<T, U>;
    <X extends "1">(): <T>(fn: (value: T, acc: U) => [TResult, U]) => mapIndexed_110<T, U>;
    <X extends "01">(): <T>(_fn: PH, list: List<T>) => mapIndexed_011<T, U>;
...
export type mapIndexed_001<T> = {
    ...
    <X extends "11">(): <U>(fn: (value: T, acc: U) => [TResult, U], acc: U) => mapIndexed_111<T, U>;
    <X extends "1">(): <U>(fn: (value: T, acc: U) => [TResult, U]) => mapIndexed_101<T, U>;
    <X extends "01">(): <U>(_fn: PH, acc: U) => mapIndexed_011<T, U>;
...
export type mapObjIndexed_00 = {
    ...
    <X extends "11">(): <T, V, M extends Obj<T>>(fn: (value: T, key: string, obj?: M) => V, obj: M) => mapObjIndexed_11<T, V, M>;
    <X extends "1">(): <T, V, M extends Obj<T>>(fn: (value: T, key: string, obj?: M) => V) => mapObjIndexed_10<T, V, M>;
    <X extends "01">(): <M extends Obj<T>>(_fn: PH, obj: M) => mapObjIndexed_01<M>;
...
export type match_00 = {
    ...
    <X extends "11">(): (regexp: RegExp, str: string) => match_11;
    <X extends "1">(): (regexp: RegExp) => match_10;
    <X extends "01">(): (_regexp: PH, str: string) => match_01;
...
export type mathMod_00 = {
    ...
    <X extends "11">(): (a: number, b: number) => mathMod_11;
    <X extends "1">(): (a: number) => mathMod_10;
    <X extends "01">(): (_a: PH, b: number) => mathMod_01;
    (a: number): mathMod_10;
};
...
export type max_00 = {
    ...
    <X extends "11">(): <T extends Ord>(a: T, b: T) => max_11<T>;
    <X extends "1">(): <T extends Ord>(a: T) => max_10<T>;
    <X extends "01">(): <T extends Ord>(_a: PH, b: T) => max_01<T>;
...
export type maxBy_000 = {
    ...
    <X extends "111">(): <T>(keyFn: (a: T) => Ord, a: T, b: T) => maxBy_111<T>;
    <X extends "11">(): <T>(keyFn: (a: T) => Ord, a: T) => maxBy_110<T>;
    <X extends "101">(): <T>(keyFn: (a: T) => Ord, _a: PH, b: T) => maxBy_101<T>;
    <X extends "1">(): <T>(keyFn: (a: T) => Ord) => maxBy_100<T>;
    <X extends "011">(): <T>(_keyFn: PH, a: T, b: T) => maxBy_011<T>;
    <X extends "01">(): <T>(_keyFn: PH, a: T) => maxBy_010<T>;
    <X extends "001">(): <T>(_keyFn: PH, _a: PH, b: T) => maxBy_001<T>;
    <T>(keyFn: (a: T) => Ord): maxBy_100<T>;
};
export type maxBy_100<T> = {
    (_a: PH, b: T): maxBy_101<T>;
    (a: T, b: T): maxBy_111<T>;
    <X extends "11">(): (a: T, b: T) => maxBy_111<T>;
    <X extends "1">(): (a: T) => maxBy_110<T>;
    <X extends "01">(): (_a: PH, b: T) => maxBy_101<T>;
    (a: T): maxBy_110<T>;
};
export type maxBy_010<T> = {
    (_keyFn: PH, b: T): maxBy_011<T>;
    (keyFn: (a: T) => Ord, b: T): maxBy_111<T>;
    <X extends "11">(): (keyFn: (a: T) => Ord, b: T) => maxBy_111<T>;
    <X extends "1">(): (keyFn: (a: T) => Ord) => maxBy_110<T>;
    <X extends "01">(): (_keyFn: PH, b: T) => maxBy_011<T>;
...
export type maxBy_001<T> = {
    ...
    <X extends "11">(): (keyFn: (a: T) => Ord, a: T) => maxBy_111<T>;
    <X extends "1">(): (keyFn: (a: T) => Ord) => maxBy_101<T>;
    <X extends "01">(): (_keyFn: PH, a: T) => maxBy_011<T>;
...
export type merge_00 = {
    ...
    <X extends "11">(): <T1 extends Struct<V1>, T2 extends Struct<V2>>(a: T1, b: T2) => merge_11<T1, T2>;
    <X extends "1">(): <T1 extends Struct<V1>>(a: T1) => merge_10<T1>;
    <X extends "01">(): <T2 extends Struct<V2>>(_a: PH, b: T2) => merge_01<T2>;
...
export type mergeWith_000 = {
    ...
    <X extends "111">(): <U, V>(fn: (x: any, z: any) => any, a: U, b: V) => mergeWith_111<U, V>;
    <X extends "11">(): <U>(fn: (x: any, z: any) => any, a: U) => mergeWith_110<U>;
    <X extends "101">(): <V>(fn: (x: any, z: any) => any, _a: PH, b: V) => mergeWith_101<V>;
    <X extends "1">(): (fn: (x: any, z: any) => any) => mergeWith_100;
    <X extends "011">(): <U, V>(_fn: PH, a: U, b: V) => mergeWith_011<U, V>;
    <X extends "01">(): <U>(_fn: PH, a: U) => mergeWith_010<U>;
    <X extends "001">(): <V>(_fn: PH, _a: PH, b: V) => mergeWith_001<V>;
    (fn: (x: any, z: any) => any): mergeWith_100;
};
export type mergeWith_100 = {
    <V>(_a: PH, b: V): mergeWith_101<V>;
    <U, V>(a: U, b: V): mergeWith_111<U, V>;
    <X extends "11">(): <U, V>(a: U, b: V) => mergeWith_111<U, V>;
    <X extends "1">(): <U>(a: U) => mergeWith_110<U>;
    <X extends "01">(): <V>(_a: PH, b: V) => mergeWith_101<V>;
    <U>(a: U): mergeWith_110<U>;
};
export type mergeWith_010<U> = {
    <V>(_fn: PH, b: V): mergeWith_011<U, V>;
    <V>(fn: (x: any, z: any) => any, b: V): mergeWith_111<U, V>;
    <X extends "11">(): <V>(fn: (x: any, z: any) => any, b: V) => mergeWith_111<U, V>;
    <X extends "1">(): (fn: (x: any, z: any) => any) => mergeWith_110<U>;
    <X extends "01">(): <V>(_fn: PH, b: V) => mergeWith_011<U, V>;
...
export type mergeWith_001<V> = {
    ...
    <X extends "11">(): <U>(fn: (x: any, z: any) => any, a: U) => mergeWith_111<U, V>;
    <X extends "1">(): (fn: (x: any, z: any) => any) => mergeWith_101<V>;
    <X extends "01">(): <U>(_fn: PH, a: U) => mergeWith_011<U, V>;
...
export type mergeWithKey_000 = {
    ...
    <X extends "111">(): <U, V>(fn: (str: string, x: any, z: any) => any, a: U, b: V) => mergeWithKey_111<U, V>;
    <X extends "11">(): <U>(fn: (str: string, x: any, z: any) => any, a: U) => mergeWithKey_110<U>;
    <X extends "101">(): <V>(fn: (str: string, x: any, z: any) => any, _a: PH, b: V) => mergeWithKey_101<V>;
    <X extends "1">(): (fn: (str: string, x: any, z: any) => any) => mergeWithKey_100;
    <X extends "011">(): <U, V>(_fn: PH, a: U, b: V) => mergeWithKey_011<U, V>;
    <X extends "01">(): <U>(_fn: PH, a: U) => mergeWithKey_010<U>;
    <X extends "001">(): <V>(_fn: PH, _a: PH, b: V) => mergeWithKey_001<V>;
...
export type mergeWithKey_100 = {
    ...
    <X extends "11">(): <U, V>(a: U, b: V) => mergeWithKey_111<U, V>;
    <X extends "1">(): <U>(a: U) => mergeWithKey_110<U>;
    <X extends "01">(): <V>(_a: PH, b: V) => mergeWithKey_101<V>;
...
export type mergeWithKey_010<U> = {
    ...
    <X extends "11">(): <V>(fn: (str: string, x: any, z: any) => any, b: V) => mergeWithKey_111<U, V>;
    <X extends "1">(): (fn: (str: string, x: any, z: any) => any) => mergeWithKey_110<U>;
    <X extends "01">(): <V>(_fn: PH, b: V) => mergeWithKey_011<U, V>;
...
export type mergeWithKey_001<V> = {
    ...
    <X extends "11">(): <U>(fn: (str: string, x: any, z: any) => any, a: U) => mergeWithKey_111<U, V>;
    <X extends "1">(): (fn: (str: string, x: any, z: any) => any) => mergeWithKey_101<V>;
    <X extends "01">(): <U>(_fn: PH, a: U) => mergeWithKey_011<U, V>;
...
export type min_00 = {
    ...
    <X extends "11">(): <T extends Ord>(a: T, b: T) => min_11<T>;
    <X extends "1">(): <T extends Ord>(a: T) => min_10<T>;
    <X extends "01">(): <T extends Ord>(_a: PH, b: T) => min_01<T>;
...
export type minBy_000 = {
    ...
    <X extends "111">(): <T>(keyFn: (a: T) => Ord, a: T, b: T) => minBy_111<T>;
    <X extends "11">(): <T>(keyFn: (a: T) => Ord, a: T) => minBy_110<T>;
    <X extends "101">(): <T>(keyFn: (a: T) => Ord, _a: PH, b: T) => minBy_101<T>;
    <X extends "1">(): <T>(keyFn: (a: T) => Ord) => minBy_100<T>;
    <X extends "011">(): <T>(_keyFn: PH, a: T, b: T) => minBy_011<T>;
    <X extends "01">(): <T>(_keyFn: PH, a: T) => minBy_010<T>;
    <X extends "001">(): <T>(_keyFn: PH, _a: PH, b: T) => minBy_001<T>;
    <T>(keyFn: (a: T) => Ord): minBy_100<T>;
};
export type minBy_100<T> = {
    (_a: PH, b: T): minBy_101<T>;
    (a: T, b: T): minBy_111<T>;
    <X extends "11">(): (a: T, b: T) => minBy_111<T>;
    <X extends "1">(): (a: T) => minBy_110<T>;
    <X extends "01">(): (_a: PH, b: T) => minBy_101<T>;
    (a: T): minBy_110<T>;
};
export type minBy_010<T> = {
    (_keyFn: PH, b: T): minBy_011<T>;
    (keyFn: (a: T) => Ord, b: T): minBy_111<T>;
    <X extends "11">(): (keyFn: (a: T) => Ord, b: T) => minBy_111<T>;
    <X extends "1">(): (keyFn: (a: T) => Ord) => minBy_110<T>;
    <X extends "01">(): (_keyFn: PH, b: T) => minBy_011<T>;
...
export type minBy_001<T> = {
    ...
    <X extends "11">(): (keyFn: (a: T) => Ord, a: T) => minBy_111<T>;
    <X extends "1">(): (keyFn: (a: T) => Ord) => minBy_101<T>;
    <X extends "01">(): (_keyFn: PH, a: T) => minBy_011<T>;
...
export type modulo_00 = {
    ...
    <X extends "11">(): (a: number, b: number) => modulo_11;
    <X extends "1">(): (a: number) => modulo_10;
    <X extends "01">(): (_a: PH, b: number) => modulo_01;
    (a: number): modulo_10;
};
...
export type multiply_00 = {
    ...
    <X extends "11">(): (a: number, b: number) => multiply_11;
    <X extends "1">(): (a: number) => multiply_10;
    <X extends "01">(): (_a: PH, b: number) => multiply_01;
...
export type nAry_00 = {
    ...
    <X extends "11">(): <T>(n: number, fn: Variadic<T>) => nAry_11<T>;
    <X extends "1">(): (n: number) => nAry_10;
    <X extends "01">(): <T>(_n: PH, fn: Variadic<T>) => nAry_01<T>;
    (n: number): nAry_10;
};
export type nAry_10 = {
...
export type none_00 = {
    ...
    <X extends "11">(): <T>(fn: (a: T) => boolean, list: List<T>) => none_11<T>;
    <X extends "1">(): <T>(fn: (a: T) => boolean) => none_10<T>;
    <X extends "01">(): <T>(_fn: PH, list: List<T>) => none_01<T>;
...
export type nth_00 = {
    ...
    <X extends "11">(): <T>(n: number, list: list<T>) => nth_11<T>;
    <X extends "1">(): (n: number) => nth_10;
    <X extends "01">(): <T>(_n: PH, list: list<T>) => nth_01<T>;
    (n: number): nth_10;
};
export type nth_10 = {
...
export type objOf_00 = {
    ...
    <X extends "11">(): <K extends string, V>(key: K, value: V) => objOf_11<K, V>;
    <X extends "1">(): <K extends string>(key: K) => objOf_10<K>;
    <X extends "01">(): <V>(_key: PH, value: V) => objOf_01<V>;
...
export type omit_00 = {
    ...
    <X extends "11">(): <T>(names: List<Prop>, obj: T) => omit_11<T>;
    <X extends "1">(): (names: List<Prop>) => omit_10;
    <X extends "01">(): <T>(_names: PH, obj: T) => omit_01<T>;
...
export type or_00 = {
    ...
    <X extends "11", K extends "dispatch_to_some__or__method">(): <T extends {
            or?: (alt: U) => T | U;
        }, U>(fn1: T, val2: U) => or_dispatch_to_some__or__method_11<T, U>;
    <X extends "1", K extends "dispatch_to_some__or__method">(): <T extends {
            or?: (alt: U) => T | U;
        }>(fn1: T) => or_dispatch_to_some__or__method_10<T>;
    <X extends "01", K extends "dispatch_to_some__or__method">(): <U>(_fn1: PH, val2: U) => or_dispatch_to_some__or__method_01<U>;
    <X extends "11", K extends "values">(): <T, U>(a: T, b: U) => or_values_11<T, U>;
    <X extends "1", K extends "values">(): <T>(a: T) => or_values_10<T>;
    <X extends "01", K extends "values">(): <U>(_a: PH, b: U) => or_values_01<U>;
...
export type over_000 = {
    ...
    <X extends "111", K extends "Functor_version">(): <V, T extends Functor<V>>(lens: Lens<T, V> | ManualLens<V> | UnknownLens, fn: (v: V) => V, value: T) => over_Functor_version_111<V, T>;
    <X extends "111", K extends "Functor_version_applied_to_array">(): <V, T extends List<V>>(lens: Lens<T, V> | ManualLens<V> | UnknownLens, fn: (v: V) => V, value: T) => over_Functor_version_applied_to_array_111<V, T>;
    <X extends "111", K extends "unbound_value">(): <T, V>(lens: Lens<T, V> | ManualLens<V> | UnknownLens, fn: (v: V) => V, value: T) => over_unbound_value_111<T, V>;
    <X extends "11">(): <T, V>(lens: Lens<T, V> | ManualLens<V> | UnknownLens, fn: (v: V) => V) => over_110<T, V>;
    <X extends "101">(): <T, V>(lens: Lens<T, V> | ManualLens<V> | UnknownLens, _fn: PH, value: T) => over_101<T, V>;
    <X extends "1">(): <T, V>(lens: Lens<T, V> | ManualLens<V> | UnknownLens) => over_100<T, V>;
    <X extends "011">(): <T, V>(_lens: PH, fn: (v: V) => V, value: T) => over_011<T, V>;
    <X extends "01">(): <V>(_lens: PH, fn: (v: V) => V) => over_010<V>;
    <X extends "001">(): <T>(_lens: PH, _fn: PH, value: T) => over_001<T>;
...
export type over_100<V, T extends Functor<V>> = {
    ...
    <X extends "11", K extends "Functor_version">(): (fn: (v: V) => V, value: T) => over_Functor_version_111<V, T>;
    <X extends "11", K extends "Functor_version_applied_to_array">(): (fn: (v: V) => V, value: T) => over_Functor_version_applied_to_array_111<V, T>;
    <X extends "11", K extends "unbound_value">(): (fn: (v: V) => V, value: T) => over_unbound_value_111<T, V>;
    <X extends "1">(): (fn: (v: V) => V) => over_110<T, V>;
    <X extends "01">(): (_fn: PH, value: T) => over_101<T, V>;
...
export type over_010<V> = {
    ...
    <X extends "11", K extends "Functor_version">(): <T extends Functor<V>>(lens: Lens<T, V> | ManualLens<V> | UnknownLens, value: T) => over_Functor_version_111<V, T>;
    <X extends "11", K extends "Functor_version_applied_to_array">(): <T extends List<V>>(lens: Lens<T, V> | ManualLens<V> | UnknownLens, value: T) => over_Functor_version_applied_to_array_111<V, T>;
    <X extends "11", K extends "unbound_value">(): <T>(lens: Lens<T, V> | ManualLens<V> | UnknownLens, value: T) => over_unbound_value_111<T, V>;
    <X extends "1">(): <T>(lens: Lens<T, V> | ManualLens<V> | UnknownLens) => over_110<T, V>;
    <X extends "01">(): <T>(_lens: PH, value: T) => over_011<T, V>;
...
export type over_110<V, T extends Functor<V>> = {
    ...
    <X extends "1", K extends "Functor_version">(): (value: T) => over_Functor_version_111<V, T>;
    <X extends "1", K extends "Functor_version_applied_to_array">(): (value: T) => over_Functor_version_applied_to_array_111<V, T>;
    <X extends "1", K extends "unbound_value">(): (value: T) => over_unbound_value_111<T, V>;
...
export type over_001<T extends Functor<V>> = {
    ...
    <X extends "11", K extends "Functor_version">(): <V>(lens: Lens<T, V> | ManualLens<V> | UnknownLens, fn: (v: V) => V) => over_Functor_version_111<V, T>;
    <X extends "11", K extends "Functor_version_applied_to_array">(): <V>(lens: Lens<T, V> | ManualLens<V> | UnknownLens, fn: (v: V) => V) => over_Functor_version_applied_to_array_111<V, T>;
    <X extends "11", K extends "unbound_value">(): <V>(lens: Lens<T, V> | ManualLens<V> | UnknownLens, fn: (v: V) => V) => over_unbound_value_111<T, V>;
    <X extends "1">(): <V>(lens: Lens<T, V> | ManualLens<V> | UnknownLens) => over_101<T, V>;
    <X extends "01">(): <V>(_lens: PH, fn: (v: V) => V) => over_011<T, V>;
...
export type over_101<V, T extends Functor<V>> = {
    ...
    <X extends "1", K extends "Functor_version">(): (fn: (v: V) => V) => over_Functor_version_111<V, T>;
    <X extends "1", K extends "Functor_version_applied_to_array">(): (fn: (v: V) => V) => over_Functor_version_applied_to_array_111<V, T>;
    <X extends "1", K extends "unbound_value">(): (fn: (v: V) => V) => over_unbound_value_111<T, V>;
...
export type over_011<V, T extends Functor<V>> = {
    ...
    <X extends "1", K extends "Functor_version">(): (lens: Lens<T, V> | ManualLens<V> | UnknownLens) => over_Functor_version_111<V, T>;
    <X extends "1", K extends "Functor_version_applied_to_array">(): (lens: Lens<T, V> | ManualLens<V> | UnknownLens) => over_Functor_version_applied_to_array_111<V, T>;
    <X extends "1", K extends "unbound_value">(): (lens: Lens<T, V> | ManualLens<V> | UnknownLens) => over_unbound_value_111<T, V>;
...
export type pair_00 = {
    ...
    <X extends "11">(): <F, S>(fst: F, snd: S) => pair_11<F, S>;
    <X extends "1">(): <F>(fst: F) => pair_10<F>;
    <X extends "01">(): <S>(_fst: PH, snd: S) => pair_01<S>;
    <F>(fst: F): pair_10<F>;
};
...
export type partial_00 = {
    ...
    <X extends "11">(): <T>(fn: Variadic<T>, args: any[]) => partial_11<T>;
    <X extends "1">(): <T>(fn: Variadic<T>) => partial_10<T>;
    <X extends "01">(): (_fn: PH, args: any[]) => partial_01;
...
export type partialRight_00 = {
    ...
    <X extends "11">(): <T>(fn: Variadic<T>, args: any[]) => partialRight_11<T>;
    <X extends "1">(): <T>(fn: Variadic<T>) => partialRight_10<T>;
    <X extends "01">(): (_fn: PH, args: any[]) => partialRight_01;
...
export type partition_00 = {
    ...
    <X extends "11", K extends "arrays">(): <T>(fn: (a: T) => boolean, list: List<T>) => partition_arrays_11<T>;
    <X extends "1", K extends "arrays">(): <T>(fn: (a: T) => boolean) => partition_arrays_10<T>;
    <X extends "01", K extends "arrays">(): <T>(_fn: PH, list: List<T>) => partition_arrays_01<T>;
    <X extends "11", K extends "objects">(): <T extends Obj<V>, U extends Obj<V>, V>(fn: (a: V) => boolean, obj: T & U) => partition_objects_11<T, U, V>;
    <X extends "1", K extends "objects">(): <V>(fn: (a: V) => boolean) => partition_objects_10<V>;
    <X extends "01", K extends "objects">(): <T extends Obj<V>, U extends Obj<V>>(_fn: PH, obj: T & U) => partition_objects_01<T, U>;
    <X extends "11", K extends "objects__alternative_notation">(): <T, U extends Obj<T>>(fn: (a: T) => boolean, obj: U) => partition_objects__alternative_notation_11<T, U>;
    <X extends "1", K extends "objects__alternative_notation">(): <T>(fn: (a: T) => boolean) => partition_objects__alternative_notation_10<T>;
    <X extends "01", K extends "objects__alternative_notation">(): <U extends Obj<T>>(_fn: PH, obj: U) => partition_objects__alternative_notation_01<U>;
...
export type pathEq_000 = {
    ...
    <X extends "111">(): (p: Path, v: any, o: any) => pathEq_111;
    <X extends "11">(): (p: Path, v: any) => pathEq_110;
    <X extends "101">(): (p: Path, _v: PH, o: any) => pathEq_101;
    <X extends "1">(): (p: Path) => pathEq_100;
    <X extends "011">(): (_p: PH, v: any, o: any) => pathEq_011;
    <X extends "01">(): (_p: PH, v: any) => pathEq_010;
    <X extends "001">(): (_p: PH, _v: PH, o: any) => pathEq_001;
    (p: Path): pathEq_100;
};
export type pathEq_100 = {
    (_v: PH, o: any): pathEq_101;
    (v: any, o: any): pathEq_111;
    <X extends "11">(): (v: any, o: any) => pathEq_111;
    <X extends "1">(): (v: any) => pathEq_110;
    <X extends "01">(): (_v: PH, o: any) => pathEq_101;
    (v: any): pathEq_110;
};
export type pathEq_010 = {
    (_p: PH, o: any): pathEq_011;
    (p: Path, o: any): pathEq_111;
    <X extends "11">(): (p: Path, o: any) => pathEq_111;
    <X extends "1">(): (p: Path) => pathEq_110;
    <X extends "01">(): (_p: PH, o: any) => pathEq_011;
    (p: Path): pathEq_110;
};
...
export type pathEq_001 = {
    ...
    <X extends "11">(): (p: Path, v: any) => pathEq_111;
    <X extends "1">(): (p: Path) => pathEq_101;
    <X extends "01">(): (_p: PH, v: any) => pathEq_011;
    (p: Path): pathEq_101;
};
...
export type pathOr_000 = {
    ...
    <X extends "111">(): <T>(d: T, p: Path, obj: Struct<any>) => pathOr_111<T>;
    <X extends "11">(): <T>(d: T, p: Path) => pathOr_110<T>;
    <X extends "101">(): <T>(d: T, _p: PH, obj: Struct<any>) => pathOr_101<T>;
    <X extends "1">(): <T>(d: T) => pathOr_100<T>;
    <X extends "011">(): (_d: PH, p: Path, obj: Struct<any>) => pathOr_011;
    <X extends "01">(): (_d: PH, p: Path) => pathOr_010;
    <X extends "001">(): (_d: PH, _p: PH, obj: Struct<any>) => pathOr_001;
    <T>(d: T): pathOr_100<T>;
};
export type pathOr_100<T> = {
    (_p: PH, obj: Struct<any>): pathOr_101<T>;
    (p: Path, obj: Struct<any>): pathOr_111<T>;
    <X extends "11">(): (p: Path, obj: Struct<any>) => pathOr_111<T>;
    <X extends "1">(): (p: Path) => pathOr_110<T>;
    <X extends "01">(): (_p: PH, obj: Struct<any>) => pathOr_101<T>;
    (p: Path): pathOr_110<T>;
};
export type pathOr_010 = {
    (_d: PH, obj: Struct<any>): pathOr_011;
    <T>(d: T, obj: Struct<any>): pathOr_111<T>;
    <X extends "11">(): <T>(d: T, obj: Struct<any>) => pathOr_111<T>;
    <X extends "1">(): <T>(d: T) => pathOr_110<T>;
    <X extends "01">(): (_d: PH, obj: Struct<any>) => pathOr_011;
    <T>(d: T): pathOr_110<T>;
};
...
export type pathOr_001 = {
    ...
    <X extends "11">(): <T>(d: T, p: Path) => pathOr_111<T>;
    <X extends "1">(): <T>(d: T) => pathOr_101<T>;
    <X extends "01">(): (_d: PH, p: Path) => pathOr_011;
    <T>(d: T): pathOr_101<T>;
};
...
export type pathSatisfies_000 = {
    ...
    <X extends "111">(): <T>(fn: Pred<T>, p: Path, obj: any) => pathSatisfies_111<T>;
    <X extends "11">(): <T>(fn: Pred<T>, p: Path) => pathSatisfies_110<T>;
    <X extends "101">(): <T>(fn: Pred<T>, _p: PH, obj: any) => pathSatisfies_101<T>;
    <X extends "1">(): <T>(fn: Pred<T>) => pathSatisfies_100<T>;
    <X extends "011">(): (_fn: PH, p: Path, obj: any) => pathSatisfies_011;
    <X extends "01">(): (_fn: PH, p: Path) => pathSatisfies_010;
    <X extends "001">(): (_fn: PH, _p: PH, obj: any) => pathSatisfies_001;
...
export type pathSatisfies_100<T> = {
    ...
    <X extends "11">(): (p: Path, obj: any) => pathSatisfies_111<T>;
    <X extends "1">(): (p: Path) => pathSatisfies_110<T>;
    <X extends "01">(): (_p: PH, obj: any) => pathSatisfies_101<T>;
...
export type pathSatisfies_010 = {
    ...
    <X extends "11">(): <T>(fn: Pred<T>, obj: any) => pathSatisfies_111<T>;
    <X extends "1">(): <T>(fn: Pred<T>) => pathSatisfies_110<T>;
    <X extends "01">(): (_fn: PH, obj: any) => pathSatisfies_011;
...
export type pathSatisfies_001 = {
    ...
    <X extends "11">(): <T>(fn: Pred<T>, p: Path) => pathSatisfies_111<T>;
    <X extends "1">(): <T>(fn: Pred<T>) => pathSatisfies_101<T>;
    <X extends "01">(): (_fn: PH, p: Path) => pathSatisfies_011;
...
export type pick_00 = {
    ...
    <X extends "11", K extends "generic_1">(): <T, K extends keyof T>(names: List<K>, obj: T) => pick_generic_1_11<T, K>;
    <X extends "1", K extends "generic_1">(): <K extends keyof T>(names: List<K>) => pick_generic_1_10<K>;
    <X extends "11", K extends "generic_2">(): <T>(names: List<Prop>, obj: T) => pick_generic_2_11<T>;
    <X extends "1", K extends "generic_2">(): (names: List<Prop>) => pick_generic_2_10;
    <X extends "01">(): <T>(_names: PH, obj: T) => pick_01<T>;
    (names: List<Prop>): pick_generic_2_10;
};
export type pick_01<T> = {
    <K extends keyof T>(names: List<K>): pick_generic_1_11<T, K>;
    <X extends "1", K extends "generic_1">(): <K extends keyof T>(names: List<K>) => pick_generic_1_11<T, K>;
    <X extends "1", K extends "generic_2">(): (names: List<Prop>) => pick_generic_2_11<T>;
...
export type pickAll_00 = {
    ...
    <X extends "11">(): <T, K>(names: List<K>, obj: T) => pickAll_11<T, K>;
    <X extends "1">(): <K>(names: List<K>) => pickAll_10<K>;
    <X extends "01">(): <T>(_names: PH, obj: T) => pickAll_01<T>;
...
export type pickBy_00 = {
    ...
    <X extends "11">(): <T>(pred: ObjPred<any>, obj: T) => pickBy_11<T>;
    <X extends "1">(): (pred: ObjPred<any>) => pickBy_10;
    <X extends "01">(): <T>(_pred: PH, obj: T) => pickBy_01<T>;
...
export type pluck_00 = {
    ...
    <X extends "11", K extends "infer">(): <T extends Struct<any>, K extends keyof T>(p: K, list: List<T>) => pluck_infer_11<T, K>;
    <X extends "1", K extends "infer">(): <K extends keyof T>(p: K) => pluck_infer_10<K>;
    <X extends "01", K extends "infer">(): <T extends Struct<any>>(_p: PH, list: List<T>) => pluck_infer_01<T>;
    <X extends "11", K extends "supply_return_object_type_manually_when_unable_to_infer_it___">(): (p: Prop, list: Struct<any>[]) => pluck_supply_return_object_type_manually_when_unable_to_infer_it____11;
    <X extends "1", K extends "supply_return_object_type_manually_when_unable_to_infer_it___">(): (p: Prop) => pluck_supply_return_object_type_manually_when_unable_to_infer_it____10;
    <X extends "01", K extends "supply_return_object_type_manually_when_unable_to_infer_it___">(): (_p: PH, list: Struct<any>[]) => pluck_supply_return_object_type_manually_when_unable_to_infer_it____01;
...
export type prepend_00 = {
    ...
    <X extends "11">(): <T>(el: T, list: List<T>) => prepend_11<T>;
    <X extends "1">(): <T>(el: T) => prepend_10<T>;
    <X extends "01">(): <T>(_el: PH, list: List<T>) => prepend_01<T>;
    <T>(el: T): prepend_10<T>;
};
...
export type project_00 = {
    ...
    <X extends "11", K extends "infer">(): <T, K extends keyof T>(props: List<K>, objs: List<T>) => project_infer_11<T, K>;
    <X extends "1", K extends "infer">(): <K extends keyof T>(props: List<K>) => project_infer_10<K>;
    <X extends "11", K extends "supply_return_object_type_manually_when_unable_to_infer_it___">(): <T>(props: List<Prop>, objs: List<T>) => project_supply_return_object_type_manually_when_unable_to_infer_it____11<T>;
    <X extends "1", K extends "supply_return_object_type_manually_when_unable_to_infer_it___">(): (props: List<Prop>) => project_supply_return_object_type_manually_when_unable_to_infer_it____10;
    <X extends "01">(): <T>(_props: PH, objs: List<T>) => project_01<T>;
...
export type project_01<T> = {
    ...
    <X extends "1", K extends "infer">(): <K extends keyof T>(props: List<K>) => project_infer_11<T, K>;
    <X extends "1", K extends "supply_return_object_type_manually_when_unable_to_infer_it___">(): (props: List<Prop>) => project_supply_return_object_type_manually_when_unable_to_infer_it____11<T>;
...
export type prop_00 = {
    ...
    <X extends "11", K extends "keyof_version">(): <T, K extends keyof T>(p: K, obj: T) => prop_keyof_version_11<T, K>;
    <X extends "11", K extends "Record_version__more_curry_friendly">(): <K extends string, T extends Record<K, V>>(p: K, obj: T) => prop_Record_version__more_curry_friendly_11<K, T>;
    <X extends "1">(): <K extends string>(p: K) => prop_10<K>;
    <X extends "01">(): <T extends Record<K, V>>(_p: PH, obj: T) => prop_01<T>;
    <K extends string>(p: K): prop_10<K>;
};
export type prop_10<K extends keyof T> = {
    <T>(obj: T): prop_keyof_version_11<T, K>;
    <X extends "1", K extends "keyof_version">(): <T>(obj: T) => prop_keyof_version_11<T, K>;
    <X extends "1", K extends "Record_version__more_curry_friendly">(): <T extends Record<K, V>>(obj: T) => prop_Record_version__more_curry_friendly_11<K, T>;
...
export type prop_01<T> = {
    ...
    <X extends "1", K extends "keyof_version">(): <K extends keyof T>(p: K) => prop_keyof_version_11<T, K>;
    <X extends "1", K extends "Record_version__more_curry_friendly">(): <K extends string>(p: K) => prop_Record_version__more_curry_friendly_11<K, T>;
...
export type propEq_000 = {
    ...
    <X extends "111">(): <T extends Struct<any>>(name: Prop, val: any, obj: T) => propEq_111<T>;
    <X extends "11">(): (name: Prop, val: any) => propEq_110;
    <X extends "101">(): <T extends Struct<any>>(name: Prop, _val: PH, obj: T) => propEq_101<T>;
    <X extends "1">(): (name: Prop) => propEq_100;
    <X extends "011">(): <T extends Struct<any>>(_name: PH, val: any, obj: T) => propEq_011<T>;
    <X extends "01">(): (_name: PH, val: any) => propEq_010;
    <X extends "001">(): <T extends Struct<any>>(_name: PH, _val: PH, obj: T) => propEq_001<T>;
...
export type propEq_100 = {
    ...
    <X extends "11">(): <T extends Struct<any>>(val: any, obj: T) => propEq_111<T>;
    <X extends "1">(): (val: any) => propEq_110;
    <X extends "01">(): <T extends Struct<any>>(_val: PH, obj: T) => propEq_101<T>;
    (val: any): propEq_110;
};
export type propEq_010 = {
    <T extends Struct<any>>(_name: PH, obj: T): propEq_011<T>;
    <T extends Struct<any>>(name: Prop, obj: T): propEq_111<T>;
    <X extends "11">(): <T extends Struct<any>>(name: Prop, obj: T) => propEq_111<T>;
    <X extends "1">(): (name: Prop) => propEq_110;
    <X extends "01">(): <T extends Struct<any>>(_name: PH, obj: T) => propEq_011<T>;
...
export type propEq_001<T extends Struct<any>> = {
    ...
    <X extends "11">(): (name: Prop, val: any) => propEq_111<T>;
    <X extends "1">(): (name: Prop) => propEq_101<T>;
    <X extends "01">(): (_name: PH, val: any) => propEq_011<T>;
...
export type propIs_000 = {
    ...
    <X extends "111", K extends "Record">(): <T extends Function, K extends string, U extends Record<K, V>>(type: T, name: K, obj: U) => propIs_Record_111<T, K, U>;
    <X extends "11", K extends "Record">(): <T extends Function, K extends string>(type: T, name: K) => propIs_Record_110<T, K>;
    <X extends "101", K extends "Record">(): <T extends Function, U extends Record<K, V>>(type: T, _name: PH, obj: U) => propIs_Record_101<T, U>;
    <X extends "1", K extends "Record">(): <T extends Function>(type: T) => propIs_Record_100<T>;
    <X extends "011", K extends "Record">(): <K extends string, U extends Record<K, V>>(_type: PH, name: K, obj: U) => propIs_Record_011<K, U>;
    <X extends "01", K extends "Record">(): <K extends string>(_type: PH, name: K) => propIs_Record_010<K>;
    <X extends "001", K extends "Record">(): <U extends Record<K, V>>(_type: PH, _name: PH, obj: U) => propIs_Record_001<U>;
    <X extends "111", K extends "curry_friendlier_fallback">(): (type: Function, name: Prop, obj: Struct<any>) => propIs_curry_friendlier_fallback_111;
    <X extends "11", K extends "curry_friendlier_fallback">(): (type: Function, name: Prop) => propIs_curry_friendlier_fallback_110;
    <X extends "101", K extends "curry_friendlier_fallback">(): (type: Function, _name: PH, obj: Struct<any>) => propIs_curry_friendlier_fallback_101;
    <X extends "1", K extends "curry_friendlier_fallback">(): (type: Function) => propIs_curry_friendlier_fallback_100;
    <X extends "011", K extends "curry_friendlier_fallback">(): (_type: PH, name: Prop, obj: Struct<any>) => propIs_curry_friendlier_fallback_011;
    <X extends "01", K extends "curry_friendlier_fallback">(): (_type: PH, name: Prop) => propIs_curry_friendlier_fallback_010;
    <X extends "001", K extends "curry_friendlier_fallback">(): (_type: PH, _name: PH, obj: Struct<any>) => propIs_curry_friendlier_fallback_001;
...
export type propIs_Record_100<T extends Function> = {
    ...
    <X extends "11">(): <K extends string, U extends Record<K, V>>(name: K, obj: U) => propIs_Record_111<T, K, U>;
    <X extends "1">(): <K extends string>(name: K) => propIs_Record_110<T, K>;
    <X extends "01">(): <U extends Record<K, V>>(_name: PH, obj: U) => propIs_Record_101<T, U>;
...
export type propIs_curry_friendlier_fallback_100 = {
    ...
    <X extends "11">(): (name: Prop, obj: Struct<any>) => propIs_curry_friendlier_fallback_111;
    <X extends "1">(): (name: Prop) => propIs_curry_friendlier_fallback_110;
    <X extends "01">(): (_name: PH, obj: Struct<any>) => propIs_curry_friendlier_fallback_101;
...
export type propIs_Record_010<K extends string> = {
    ...
    <X extends "11">(): <T extends Function, U extends Record<K, V>>(type: T, obj: U) => propIs_Record_111<T, K, U>;
    <X extends "1">(): <T extends Function>(type: T) => propIs_Record_110<T, K>;
    <X extends "01">(): <U extends Record<K, V>>(_type: PH, obj: U) => propIs_Record_011<K, U>;
...
export type propIs_curry_friendlier_fallback_010 = {
    ...
    <X extends "11">(): (type: Function, obj: Struct<any>) => propIs_curry_friendlier_fallback_111;
    <X extends "1">(): (type: Function) => propIs_curry_friendlier_fallback_110;
    <X extends "01">(): (_type: PH, obj: Struct<any>) => propIs_curry_friendlier_fallback_011;
...
export type propIs_Record_001<U extends Record<K, V>> = {
    ...
    <X extends "11">(): <T extends Function, K extends string>(type: T, name: K) => propIs_Record_111<T, K, U>;
    <X extends "1">(): <T extends Function>(type: T) => propIs_Record_101<T, U>;
    <X extends "01">(): <K extends string>(_type: PH, name: K) => propIs_Record_011<K, U>;
...
export type propIs_curry_friendlier_fallback_001 = {
    ...
    <X extends "11">(): (type: Function, name: Prop) => propIs_curry_friendlier_fallback_111;
    <X extends "1">(): (type: Function) => propIs_curry_friendlier_fallback_101;
    <X extends "01">(): (_type: PH, name: Prop) => propIs_curry_friendlier_fallback_011;
...
export type props_00 = {
    ...
    <X extends "11">(): <T>(ps: List<Prop>, obj: Struct<T>) => props_11<T>;
    <X extends "1">(): (ps: List<Prop>) => props_10;
    <X extends "01">(): <T>(_ps: PH, obj: Struct<T>) => props_01<T>;
...
export type propSatisfies_000 = {
    ...
    <X extends "111", K extends "Record">(): <V, K extends string, U extends Record<K, V>>(pred: Pred<V>, name: K, obj: U) => propSatisfies_Record_111<V, K, U>;
    <X extends "11", K extends "Record">(): <V, K extends string>(pred: Pred<V>, name: K) => propSatisfies_Record_110<V, K>;
    <X extends "101", K extends "Record">(): <V, U extends Record<K, V>>(pred: Pred<V>, _name: PH, obj: U) => propSatisfies_Record_101<V, U>;
    <X extends "1", K extends "Record">(): <V>(pred: Pred<V>) => propSatisfies_Record_100<V>;
    <X extends "011", K extends "Record">(): <K extends string, U extends Record<K, V>>(_pred: PH, name: K, obj: U) => propSatisfies_Record_011<K, U>;
    <X extends "01", K extends "Record">(): <K extends string>(_pred: PH, name: K) => propSatisfies_Record_010<K>;
    <X extends "111", K extends "keyof__info_too_late_on_currying">(): <T, U>(pred: Pred<T>, name: Pred, obj: U) => propSatisfies_keyof__info_too_late_on_currying_111<T, U>;
    <X extends "11", K extends "keyof__info_too_late_on_currying">(): <T>(pred: Pred<T>, name: Pred) => propSatisfies_keyof__info_too_late_on_currying_110<T>;
    <X extends "101", K extends "keyof__info_too_late_on_currying">(): <T, U>(pred: Pred<T>, _name: PH, obj: U) => propSatisfies_keyof__info_too_late_on_currying_101<T, U>;
    <X extends "1", K extends "keyof__info_too_late_on_currying">(): <T>(pred: Pred<T>) => propSatisfies_keyof__info_too_late_on_currying_100<T>;
    <X extends "011", K extends "keyof__info_too_late_on_currying">(): <U>(_pred: PH, name: Pred, obj: U) => propSatisfies_keyof__info_too_late_on_currying_011<U>;
    <X extends "01", K extends "keyof__info_too_late_on_currying">(): (_pred: PH, name: Pred) => propSatisfies_keyof__info_too_late_on_currying_010;
    <X extends "001">(): <U>(_pred: PH, _name: PH, obj: U) => propSatisfies_001<U>;
...
export type propSatisfies_001<U extends Record<K, V>> = {
    ...
    <X extends "11", K extends "Record">(): <V, K extends string>(pred: Pred<V>, name: K) => propSatisfies_Record_111<V, K, U>;
    <X extends "1", K extends "Record">(): <V>(pred: Pred<V>) => propSatisfies_Record_101<V, U>;
    <X extends "01", K extends "Record">(): <K extends string>(_pred: PH, name: K) => propSatisfies_Record_011<K, U>;
    <X extends "11", K extends "keyof__info_too_late_on_currying">(): <T>(pred: Pred<T>, name: Pred) => propSatisfies_keyof__info_too_late_on_currying_111<T, U>;
    <X extends "1", K extends "keyof__info_too_late_on_currying">(): <T>(pred: Pred<T>) => propSatisfies_keyof__info_too_late_on_currying_101<T, U>;
    <X extends "01", K extends "keyof__info_too_late_on_currying">(): (_pred: PH, name: Pred) => propSatisfies_keyof__info_too_late_on_currying_011<U>;
...
export type propSatisfies_Record_100<V> = {
    ...
    <X extends "11">(): <K extends string, U extends Record<K, V>>(name: K, obj: U) => propSatisfies_Record_111<V, K, U>;
    <X extends "1">(): <K extends string>(name: K) => propSatisfies_Record_110<V, K>;
    <X extends "01">(): <U extends Record<K, V>>(_name: PH, obj: U) => propSatisfies_Record_101<V, U>;
...
export type propSatisfies_keyof__info_too_late_on_currying_100<T> = {
    ...
    <X extends "11">(): <U>(name: Pred, obj: U) => propSatisfies_keyof__info_too_late_on_currying_111<T, U>;
    <X extends "1">(): (name: Pred) => propSatisfies_keyof__info_too_late_on_currying_110<T>;
    <X extends "01">(): <U>(_name: PH, obj: U) => propSatisfies_keyof__info_too_late_on_currying_101<T, U>;
...
export type propSatisfies_Record_010<K extends string> = {
    ...
    <X extends "11">(): <V, U extends Record<K, V>>(pred: Pred<V>, obj: U) => propSatisfies_Record_111<V, K, U>;
    <X extends "1">(): <V>(pred: Pred<V>) => propSatisfies_Record_110<V, K>;
    <X extends "01">(): <U extends Record<K, V>>(_pred: PH, obj: U) => propSatisfies_Record_011<K, U>;
...
export type propSatisfies_keyof__info_too_late_on_currying_010 = {
    ...
    <X extends "11">(): <T, U>(pred: Pred<T>, obj: U) => propSatisfies_keyof__info_too_late_on_currying_111<T, U>;
    <X extends "1">(): <T>(pred: Pred<T>) => propSatisfies_keyof__info_too_late_on_currying_110<T>;
    <X extends "01">(): <U>(_pred: PH, obj: U) => propSatisfies_keyof__info_too_late_on_currying_011<U>;
...
export type propStatisfies_000 = {
    ...
    <X extends "111", K extends "Record__curry_friendly_">(): <V, K extends string, U extends Record<K, V>>(pred: Pred<V>, name: K, obj: U) => propStatisfies_Record__curry_friendly__111<V, K, U>;
    <X extends "11", K extends "Record__curry_friendly_">(): <V, K extends string>(pred: Pred<V>, name: K) => propStatisfies_Record__curry_friendly__110<V, K>;
    <X extends "101", K extends "Record__curry_friendly_">(): <V, U extends Record<K, V>>(pred: Pred<V>, _name: PH, obj: U) => propStatisfies_Record__curry_friendly__101<V, U>;
    <X extends "1", K extends "Record__curry_friendly_">(): <V>(pred: Pred<V>) => propStatisfies_Record__curry_friendly__100<V>;
    <X extends "011", K extends "Record__curry_friendly_">(): <K extends string, U extends Record<K, V>>(_pred: PH, name: K, obj: U) => propStatisfies_Record__curry_friendly__011<K, U>;
    <X extends "01", K extends "Record__curry_friendly_">(): <K extends string>(_pred: PH, name: K) => propStatisfies_Record__curry_friendly__010<K>;
    <X extends "111", K extends "keyof__info_too_late_on_currying">(): <T, U>(pred: Pred<T>, name: Prop, obj: U) => propStatisfies_keyof__info_too_late_on_currying_111<T, U>;
    <X extends "11", K extends "keyof__info_too_late_on_currying">(): <T>(pred: Pred<T>, name: Prop) => propStatisfies_keyof__info_too_late_on_currying_110<T>;
    <X extends "101", K extends "keyof__info_too_late_on_currying">(): <T, U>(pred: Pred<T>, _name: PH, obj: U) => propStatisfies_keyof__info_too_late_on_currying_101<T, U>;
    <X extends "1", K extends "keyof__info_too_late_on_currying">(): <T>(pred: Pred<T>) => propStatisfies_keyof__info_too_late_on_currying_100<T>;
    <X extends "011", K extends "keyof__info_too_late_on_currying">(): <U>(_pred: PH, name: Prop, obj: U) => propStatisfies_keyof__info_too_late_on_currying_011<U>;
    <X extends "01", K extends "keyof__info_too_late_on_currying">(): (_pred: PH, name: Prop) => propStatisfies_keyof__info_too_late_on_currying_010;
    <X extends "001">(): <U>(_pred: PH, _name: PH, obj: U) => propStatisfies_001<U>;
...
export type propStatisfies_001<U extends Record<K, V>> = {
    ...
    <X extends "11", K extends "Record__curry_friendly_">(): <V, K extends string>(pred: Pred<V>, name: K) => propStatisfies_Record__curry_friendly__111<V, K, U>;
    <X extends "1", K extends "Record__curry_friendly_">(): <V>(pred: Pred<V>) => propStatisfies_Record__curry_friendly__101<V, U>;
    <X extends "01", K extends "Record__curry_friendly_">(): <K extends string>(_pred: PH, name: K) => propStatisfies_Record__curry_friendly__011<K, U>;
    <X extends "11", K extends "keyof__info_too_late_on_currying">(): <T>(pred: Pred<T>, name: Prop) => propStatisfies_keyof__info_too_late_on_currying_111<T, U>;
    <X extends "1", K extends "keyof__info_too_late_on_currying">(): <T>(pred: Pred<T>) => propStatisfies_keyof__info_too_late_on_currying_101<T, U>;
    <X extends "01", K extends "keyof__info_too_late_on_currying">(): (_pred: PH, name: Prop) => propStatisfies_keyof__info_too_late_on_currying_011<U>;
...
export type propStatisfies_Record__curry_friendly__100<V> = {
    ...
    <X extends "11">(): <K extends string, U extends Record<K, V>>(name: K, obj: U) => propStatisfies_Record__curry_friendly__111<V, K, U>;
    <X extends "1">(): <K extends string>(name: K) => propStatisfies_Record__curry_friendly__110<V, K>;
    <X extends "01">(): <U extends Record<K, V>>(_name: PH, obj: U) => propStatisfies_Record__curry_friendly__101<V, U>;
...
export type propStatisfies_keyof__info_too_late_on_currying_100<T> = {
    ...
    <X extends "11">(): <U>(name: Prop, obj: U) => propStatisfies_keyof__info_too_late_on_currying_111<T, U>;
    <X extends "1">(): (name: Prop) => propStatisfies_keyof__info_too_late_on_currying_110<T>;
    <X extends "01">(): <U>(_name: PH, obj: U) => propStatisfies_keyof__info_too_late_on_currying_101<T, U>;
...
export type propStatisfies_Record__curry_friendly__010<K extends string> = {
    ...
    <X extends "11">(): <V, U extends Record<K, V>>(pred: Pred<V>, obj: U) => propStatisfies_Record__curry_friendly__111<V, K, U>;
    <X extends "1">(): <V>(pred: Pred<V>) => propStatisfies_Record__curry_friendly__110<V, K>;
    <X extends "01">(): <U extends Record<K, V>>(_pred: PH, obj: U) => propStatisfies_Record__curry_friendly__011<K, U>;
...
export type propStatisfies_keyof__info_too_late_on_currying_010 = {
    ...
    <X extends "11">(): <T, U>(pred: Pred<T>, obj: U) => propStatisfies_keyof__info_too_late_on_currying_111<T, U>;
    <X extends "1">(): <T>(pred: Pred<T>) => propStatisfies_keyof__info_too_late_on_currying_110<T>;
    <X extends "01">(): <U>(_pred: PH, obj: U) => propStatisfies_keyof__info_too_late_on_currying_011<U>;
...
export type range_00 = {
    ...
    <X extends "11">(): (from: number, to: number) => range_11;
    <X extends "1">(): (from: number) => range_10;
    <X extends "01">(): (_from: PH, to: number) => range_01;
...
export type reduce_000 = {
    ...
    <X extends "111">(): <T, TResult, R extends List<T>>(fn: (acc: TResult, elem: T, idx: number, list: R) => TResult | Reduced, acc: TResult, list: R) => reduce_111<T, TResult, R>;
    <X extends "11">(): <T, TResult, R extends List<T>>(fn: (acc: TResult, elem: T, idx: number, list: R) => TResult | Reduced, acc: TResult) => reduce_110<T, TResult, R>;
    <X extends "101">(): <T, TResult, R extends List<T>>(fn: (acc: TResult, elem: T, idx: number, list: R) => TResult | Reduced, _acc: PH, list: R) => reduce_101<T, TResult, R>;
    <X extends "1">(): <T, TResult, R extends List<T>>(fn: (acc: TResult, elem: T, idx: number, list: R) => TResult | Reduced) => reduce_100<T, TResult, R>;
    <X extends "011">(): <TResult, R extends List<T>>(_fn: PH, acc: TResult, list: R) => reduce_011<TResult, R>;
    <X extends "01">(): <TResult>(_fn: PH, acc: TResult) => reduce_010<TResult>;
    <X extends "001">(): <R extends List<T>>(_fn: PH, _acc: PH, list: R) => reduce_001<R>;
...
export type reduce_100<T, TResult, R extends List<T>> = {
    ...
    <X extends "11">(): (acc: TResult, list: R) => reduce_111<T, TResult, R>;
    <X extends "1">(): (acc: TResult) => reduce_110<T, TResult, R>;
    <X extends "01">(): (_acc: PH, list: R) => reduce_101<T, TResult, R>;
...
export type reduce_010<TResult> = {
    ...
    <X extends "11">(): <T, R extends List<T>>(fn: (acc: TResult, elem: T, idx: number, list: R) => TResult | Reduced, list: R) => reduce_111<T, TResult, R>;
    <X extends "1">(): <T, R extends List<T>>(fn: (acc: TResult, elem: T, idx: number, list: R) => TResult | Reduced) => reduce_110<T, TResult, R>;
    <X extends "01">(): <R extends List<T>>(_fn: PH, list: R) => reduce_011<TResult, R>;
...
export type reduce_001<R extends List<T>> = {
    ...
    <X extends "11">(): <T, TResult>(fn: (acc: TResult, elem: T, idx: number, list: R) => TResult | Reduced, acc: TResult) => reduce_111<T, TResult, R>;
    <X extends "1">(): <T, TResult>(fn: (acc: TResult, elem: T, idx: number, list: R) => TResult | Reduced) => reduce_101<T, TResult, R>;
    <X extends "01">(): <TResult>(_fn: PH, acc: TResult) => reduce_011<TResult, R>;
...
export type reduceBy_0000 = {
    ...
    <X extends "1111">(): <T, TResult, R extends List<T>>(valueFn: (acc: TResult, elem: T, idx: number, list: R) => TResult, acc: TResult | any, keyFn: (elem: T) => string, list: R) => reduceBy_1111<T, TResult, R>;
    <X extends "111">(): <T, TResult, R extends List<T>>(valueFn: (acc: TResult, elem: T, idx: number, list: R) => TResult, acc: TResult | any, keyFn: (elem: T) => string) => reduceBy_1110<T, TResult, R>;
    <X extends "1101">(): <T, TResult, R extends List<T>>(valueFn: (acc: TResult, elem: T, idx: number, list: R) => TResult, acc: TResult | any, _keyFn: PH, list: R) => reduceBy_1101<T, TResult, R>;
    <X extends "11">(): <T, TResult, R extends List<T>>(valueFn: (acc: TResult, elem: T, idx: number, list: R) => TResult, acc: TResult | any) => reduceBy_1100<T, TResult, R>;
    <X extends "1011">(): <T, TResult, R extends List<T>>(valueFn: (acc: TResult, elem: T, idx: number, list: R) => TResult, _acc: PH, keyFn: (elem: T) => string, list: R) => reduceBy_1011<T, TResult, R>;
    <X extends "101">(): <T, TResult, R extends List<T>>(valueFn: (acc: TResult, elem: T, idx: number, list: R) => TResult, _acc: PH, keyFn: (elem: T) => string) => reduceBy_1010<T, TResult, R>;
    <X extends "1001">(): <T, TResult, R extends List<T>>(valueFn: (acc: TResult, elem: T, idx: number, list: R) => TResult, _acc: PH, _keyFn: PH, list: R) => reduceBy_1001<T, TResult, R>;
    <X extends "1">(): <T, TResult, R extends List<T>>(valueFn: (acc: TResult, elem: T, idx: number, list: R) => TResult) => reduceBy_1000<T, TResult, R>;
    <X extends "0111">(): <T, TResult, R extends List<T>>(_valueFn: PH, acc: TResult | any, keyFn: (elem: T) => string, list: R) => reduceBy_0111<T, TResult, R>;
    <X extends "011">(): <T, TResult>(_valueFn: PH, acc: TResult | any, keyFn: (elem: T) => string) => reduceBy_0110<T, TResult>;
    <X extends "0101">(): <TResult, R extends List<T>>(_valueFn: PH, acc: TResult | any, _keyFn: PH, list: R) => reduceBy_0101<TResult, R>;
    <X extends "01">(): <TResult>(_valueFn: PH, acc: TResult | any) => reduceBy_0100<TResult>;
    <X extends "0011">(): <T, R extends List<T>>(_valueFn: PH, _acc: PH, keyFn: (elem: T) => string, list: R) => reduceBy_0011<T, R>;
    <X extends "001">(): <T>(_valueFn: PH, _acc: PH, keyFn: (elem: T) => string) => reduceBy_0010<T>;
    <X extends "0001">(): <R extends List<T>>(_valueFn: PH, _acc: PH, _keyFn: PH, list: R) => reduceBy_0001<R>;
...
export type reduceBy_1000<T, TResult, R extends List<T>> = {
    ...
    <X extends "111">(): (acc: TResult | any, keyFn: (elem: T) => string, list: R) => reduceBy_1111<T, TResult, R>;
    <X extends "11">(): (acc: TResult | any, keyFn: (elem: T) => string) => reduceBy_1110<T, TResult, R>;
    <X extends "101">(): (acc: TResult | any, _keyFn: PH, list: R) => reduceBy_1101<T, TResult, R>;
    <X extends "1">(): (acc: TResult | any) => reduceBy_1100<T, TResult, R>;
    <X extends "011">(): (_acc: PH, keyFn: (elem: T) => string, list: R) => reduceBy_1011<T, TResult, R>;
    <X extends "01">(): (_acc: PH, keyFn: (elem: T) => string) => reduceBy_1010<T, TResult, R>;
    <X extends "001">(): (_acc: PH, _keyFn: PH, list: R) => reduceBy_1001<T, TResult, R>;
...
export type reduceBy_0100<TResult> = {
    ...
    <X extends "111">(): <T, R extends List<T>>(valueFn: (acc: TResult, elem: T, idx: number, list: R) => TResult, keyFn: (elem: T) => string, list: R) => reduceBy_1111<T, TResult, R>;
    <X extends "11">(): <T, R extends List<T>>(valueFn: (acc: TResult, elem: T, idx: number, list: R) => TResult, keyFn: (elem: T) => string) => reduceBy_1110<T, TResult, R>;
    <X extends "101">(): <T, R extends List<T>>(valueFn: (acc: TResult, elem: T, idx: number, list: R) => TResult, _keyFn: PH, list: R) => reduceBy_1101<T, TResult, R>;
    <X extends "1">(): <T, R extends List<T>>(valueFn: (acc: TResult, elem: T, idx: number, list: R) => TResult) => reduceBy_1100<T, TResult, R>;
    <X extends "011">(): <T, R extends List<T>>(_valueFn: PH, keyFn: (elem: T) => string, list: R) => reduceBy_0111<T, TResult, R>;
    <X extends "01">(): <T>(_valueFn: PH, keyFn: (elem: T) => string) => reduceBy_0110<T, TResult>;
    <X extends "001">(): <R extends List<T>>(_valueFn: PH, _keyFn: PH, list: R) => reduceBy_0101<TResult, R>;
...
export type reduceBy_1100<T, TResult, R extends List<T>> = {
    ...
    <X extends "11">(): (keyFn: (elem: T) => string, list: R) => reduceBy_1111<T, TResult, R>;
    <X extends "1">(): (keyFn: (elem: T) => string) => reduceBy_1110<T, TResult, R>;
    <X extends "01">(): (_keyFn: PH, list: R) => reduceBy_1101<T, TResult, R>;
...
export type reduceBy_0010<T> = {
    ...
    <X extends "111">(): <TResult, R extends List<T>>(valueFn: (acc: TResult, elem: T, idx: number, list: R) => TResult, acc: TResult | any, list: R) => reduceBy_1111<T, TResult, R>;
    <X extends "11">(): <TResult, R extends List<T>>(valueFn: (acc: TResult, elem: T, idx: number, list: R) => TResult, acc: TResult | any) => reduceBy_1110<T, TResult, R>;
    <X extends "101">(): <TResult, R extends List<T>>(valueFn: (acc: TResult, elem: T, idx: number, list: R) => TResult, _acc: PH, list: R) => reduceBy_1011<T, TResult, R>;
    <X extends "1">(): <TResult, R extends List<T>>(valueFn: (acc: TResult, elem: T, idx: number, list: R) => TResult) => reduceBy_1010<T, TResult, R>;
    <X extends "011">(): <TResult, R extends List<T>>(_valueFn: PH, acc: TResult | any, list: R) => reduceBy_0111<T, TResult, R>;
    <X extends "01">(): <TResult>(_valueFn: PH, acc: TResult | any) => reduceBy_0110<T, TResult>;
    <X extends "001">(): <R extends List<T>>(_valueFn: PH, _acc: PH, list: R) => reduceBy_0011<T, R>;
...
export type reduceBy_1010<T, TResult, R extends List<T>> = {
    ...
    <X extends "11">(): (acc: TResult | any, list: R) => reduceBy_1111<T, TResult, R>;
    <X extends "1">(): (acc: TResult | any) => reduceBy_1110<T, TResult, R>;
    <X extends "01">(): (_acc: PH, list: R) => reduceBy_1011<T, TResult, R>;
...
export type reduceBy_0110<T, TResult> = {
    ...
    <X extends "11">(): <R extends List<T>>(valueFn: (acc: TResult, elem: T, idx: number, list: R) => TResult, list: R) => reduceBy_1111<T, TResult, R>;
    <X extends "1">(): <R extends List<T>>(valueFn: (acc: TResult, elem: T, idx: number, list: R) => TResult) => reduceBy_1110<T, TResult, R>;
    <X extends "01">(): <R extends List<T>>(_valueFn: PH, list: R) => reduceBy_0111<T, TResult, R>;
...
export type reduceBy_0001<R extends List<T>> = {
    ...
    <X extends "111">(): <T, TResult>(valueFn: (acc: TResult, elem: T, idx: number, list: R) => TResult, acc: TResult | any, keyFn: (elem: T) => string) => reduceBy_1111<T, TResult, R>;
    <X extends "11">(): <T, TResult>(valueFn: (acc: TResult, elem: T, idx: number, list: R) => TResult, acc: TResult | any) => reduceBy_1101<T, TResult, R>;
    <X extends "101">(): <T, TResult>(valueFn: (acc: TResult, elem: T, idx: number, list: R) => TResult, _acc: PH, keyFn: (elem: T) => string) => reduceBy_1011<T, TResult, R>;
    <X extends "1">(): <T, TResult>(valueFn: (acc: TResult, elem: T, idx: number, list: R) => TResult) => reduceBy_1001<T, TResult, R>;
    <X extends "011">(): <T, TResult>(_valueFn: PH, acc: TResult | any, keyFn: (elem: T) => string) => reduceBy_0111<T, TResult, R>;
    <X extends "01">(): <TResult>(_valueFn: PH, acc: TResult | any) => reduceBy_0101<TResult, R>;
    <X extends "001">(): <T>(_valueFn: PH, _acc: PH, keyFn: (elem: T) => string) => reduceBy_0011<T, R>;
...
export type reduceBy_1001<T, TResult, R extends List<T>> = {
    ...
    <X extends "11">(): (acc: TResult | any, keyFn: (elem: T) => string) => reduceBy_1111<T, TResult, R>;
    <X extends "1">(): (acc: TResult | any) => reduceBy_1101<T, TResult, R>;
    <X extends "01">(): (_acc: PH, keyFn: (elem: T) => string) => reduceBy_1011<T, TResult, R>;
...
export type reduceBy_0101<TResult, R extends List<T>> = {
    ...
    <X extends "11">(): <T>(valueFn: (acc: TResult, elem: T, idx: number, list: R) => TResult, keyFn: (elem: T) => string) => reduceBy_1111<T, TResult, R>;
    <X extends "1">(): <T>(valueFn: (acc: TResult, elem: T, idx: number, list: R) => TResult) => reduceBy_1101<T, TResult, R>;
    <X extends "01">(): <T>(_valueFn: PH, keyFn: (elem: T) => string) => reduceBy_0111<T, TResult, R>;
...
export type reduceBy_0011<T, R extends List<T>> = {
    ...
    <X extends "11">(): <TResult>(valueFn: (acc: TResult, elem: T, idx: number, list: R) => TResult, acc: TResult | any) => reduceBy_1111<T, TResult, R>;
    <X extends "1">(): <TResult>(valueFn: (acc: TResult, elem: T, idx: number, list: R) => TResult) => reduceBy_1011<T, TResult, R>;
    <X extends "01">(): <TResult>(_valueFn: PH, acc: TResult | any) => reduceBy_0111<T, TResult, R>;
...
export type reduceRight_000 = {
    ...
    <X extends "111">(): <T, TResult>(fn: (elem: T, acc: TResult) => TResult | Reduced, acc: TResult | any, list: List<T>) => reduceRight_111<T, TResult>;
    <X extends "11">(): <T, TResult>(fn: (elem: T, acc: TResult) => TResult | Reduced, acc: TResult | any) => reduceRight_110<T, TResult>;
    <X extends "101">(): <T, TResult>(fn: (elem: T, acc: TResult) => TResult | Reduced, _acc: PH, list: List<T>) => reduceRight_101<T, TResult>;
    <X extends "1">(): <T, TResult>(fn: (elem: T, acc: TResult) => TResult | Reduced) => reduceRight_100<T, TResult>;
    <X extends "011">(): <T, TResult>(_fn: PH, acc: TResult | any, list: List<T>) => reduceRight_011<T, TResult>;
    <X extends "01">(): <TResult>(_fn: PH, acc: TResult | any) => reduceRight_010<TResult>;
    <X extends "001">(): <T>(_fn: PH, _acc: PH, list: List<T>) => reduceRight_001<T>;
...
export type reduceRight_100<T, TResult> = {
    ...
    <X extends "11">(): (acc: TResult | any, list: List<T>) => reduceRight_111<T, TResult>;
    <X extends "1">(): (acc: TResult | any) => reduceRight_110<T, TResult>;
    <X extends "01">(): (_acc: PH, list: List<T>) => reduceRight_101<T, TResult>;
...
export type reduceRight_010<TResult> = {
    ...
    <X extends "11">(): <T>(fn: (elem: T, acc: TResult) => TResult | Reduced, list: List<T>) => reduceRight_111<T, TResult>;
    <X extends "1">(): <T>(fn: (elem: T, acc: TResult) => TResult | Reduced) => reduceRight_110<T, TResult>;
    <X extends "01">(): <T>(_fn: PH, list: List<T>) => reduceRight_011<T, TResult>;
...
export type reduceRight_001<T> = {
    ...
    <X extends "11">(): <TResult>(fn: (elem: T, acc: TResult) => TResult | Reduced, acc: TResult | any) => reduceRight_111<T, TResult>;
    <X extends "1">(): <TResult>(fn: (elem: T, acc: TResult) => TResult | Reduced) => reduceRight_101<T, TResult>;
    <X extends "01">(): <TResult>(_fn: PH, acc: TResult | any) => reduceRight_011<T, TResult>;
...
export type reduceWhile_0000 = {
    ...
    <X extends "1111">(): <T, TResult>(pred: (acc: TResult, elem: T) => boolean, fn: (acc: TResult, elem: T) => TResult | Reduced, acc: TResult, list: List<T>) => reduceWhile_1111<T, TResult>;
    <X extends "111">(): <T, TResult>(pred: (acc: TResult, elem: T) => boolean, fn: (acc: TResult, elem: T) => TResult | Reduced, acc: TResult) => reduceWhile_1110<T, TResult>;
    <X extends "1101">(): <T, TResult>(pred: (acc: TResult, elem: T) => boolean, fn: (acc: TResult, elem: T) => TResult | Reduced, _acc: PH, list: List<T>) => reduceWhile_1101<T, TResult>;
    <X extends "11">(): <T, TResult>(pred: (acc: TResult, elem: T) => boolean, fn: (acc: TResult, elem: T) => TResult | Reduced) => reduceWhile_1100<T, TResult>;
    <X extends "1011">(): <T, TResult>(pred: (acc: TResult, elem: T) => boolean, _fn: PH, acc: TResult, list: List<T>) => reduceWhile_1011<T, TResult>;
    <X extends "101">(): <T, TResult>(pred: (acc: TResult, elem: T) => boolean, _fn: PH, acc: TResult) => reduceWhile_1010<T, TResult>;
    <X extends "1001">(): <T, TResult>(pred: (acc: TResult, elem: T) => boolean, _fn: PH, _acc: PH, list: List<T>) => reduceWhile_1001<T, TResult>;
    <X extends "1">(): <T, TResult>(pred: (acc: TResult, elem: T) => boolean) => reduceWhile_1000<T, TResult>;
    <X extends "0111">(): <T, TResult>(_pred: PH, fn: (acc: TResult, elem: T) => TResult | Reduced, acc: TResult, list: List<T>) => reduceWhile_0111<T, TResult>;
    <X extends "011">(): <T, TResult>(_pred: PH, fn: (acc: TResult, elem: T) => TResult | Reduced, acc: TResult) => reduceWhile_0110<T, TResult>;
    <X extends "0101">(): <T, TResult>(_pred: PH, fn: (acc: TResult, elem: T) => TResult | Reduced, _acc: PH, list: List<T>) => reduceWhile_0101<T, TResult>;
    <X extends "01">(): <T, TResult>(_pred: PH, fn: (acc: TResult, elem: T) => TResult | Reduced) => reduceWhile_0100<T, TResult>;
    <X extends "0011">(): <T, TResult>(_pred: PH, _fn: PH, acc: TResult, list: List<T>) => reduceWhile_0011<T, TResult>;
    <X extends "001">(): <TResult>(_pred: PH, _fn: PH, acc: TResult) => reduceWhile_0010<TResult>;
    <X extends "0001">(): <T>(_pred: PH, _fn: PH, _acc: PH, list: List<T>) => reduceWhile_0001<T>;
...
export type reduceWhile_1000<T, TResult> = {
    ...
    <X extends "111">(): (fn: (acc: TResult, elem: T) => TResult | Reduced, acc: TResult, list: List<T>) => reduceWhile_1111<T, TResult>;
    <X extends "11">(): (fn: (acc: TResult, elem: T) => TResult | Reduced, acc: TResult) => reduceWhile_1110<T, TResult>;
    <X extends "101">(): (fn: (acc: TResult, elem: T) => TResult | Reduced, _acc: PH, list: List<T>) => reduceWhile_1101<T, TResult>;
    <X extends "1">(): (fn: (acc: TResult, elem: T) => TResult | Reduced) => reduceWhile_1100<T, TResult>;
    <X extends "011">(): (_fn: PH, acc: TResult, list: List<T>) => reduceWhile_1011<T, TResult>;
    <X extends "01">(): (_fn: PH, acc: TResult) => reduceWhile_1010<T, TResult>;
    <X extends "001">(): (_fn: PH, _acc: PH, list: List<T>) => reduceWhile_1001<T, TResult>;
...
export type reduceWhile_0100<T, TResult> = {
    ...
    <X extends "111">(): (pred: (acc: TResult, elem: T) => boolean, acc: TResult, list: List<T>) => reduceWhile_1111<T, TResult>;
    <X extends "11">(): (pred: (acc: TResult, elem: T) => boolean, acc: TResult) => reduceWhile_1110<T, TResult>;
    <X extends "101">(): (pred: (acc: TResult, elem: T) => boolean, _acc: PH, list: List<T>) => reduceWhile_1101<T, TResult>;
    <X extends "1">(): (pred: (acc: TResult, elem: T) => boolean) => reduceWhile_1100<T, TResult>;
    <X extends "011">(): (_pred: PH, acc: TResult, list: List<T>) => reduceWhile_0111<T, TResult>;
    <X extends "01">(): (_pred: PH, acc: TResult) => reduceWhile_0110<T, TResult>;
    <X extends "001">(): (_pred: PH, _acc: PH, list: List<T>) => reduceWhile_0101<T, TResult>;
...
export type reduceWhile_1100<T, TResult> = {
    ...
    <X extends "11">(): (acc: TResult, list: List<T>) => reduceWhile_1111<T, TResult>;
    <X extends "1">(): (acc: TResult) => reduceWhile_1110<T, TResult>;
    <X extends "01">(): (_acc: PH, list: List<T>) => reduceWhile_1101<T, TResult>;
...
export type reduceWhile_0010<TResult> = {
    ...
    <X extends "111">(): <T>(pred: (acc: TResult, elem: T) => boolean, fn: (acc: TResult, elem: T) => TResult | Reduced, list: List<T>) => reduceWhile_1111<T, TResult>;
    <X extends "11">(): <T>(pred: (acc: TResult, elem: T) => boolean, fn: (acc: TResult, elem: T) => TResult | Reduced) => reduceWhile_1110<T, TResult>;
    <X extends "101">(): <T>(pred: (acc: TResult, elem: T) => boolean, _fn: PH, list: List<T>) => reduceWhile_1011<T, TResult>;
    <X extends "1">(): <T>(pred: (acc: TResult, elem: T) => boolean) => reduceWhile_1010<T, TResult>;
    <X extends "011">(): <T>(_pred: PH, fn: (acc: TResult, elem: T) => TResult | Reduced, list: List<T>) => reduceWhile_0111<T, TResult>;
    <X extends "01">(): <T>(_pred: PH, fn: (acc: TResult, elem: T) => TResult | Reduced) => reduceWhile_0110<T, TResult>;
    <X extends "001">(): <T>(_pred: PH, _fn: PH, list: List<T>) => reduceWhile_0011<T, TResult>;
...
export type reduceWhile_1010<T, TResult> = {
    ...
    <X extends "11">(): (fn: (acc: TResult, elem: T) => TResult | Reduced, list: List<T>) => reduceWhile_1111<T, TResult>;
    <X extends "1">(): (fn: (acc: TResult, elem: T) => TResult | Reduced) => reduceWhile_1110<T, TResult>;
    <X extends "01">(): (_fn: PH, list: List<T>) => reduceWhile_1011<T, TResult>;
...
export type reduceWhile_0110<T, TResult> = {
    ...
    <X extends "11">(): (pred: (acc: TResult, elem: T) => boolean, list: List<T>) => reduceWhile_1111<T, TResult>;
    <X extends "1">(): (pred: (acc: TResult, elem: T) => boolean) => reduceWhile_1110<T, TResult>;
    <X extends "01">(): (_pred: PH, list: List<T>) => reduceWhile_0111<T, TResult>;
...
export type reduceWhile_0001<T> = {
    ...
    <X extends "111">(): <TResult>(pred: (acc: TResult, elem: T) => boolean, fn: (acc: TResult, elem: T) => TResult | Reduced, acc: TResult) => reduceWhile_1111<T, TResult>;
    <X extends "11">(): <TResult>(pred: (acc: TResult, elem: T) => boolean, fn: (acc: TResult, elem: T) => TResult | Reduced) => reduceWhile_1101<T, TResult>;
    <X extends "101">(): <TResult>(pred: (acc: TResult, elem: T) => boolean, _fn: PH, acc: TResult) => reduceWhile_1011<T, TResult>;
    <X extends "1">(): <TResult>(pred: (acc: TResult, elem: T) => boolean) => reduceWhile_1001<T, TResult>;
    <X extends "011">(): <TResult>(_pred: PH, fn: (acc: TResult, elem: T) => TResult | Reduced, acc: TResult) => reduceWhile_0111<T, TResult>;
    <X extends "01">(): <TResult>(_pred: PH, fn: (acc: TResult, elem: T) => TResult | Reduced) => reduceWhile_0101<T, TResult>;
    <X extends "001">(): <TResult>(_pred: PH, _fn: PH, acc: TResult) => reduceWhile_0011<T, TResult>;
...
export type reduceWhile_1001<T, TResult> = {
    ...
    <X extends "11">(): (fn: (acc: TResult, elem: T) => TResult | Reduced, acc: TResult) => reduceWhile_1111<T, TResult>;
    <X extends "1">(): (fn: (acc: TResult, elem: T) => TResult | Reduced) => reduceWhile_1101<T, TResult>;
    <X extends "01">(): (_fn: PH, acc: TResult) => reduceWhile_1011<T, TResult>;
...
export type reduceWhile_0101<T, TResult> = {
    ...
    <X extends "11">(): (pred: (acc: TResult, elem: T) => boolean, acc: TResult) => reduceWhile_1111<T, TResult>;
    <X extends "1">(): (pred: (acc: TResult, elem: T) => boolean) => reduceWhile_1101<T, TResult>;
    <X extends "01">(): (_pred: PH, acc: TResult) => reduceWhile_0111<T, TResult>;
...
export type reduceWhile_0011<T, TResult> = {
    ...
    <X extends "11">(): (pred: (acc: TResult, elem: T) => boolean, fn: (acc: TResult, elem: T) => TResult | Reduced) => reduceWhile_1111<T, TResult>;
    <X extends "1">(): (pred: (acc: TResult, elem: T) => boolean) => reduceWhile_1011<T, TResult>;
    <X extends "01">(): (_pred: PH, fn: (acc: TResult, elem: T) => TResult | Reduced) => reduceWhile_0111<T, TResult>;
...
export type reject_00 = {
    ...
    <X extends "11", K extends "array">(): <T>(pred: Pred<T>, list: List<T>) => reject_array_11<T>;
    <X extends "01", K extends "array">(): <T>(_pred: PH, list: List<T>) => reject_array_01<T>;
    <X extends "11", K extends "functor_to_functor">(): <T>(pred: Pred<T>, list: Functor<T>) => reject_functor_to_functor_11<T>;
    <X extends "01", K extends "functor_to_functor">(): <T>(_pred: PH, list: Functor<T>) => reject_functor_to_functor_01<T>;
    <X extends "11", K extends "functor_to_array">(): <T>(pred: Pred<T>, list: Functor<T>) => reject_functor_to_array_11<T>;
    <X extends "01", K extends "functor_to_array">(): <T>(_pred: PH, list: Functor<T>) => reject_functor_to_array_01<T>;
    <X extends "11", K extends "object">(): <T, U extends Obj<T>>(pred: Pred<T>, obj: U) => reject_object_11<T, U>;
    <X extends "01", K extends "object">(): <U extends Obj<T>>(_pred: PH, obj: U) => reject_object_01<U>;
    <X extends "1">(): <T>(pred: Pred<T>) => reject_10<T>;
...
export type reject_10<T> = {
    ...
    <X extends "1", K extends "array">(): (list: List<T>) => reject_array_11<T>;
    <X extends "1", K extends "functor_to_functor">(): (list: Functor<T>) => reject_functor_to_functor_11<T>;
    <X extends "1", K extends "functor_to_array">(): (list: Functor<T>) => reject_functor_to_array_11<T>;
    <X extends "1", K extends "object">(): <U extends Obj<T>>(obj: U) => reject_object_11<T, U>;
...
export type remove_000 = {
    ...
    <X extends "111">(): <T>(start: number, count: number, list: List<T>) => remove_111<T>;
    <X extends "11">(): (start: number, count: number) => remove_110;
    <X extends "101">(): <T>(start: number, _count: PH, list: List<T>) => remove_101<T>;
    <X extends "1">(): (start: number) => remove_100;
    <X extends "011">(): <T>(_start: PH, count: number, list: List<T>) => remove_011<T>;
    <X extends "01">(): (_start: PH, count: number) => remove_010;
    <X extends "001">(): <T>(_start: PH, _count: PH, list: List<T>) => remove_001<T>;
    (start: number): remove_100;
};
export type remove_100 = {
    <T>(_count: PH, list: List<T>): remove_101<T>;
    <T>(count: number, list: List<T>): remove_111<T>;
    <X extends "11">(): <T>(count: number, list: List<T>) => remove_111<T>;
    <X extends "1">(): (count: number) => remove_110;
    <X extends "01">(): <T>(_count: PH, list: List<T>) => remove_101<T>;
    (count: number): remove_110;
};
export type remove_010 = {
    <T>(_start: PH, list: List<T>): remove_011<T>;
    <T>(start: number, list: List<T>): remove_111<T>;
    <X extends "11">(): <T>(start: number, list: List<T>) => remove_111<T>;
    <X extends "1">(): (start: number) => remove_110;
    <X extends "01">(): <T>(_start: PH, list: List<T>) => remove_011<T>;
...
export type remove_001<T> = {
    ...
    <X extends "11">(): (start: number, count: number) => remove_111<T>;
    <X extends "1">(): (start: number) => remove_101<T>;
    <X extends "01">(): (_start: PH, count: number) => remove_011<T>;
...
export type repeat_00 = {
    ...
    <X extends "11">(): <T>(a: T, n: number) => repeat_11<T>;
    <X extends "1">(): <T>(a: T) => repeat_10<T>;
    <X extends "01">(): (_a: PH, n: number) => repeat_01;
    <T>(a: T): repeat_10<T>;
};
...
export type replace_000 = {
    ...
    <X extends "111">(): (pattern: RegExp | Prop, replacement: Prop, str: string) => replace_111;
    <X extends "11">(): (pattern: RegExp | Prop, replacement: Prop) => replace_110;
    <X extends "101">(): (pattern: RegExp | Prop, _replacement: PH, str: string) => replace_101;
    <X extends "1">(): (pattern: RegExp | Prop) => replace_100;
    <X extends "011">(): (_pattern: PH, replacement: Prop, str: string) => replace_011;
    <X extends "01">(): (_pattern: PH, replacement: Prop) => replace_010;
...
export type replace_100 = {
    ...
    <X extends "11">(): (replacement: Prop, str: string) => replace_111;
    <X extends "1">(): (replacement: Prop) => replace_110;
...
export type replace_010 = {
    ...
    <X extends "11">(): (pattern: RegExp | Prop, str: string) => replace_111;
    <X extends "1">(): (pattern: RegExp | Prop) => replace_110;
...
export type replace_001 = {
    ...
    <X extends "11">(): (pattern: RegExp | Prop, replacement: Prop) => replace_111;
    <X extends "1">(): (pattern: RegExp | Prop) => replace_101;
    <X extends "01">(): (_pattern: PH, replacement: Prop) => replace_011;
...
export type scan_000 = {
    ...
    <X extends "111">(): <T, TResult>(fn: (acc: TResult, elem: T) => TResult | Reduced, acc: TResult, list: List<T>) => scan_111<T, TResult>;
    <X extends "11">(): <T, TResult>(fn: (acc: TResult, elem: T) => TResult | Reduced, acc: TResult) => scan_110<T, TResult>;
    <X extends "101">(): <T, TResult>(fn: (acc: TResult, elem: T) => TResult | Reduced, _acc: PH, list: List<T>) => scan_101<T, TResult>;
    <X extends "1">(): <T, TResult>(fn: (acc: TResult, elem: T) => TResult | Reduced) => scan_100<T, TResult>;
    <X extends "011">(): <T, TResult>(_fn: PH, acc: TResult, list: List<T>) => scan_011<T, TResult>;
    <X extends "01">(): <TResult>(_fn: PH, acc: TResult) => scan_010<TResult>;
    <X extends "001">(): <T>(_fn: PH, _acc: PH, list: List<T>) => scan_001<T>;
...
export type scan_100<T, TResult> = {
    ...
    <X extends "11">(): (acc: TResult, list: List<T>) => scan_111<T, TResult>;
    <X extends "1">(): (acc: TResult) => scan_110<T, TResult>;
    <X extends "01">(): (_acc: PH, list: List<T>) => scan_101<T, TResult>;
...
export type scan_010<TResult> = {
    ...
    <X extends "11">(): <T>(fn: (acc: TResult, elem: T) => TResult | Reduced, list: List<T>) => scan_111<T, TResult>;
    <X extends "1">(): <T>(fn: (acc: TResult, elem: T) => TResult | Reduced) => scan_110<T, TResult>;
    <X extends "01">(): <T>(_fn: PH, list: List<T>) => scan_011<T, TResult>;
...
export type scan_001<T> = {
    ...
    <X extends "11">(): <TResult>(fn: (acc: TResult, elem: T) => TResult | Reduced, acc: TResult) => scan_111<T, TResult>;
    <X extends "1">(): <TResult>(fn: (acc: TResult, elem: T) => TResult | Reduced) => scan_101<T, TResult>;
    <X extends "01">(): <TResult>(_fn: PH, acc: TResult) => scan_011<T, TResult>;
...
export type sequence_00 = {
    ...
    <X extends "11", K extends "common_case_of_array_as_traversable">(): <T>(fn: (v: T) => Applicative<T>, traversable: List<Applicative<T>>) => sequence_common_case_of_array_as_traversable_11<T>;
    <X extends "01", K extends "common_case_of_array_as_traversable">(): <T>(_fn: PH, traversable: List<Applicative<T>>) => sequence_common_case_of_array_as_traversable_01<T>;
    <X extends "11", K extends "general_ADT_case_">(): <T>(fn: (v: T) => Applicative<T>, traversable: Traversable<Applicative<T>>) => sequence_general_ADT_case__11<T>;
    <X extends "01", K extends "general_ADT_case_">(): <T>(_fn: PH, traversable: Traversable<Applicative<T>>) => sequence_general_ADT_case__01<T>;
    <X extends "1">(): <T>(fn: (v: T) => Applicative<T>) => sequence_10<T>;
...
export type sequence_10<T> = {
    ...
    <X extends "1", K extends "common_case_of_array_as_traversable">(): (traversable: List<Applicative<T>>) => sequence_common_case_of_array_as_traversable_11<T>;
    <X extends "1", K extends "general_ADT_case_">(): (traversable: Traversable<Applicative<T>>) => sequence_general_ADT_case__11<T>;
...
export type set_000 = {
    ...
    <X extends "111", K extends "base">(): <T, U>(lens: Lens<T, U>, a: U, obj: T) => set_base_111<T, U>;
    <X extends "11", K extends "base">(): <T, U>(lens: Lens<T, U>, a: U) => set_base_110<T, U>;
    <X extends "101", K extends "base">(): <T, U>(lens: Lens<T, U>, _a: PH, obj: T) => set_base_101<T, U>;
    <X extends "1", K extends "base">(): <T, U>(lens: Lens<T, U>) => set_base_100<T, U>;
    <X extends "011", K extends "base">(): <T, U>(_lens: PH, a: U, obj: T) => set_base_011<T, U>;
    <X extends "01", K extends "base">(): <U>(_lens: PH, a: U) => set_base_010<U>;
    <X extends "111", K extends "unknown">(): <T>(lens: UnknownLens, a: any, obj: T) => set_unknown_111<T>;
    <X extends "11", K extends "unknown">(): (lens: UnknownLens, a: any) => set_unknown_110;
    <X extends "101", K extends "unknown">(): <T>(lens: UnknownLens, _a: PH, obj: T) => set_unknown_101<T>;
    <X extends "1", K extends "unknown">(): (lens: UnknownLens) => set_unknown_100;
    <X extends "011", K extends "unknown">(): <T>(_lens: PH, a: any, obj: T) => set_unknown_011<T>;
    <X extends "01", K extends "unknown">(): (_lens: PH, a: any) => set_unknown_010;
    <X extends "001">(): <T>(_lens: PH, _a: PH, obj: T) => set_001<T>;
...
export type set_001<T> = {
    ...
    <X extends "11", K extends "base">(): <U>(lens: Lens<T, U>, a: U) => set_base_111<T, U>;
    <X extends "1", K extends "base">(): <U>(lens: Lens<T, U>) => set_base_101<T, U>;
    <X extends "01", K extends "base">(): <U>(_lens: PH, a: U) => set_base_011<T, U>;
    <X extends "11", K extends "unknown">(): (lens: UnknownLens, a: any) => set_unknown_111<T>;
    <X extends "1", K extends "unknown">(): (lens: UnknownLens) => set_unknown_101<T>;
    <X extends "01", K extends "unknown">(): (_lens: PH, a: any) => set_unknown_011<T>;
    (lens: UnknownLens): set_unknown_101<T>;
};
export type set_base_100<T, U> = {
    (_a: PH, obj: T): set_base_101<T, U>;
    (a: U, obj: T): set_base_111<T, U>;
    <X extends "11">(): (a: U, obj: T) => set_base_111<T, U>;
    <X extends "1">(): (a: U) => set_base_110<T, U>;
    <X extends "01">(): (_a: PH, obj: T) => set_base_101<T, U>;
    (a: U): set_base_110<T, U>;
};
export type set_unknown_100 = {
    <T>(_a: PH, obj: T): set_unknown_101<T>;
    <T>(a: any, obj: T): set_unknown_111<T>;
    <X extends "11">(): <T>(a: any, obj: T) => set_unknown_111<T>;
    <X extends "1">(): (a: any) => set_unknown_110;
    <X extends "01">(): <T>(_a: PH, obj: T) => set_unknown_101<T>;
    (a: any): set_unknown_110;
};
export type set_base_010<U> = {
    <T>(_lens: PH, obj: T): set_base_011<T, U>;
    <T>(lens: Lens<T, U>, obj: T): set_base_111<T, U>;
    <X extends "11">(): <T>(lens: Lens<T, U>, obj: T) => set_base_111<T, U>;
    <X extends "1">(): <T>(lens: Lens<T, U>) => set_base_110<T, U>;
    <X extends "01">(): <T>(_lens: PH, obj: T) => set_base_011<T, U>;
...
export type set_unknown_010 = {
    ...
    <X extends "11">(): <T>(lens: UnknownLens, obj: T) => set_unknown_111<T>;
    <X extends "1">(): (lens: UnknownLens) => set_unknown_110;
    <X extends "01">(): <T>(_lens: PH, obj: T) => set_unknown_011<T>;
...
export type slice_000 = {
    ...
    <X extends "111">(): <T extends List<any>>(a: number, b: number, list: T) => slice_111<T>;
    <X extends "11">(): (a: number, b: number) => slice_110;
    <X extends "101">(): <T extends List<any>>(a: number, _b: PH, list: T) => slice_101<T>;
    <X extends "1">(): (a: number) => slice_100;
    <X extends "011">(): <T extends List<any>>(_a: PH, b: number, list: T) => slice_011<T>;
    <X extends "01">(): (_a: PH, b: number) => slice_010;
    <X extends "001">(): <T extends List<any>>(_a: PH, _b: PH, list: T) => slice_001<T>;
    (a: number): slice_100;
};
export type slice_100 = {
    <T extends List<any>>(_b: PH, list: T): slice_101<T>;
    <T extends List<any>>(b: number, list: T): slice_111<T>;
    <X extends "11">(): <T extends List<any>>(b: number, list: T) => slice_111<T>;
    <X extends "1">(): (b: number) => slice_110;
    <X extends "01">(): <T extends List<any>>(_b: PH, list: T) => slice_101<T>;
    (b: number): slice_110;
};
export type slice_010 = {
    <T extends List<any>>(_a: PH, list: T): slice_011<T>;
    <T extends List<any>>(a: number, list: T): slice_111<T>;
    <X extends "11">(): <T extends List<any>>(a: number, list: T) => slice_111<T>;
    <X extends "1">(): (a: number) => slice_110;
    <X extends "01">(): <T extends List<any>>(_a: PH, list: T) => slice_011<T>;
    (a: number): slice_110;
};
...
export type slice_001<T extends List<any>> = {
    ...
    <X extends "11">(): (a: number, b: number) => slice_111<T>;
    <X extends "1">(): (a: number) => slice_101<T>;
    <X extends "01">(): (_a: PH, b: number) => slice_011<T>;
...
export type sort_00 = {
    ...
    <X extends "11">(): <T>(fn: (a: T, b: T) => number, list: List<T>) => sort_11<T>;
    <X extends "1">(): <T>(fn: (a: T, b: T) => number) => sort_10<T>;
    <X extends "01">(): <T>(_fn: PH, list: List<T>) => sort_01<T>;
...
export type sortBy_00 = {
    ...
    <X extends "11">(): <T>(fn: (a: T) => string, list: List<T>) => sortBy_11<T>;
    <X extends "1">(): <T>(fn: (a: T) => string) => sortBy_10<T>;
    <X extends "01">(): <T>(_fn: PH, list: List<T>) => sortBy_01<T>;
...
export type sortWith_00 = {
    ...
    <X extends "11">(): <T>(comparators: List<((a: T, b: T) => number)>, list: List<T>) => sortWith_11<T>;
    <X extends "1">(): <T>(comparators: List<((a: T, b: T) => number)>) => sortWith_10<T>;
    <X extends "01">(): <T>(_comparators: PH, list: List<T>) => sortWith_01<T>;
...
export type split_00 = {
    ...
    <X extends "11">(): (sep: RegExp | Prop, str: string) => split_11;
    <X extends "1">(): (sep: RegExp | Prop) => split_10;
    <X extends "01">(): (_sep: PH, str: string) => split_01;
...
export type splitAt_00 = {
    ...
    <X extends "11", K extends "string">(): (index: number, list: string) => splitAt_string_11;
    <X extends "01", K extends "string">(): (_index: PH, list: string) => splitAt_string_01;
    <X extends "11", K extends "array">(): <T>(index: number, list: List<T>) => splitAt_array_11<T>;
    <X extends "01", K extends "array">(): <T>(_index: PH, list: List<T>) => splitAt_array_01<T>;
    <X extends "1">(): (index: number) => splitAt_10;
    (index: number): splitAt_10;
};
export type splitAt_10 = {
    (list: string): splitAt_string_11;
    <X extends "1", K extends "string">(): (list: string) => splitAt_string_11;
    <X extends "1", K extends "array">(): <T>(list: List<T>) => splitAt_array_11<T>;
...
export type splitEvery_00 = {
    ...
    <X extends "11">(): <R extends List<T>>(a: number, list: R) => splitEvery_11<R>;
    <X extends "1">(): (a: number) => splitEvery_10;
    <X extends "01">(): <R extends List<T>>(_a: PH, list: R) => splitEvery_01<R>;
...
export type splitWhen_00 = {
    ...
    <X extends "11">(): <T, R extends List<T>>(pred: Pred<T>, list: R) => splitWhen_11<T, R>;
    <X extends "1">(): <T>(pred: Pred<T>) => splitWhen_10<T>;
    <X extends "01">(): <R extends List<T>>(_pred: PH, list: R) => splitWhen_01<R>;
...
export type subtract_00 = {
    ...
    <X extends "11">(): (a: number, b: number) => subtract_11;
    <X extends "1">(): (a: number) => subtract_10;
    <X extends "01">(): (_a: PH, b: number) => subtract_01;
...
export type symmetricDifference_00 = {
    ...
    <X extends "11">(): <T>(list1: List<T>, list2: List<T>) => symmetricDifference_11<T>;
    <X extends "1">(): <T>(list1: List<T>) => symmetricDifference_10<T>;
    <X extends "01">(): <T>(_list1: PH, list2: List<T>) => symmetricDifference_01<T>;
...
export type symmetricDifferenceWith_000 = {
    ...
    <X extends "111">(): <T>(pred: (a: T, b: T) => boolean, list1: List<T>, list2: List<T>) => symmetricDifferenceWith_111<T>;
    <X extends "11">(): <T>(pred: (a: T, b: T) => boolean, list1: List<T>) => symmetricDifferenceWith_110<T>;
    <X extends "101">(): <T>(pred: (a: T, b: T) => boolean, _list1: PH, list2: List<T>) => symmetricDifferenceWith_101<T>;
    <X extends "1">(): <T>(pred: (a: T, b: T) => boolean) => symmetricDifferenceWith_100<T>;
    <X extends "011">(): <T>(_pred: PH, list1: List<T>, list2: List<T>) => symmetricDifferenceWith_011<T>;
    <X extends "01">(): <T>(_pred: PH, list1: List<T>) => symmetricDifferenceWith_010<T>;
    <X extends "001">(): <T>(_pred: PH, _list1: PH, list2: List<T>) => symmetricDifferenceWith_001<T>;
...
export type symmetricDifferenceWith_100<T> = {
    ...
    <X extends "11">(): (list1: List<T>, list2: List<T>) => symmetricDifferenceWith_111<T>;
    <X extends "1">(): (list1: List<T>) => symmetricDifferenceWith_110<T>;
    <X extends "01">(): (_list1: PH, list2: List<T>) => symmetricDifferenceWith_101<T>;
...
export type symmetricDifferenceWith_010<T> = {
    ...
    <X extends "11">(): (pred: (a: T, b: T) => boolean, list2: List<T>) => symmetricDifferenceWith_111<T>;
    <X extends "1">(): (pred: (a: T, b: T) => boolean) => symmetricDifferenceWith_110<T>;
    <X extends "01">(): (_pred: PH, list2: List<T>) => symmetricDifferenceWith_011<T>;
...
export type symmetricDifferenceWith_001<T> = {
    ...
    <X extends "11">(): (pred: (a: T, b: T) => boolean, list1: List<T>) => symmetricDifferenceWith_111<T>;
    <X extends "1">(): (pred: (a: T, b: T) => boolean) => symmetricDifferenceWith_101<T>;
    <X extends "01">(): (_pred: PH, list1: List<T>) => symmetricDifferenceWith_011<T>;
...
export type take_00 = {
    ...
    <X extends "11">(): <T extends List<any>>(n: number, xs: T) => take_11<T>;
    <X extends "1">(): (n: number) => take_10;
    <X extends "01">(): <T extends List<any>>(_n: PH, xs: T) => take_01<T>;
    (n: number): take_10;
};
export type take_10 = {
...
export type takeLast_00 = {
    ...
    <X extends "11">(): <T extends List<any>>(n: number, xs: T) => takeLast_11<T>;
    <X extends "1">(): (n: number) => takeLast_10;
    <X extends "01">(): <T extends List<any>>(_n: PH, xs: T) => takeLast_01<T>;
...
export type takeLastWhile_00 = {
    ...
    <X extends "11">(): <T, R extends List<T>>(pred: Pred<T>, list: R) => takeLastWhile_11<T, R>;
    <X extends "1">(): <T>(pred: Pred<T>) => takeLastWhile_10<T>;
    <X extends "01">(): <R extends List<T>>(_pred: PH, list: R) => takeLastWhile_01<R>;
...
export type takeWhile_00 = {
    ...
    <X extends "11">(): <T, R extends List<T>>(pred: Pred<T>, list: R) => takeWhile_11<T, R>;
    <X extends "1">(): <T>(pred: Pred<T>) => takeWhile_10<T>;
    <X extends "01">(): <R extends List<T>>(_pred: PH, list: R) => takeWhile_01<R>;
...
export type tap_00 = {
    ...
    <X extends "11">(): <T>(fn: (a: T) => any, value: T) => tap_11<T>;
    <X extends "1">(): <T>(fn: (a: T) => any) => tap_10<T>;
    <X extends "01">(): <T>(_fn: PH, value: T) => tap_01<T>;
...
export type test_00 = {
    ...
    <X extends "11">(): (regexp: RegExp, str: Prop) => test_11;
    <X extends "1">(): (regexp: RegExp) => test_10;
    <X extends "01">(): (_regexp: PH, str: Prop) => test_01;
...
export type times_00 = {
    ...
    <X extends "11">(): <T>(fn: (i: number) => T, n: number) => times_11<T>;
    <X extends "1">(): <T>(fn: (i: number) => T) => times_10<T>;
    <X extends "01">(): (_fn: PH, n: number) => times_01;
...
export type toPairsIn_0 = {
    ...
    <X extends "1", K extends "generics">(): <T>(obj: Obj<T>) => toPairsIn_generics_1<T>;
    <X extends "1", K extends "non_generic">(): (obj: Object) => toPairsIn_non_generic_1;
...
export type transduce_0000 = {
    ...
    <X extends "1111">(): <T, U>(xf: (arg: List<T>) => List<T>, fn: (acc: List<U>, val: U) => List<U>, acc: List<T>, list: List<T>) => transduce_1111<T, U>;
    <X extends "111">(): <T, U>(xf: (arg: List<T>) => List<T>, fn: (acc: List<U>, val: U) => List<U>, acc: List<T>) => transduce_1110<T, U>;
    <X extends "1101">(): <T, U>(xf: (arg: List<T>) => List<T>, fn: (acc: List<U>, val: U) => List<U>, _acc: PH, list: List<T>) => transduce_1101<T, U>;
    <X extends "11">(): <T, U>(xf: (arg: List<T>) => List<T>, fn: (acc: List<U>, val: U) => List<U>) => transduce_1100<T, U>;
    <X extends "1011">(): <T>(xf: (arg: List<T>) => List<T>, _fn: PH, acc: List<T>, list: List<T>) => transduce_1011<T>;
    <X extends "101">(): <T>(xf: (arg: List<T>) => List<T>, _fn: PH, acc: List<T>) => transduce_1010<T>;
    <X extends "1001">(): <T>(xf: (arg: List<T>) => List<T>, _fn: PH, _acc: PH, list: List<T>) => transduce_1001<T>;
    <X extends "1">(): <T>(xf: (arg: List<T>) => List<T>) => transduce_1000<T>;
    <X extends "0111">(): <T, U>(_xf: PH, fn: (acc: List<U>, val: U) => List<U>, acc: List<T>, list: List<T>) => transduce_0111<T, U>;
    <X extends "011">(): <T, U>(_xf: PH, fn: (acc: List<U>, val: U) => List<U>, acc: List<T>) => transduce_0110<T, U>;
    <X extends "0101">(): <T, U>(_xf: PH, fn: (acc: List<U>, val: U) => List<U>, _acc: PH, list: List<T>) => transduce_0101<T, U>;
    <X extends "01">(): <U>(_xf: PH, fn: (acc: List<U>, val: U) => List<U>) => transduce_0100<U>;
    <X extends "0011">(): <T>(_xf: PH, _fn: PH, acc: List<T>, list: List<T>) => transduce_0011<T>;
    <X extends "001">(): <T>(_xf: PH, _fn: PH, acc: List<T>) => transduce_0010<T>;
    <X extends "0001">(): <T>(_xf: PH, _fn: PH, _acc: PH, list: List<T>) => transduce_0001<T>;
...
export type transduce_1000<T> = {
    ...
    <X extends "111">(): <U>(fn: (acc: List<U>, val: U) => List<U>, acc: List<T>, list: List<T>) => transduce_1111<T, U>;
    <X extends "11">(): <U>(fn: (acc: List<U>, val: U) => List<U>, acc: List<T>) => transduce_1110<T, U>;
    <X extends "101">(): <U>(fn: (acc: List<U>, val: U) => List<U>, _acc: PH, list: List<T>) => transduce_1101<T, U>;
    <X extends "1">(): <U>(fn: (acc: List<U>, val: U) => List<U>) => transduce_1100<T, U>;
    <X extends "011">(): (_fn: PH, acc: List<T>, list: List<T>) => transduce_1011<T>;
    <X extends "01">(): (_fn: PH, acc: List<T>) => transduce_1010<T>;
    <X extends "001">(): (_fn: PH, _acc: PH, list: List<T>) => transduce_1001<T>;
...
export type transduce_0100<U> = {
    ...
    <X extends "111">(): <T>(xf: (arg: List<T>) => List<T>, acc: List<T>, list: List<T>) => transduce_1111<T, U>;
    <X extends "11">(): <T>(xf: (arg: List<T>) => List<T>, acc: List<T>) => transduce_1110<T, U>;
    <X extends "101">(): <T>(xf: (arg: List<T>) => List<T>, _acc: PH, list: List<T>) => transduce_1101<T, U>;
    <X extends "1">(): <T>(xf: (arg: List<T>) => List<T>) => transduce_1100<T, U>;
    <X extends "011">(): <T>(_xf: PH, acc: List<T>, list: List<T>) => transduce_0111<T, U>;
    <X extends "01">(): <T>(_xf: PH, acc: List<T>) => transduce_0110<T, U>;
    <X extends "001">(): <T>(_xf: PH, _acc: PH, list: List<T>) => transduce_0101<T, U>;
...
export type transduce_1100<T, U> = {
    ...
    <X extends "11">(): (acc: List<T>, list: List<T>) => transduce_1111<T, U>;
    <X extends "1">(): (acc: List<T>) => transduce_1110<T, U>;
    <X extends "01">(): (_acc: PH, list: List<T>) => transduce_1101<T, U>;
...
export type transduce_0010<T> = {
    ...
    <X extends "111">(): <U>(xf: (arg: List<T>) => List<T>, fn: (acc: List<U>, val: U) => List<U>, list: List<T>) => transduce_1111<T, U>;
    <X extends "11">(): <U>(xf: (arg: List<T>) => List<T>, fn: (acc: List<U>, val: U) => List<U>) => transduce_1110<T, U>;
    <X extends "101">(): (xf: (arg: List<T>) => List<T>, _fn: PH, list: List<T>) => transduce_1011<T>;
    <X extends "1">(): (xf: (arg: List<T>) => List<T>) => transduce_1010<T>;
    <X extends "011">(): <U>(_xf: PH, fn: (acc: List<U>, val: U) => List<U>, list: List<T>) => transduce_0111<T, U>;
    <X extends "01">(): <U>(_xf: PH, fn: (acc: List<U>, val: U) => List<U>) => transduce_0110<T, U>;
    <X extends "001">(): (_xf: PH, _fn: PH, list: List<T>) => transduce_0011<T>;
...
export type transduce_1010<T> = {
    ...
    <X extends "11">(): <U>(fn: (acc: List<U>, val: U) => List<U>, list: List<T>) => transduce_1111<T, U>;
    <X extends "1">(): <U>(fn: (acc: List<U>, val: U) => List<U>) => transduce_1110<T, U>;
    <X extends "01">(): (_fn: PH, list: List<T>) => transduce_1011<T>;
...
export type transduce_0110<T, U> = {
    ...
    <X extends "11">(): (xf: (arg: List<T>) => List<T>, list: List<T>) => transduce_1111<T, U>;
    <X extends "1">(): (xf: (arg: List<T>) => List<T>) => transduce_1110<T, U>;
    <X extends "01">(): (_xf: PH, list: List<T>) => transduce_0111<T, U>;
...
export type transduce_0001<T> = {
    ...
    <X extends "111">(): <U>(xf: (arg: List<T>) => List<T>, fn: (acc: List<U>, val: U) => List<U>, acc: List<T>) => transduce_1111<T, U>;
    <X extends "11">(): <U>(xf: (arg: List<T>) => List<T>, fn: (acc: List<U>, val: U) => List<U>) => transduce_1101<T, U>;
    <X extends "101">(): (xf: (arg: List<T>) => List<T>, _fn: PH, acc: List<T>) => transduce_1011<T>;
    <X extends "1">(): (xf: (arg: List<T>) => List<T>) => transduce_1001<T>;
    <X extends "011">(): <U>(_xf: PH, fn: (acc: List<U>, val: U) => List<U>, acc: List<T>) => transduce_0111<T, U>;
    <X extends "01">(): <U>(_xf: PH, fn: (acc: List<U>, val: U) => List<U>) => transduce_0101<T, U>;
    <X extends "001">(): (_xf: PH, _fn: PH, acc: List<T>) => transduce_0011<T>;
...
export type transduce_1001<T> = {
    ...
    <X extends "11">(): <U>(fn: (acc: List<U>, val: U) => List<U>, acc: List<T>) => transduce_1111<T, U>;
    <X extends "1">(): <U>(fn: (acc: List<U>, val: U) => List<U>) => transduce_1101<T, U>;
    <X extends "01">(): (_fn: PH, acc: List<T>) => transduce_1011<T>;
...
export type transduce_0101<T, U> = {
    ...
    <X extends "11">(): (xf: (arg: List<T>) => List<T>, acc: List<T>) => transduce_1111<T, U>;
    <X extends "1">(): (xf: (arg: List<T>) => List<T>) => transduce_1101<T, U>;
    <X extends "01">(): (_xf: PH, acc: List<T>) => transduce_0111<T, U>;
...
export type transduce_0011<T> = {
    ...
    <X extends "11">(): <U>(xf: (arg: List<T>) => List<T>, fn: (acc: List<U>, val: U) => List<U>) => transduce_1111<T, U>;
    <X extends "1">(): (xf: (arg: List<T>) => List<T>) => transduce_1011<T>;
    <X extends "01">(): <U>(_xf: PH, fn: (acc: List<U>, val: U) => List<U>) => transduce_0111<T, U>;
...
export type transpose_0 = {
    ...
    <X extends "1", K extends "generics_1">(): <T>(list: List<List<T>>) => transpose_generics_1_1<T>;
    <X extends "1", K extends "generics_2">(): (list: List<List<any>>) => transpose_generics_2_1;
...
export type traverse_000 = {
    ...
    <X extends "111", K extends "base">(): <T, U>(ap: (v: T) => Applicative<T>, fn: (v: T) => Applicative<U>, traversable: List<T>) => traverse_base_111<T, U>;
    <X extends "111", K extends "general_ADT_case">(): <T, U>(ap: (v: T) => Applicative<T>, fn: (v: T) => Applicative<U>, traversable: List<T>) => traverse_general_ADT_case_111<T, U>;
    <X extends "11">(): <T, U>(ap: (v: T) => Applicative<T>, fn: (v: T) => Applicative<U>) => traverse_110<T, U>;
    <X extends "101">(): <T>(ap: (v: T) => Applicative<T>, _fn: PH, traversable: List<T>) => traverse_101<T>;
    <X extends "1">(): <T>(ap: (v: T) => Applicative<T>) => traverse_100<T>;
    <X extends "011">(): <T, U>(_ap: PH, fn: (v: T) => Applicative<U>, traversable: List<T>) => traverse_011<T, U>;
    <X extends "01">(): <T, U>(_ap: PH, fn: (v: T) => Applicative<U>) => traverse_010<T, U>;
    <X extends "001">(): <T>(_ap: PH, _fn: PH, traversable: List<T>) => traverse_001<T>;
...
export type traverse_100<T> = {
    ...
    <X extends "11", K extends "base">(): <U>(fn: (v: T) => Applicative<U>, traversable: List<T>) => traverse_base_111<T, U>;
    <X extends "11", K extends "general_ADT_case">(): <U>(fn: (v: T) => Applicative<U>, traversable: List<T>) => traverse_general_ADT_case_111<T, U>;
    <X extends "1">(): <U>(fn: (v: T) => Applicative<U>) => traverse_110<T, U>;
    <X extends "01">(): (_fn: PH, traversable: List<T>) => traverse_101<T>;
...
export type traverse_010<T, U> = {
    ...
    <X extends "11", K extends "base">(): (ap: (v: T) => Applicative<T>, traversable: List<T>) => traverse_base_111<T, U>;
    <X extends "11", K extends "general_ADT_case">(): (ap: (v: T) => Applicative<T>, traversable: List<T>) => traverse_general_ADT_case_111<T, U>;
    <X extends "1">(): (ap: (v: T) => Applicative<T>) => traverse_110<T, U>;
    <X extends "01">(): (_ap: PH, traversable: List<T>) => traverse_011<T, U>;
    (ap: (v: T) => Applicative<T>): traverse_110<T, U>;
};
export type traverse_110<T, U> = {
    (traversable: List<T>): traverse_base_111<T, U>;
    <X extends "1", K extends "base">(): (traversable: List<T>) => traverse_base_111<T, U>;
    <X extends "1", K extends "general_ADT_case">(): (traversable: List<T>) => traverse_general_ADT_case_111<T, U>;
...
export type traverse_001<T> = {
    ...
    <X extends "11", K extends "base">(): <U>(ap: (v: T) => Applicative<T>, fn: (v: T) => Applicative<U>) => traverse_base_111<T, U>;
    <X extends "11", K extends "general_ADT_case">(): <U>(ap: (v: T) => Applicative<T>, fn: (v: T) => Applicative<U>) => traverse_general_ADT_case_111<T, U>;
    <X extends "1">(): (ap: (v: T) => Applicative<T>) => traverse_101<T>;
    <X extends "01">(): <U>(_ap: PH, fn: (v: T) => Applicative<U>) => traverse_011<T, U>;
    (ap: (v: T) => Applicative<T>): traverse_101<T>;
};
export type traverse_101<T> = {
    <U>(fn: (v: T) => Applicative<U>): traverse_base_111<T, U>;
    <X extends "1", K extends "base">(): <U>(fn: (v: T) => Applicative<U>) => traverse_base_111<T, U>;
    <X extends "1", K extends "general_ADT_case">(): <U>(fn: (v: T) => Applicative<U>) => traverse_general_ADT_case_111<T, U>;
...
export type traverse_011<T, U> = {
    ...
    <X extends "1", K extends "base">(): (ap: (v: T) => Applicative<T>) => traverse_base_111<T, U>;
    <X extends "1", K extends "general_ADT_case">(): (ap: (v: T) => Applicative<T>) => traverse_general_ADT_case_111<T, U>;
...
export type tryCatch_00 = {
    ...
    <X extends "11">(): <T>(tryer: Variadic<T>, catcher: Variadic<T>) => tryCatch_11<T>;
    <X extends "1">(): <T>(tryer: Variadic<T>) => tryCatch_10<T>;
    <X extends "01">(): <T>(_tryer: PH, catcher: Variadic<T>) => tryCatch_01<T>;
...
export type uncurryN_00 = {
    ...
    <X extends "11">(): (len: number, fn: (a: any) => any) => uncurryN_11;
    <X extends "1">(): (len: number) => uncurryN_10;
    <X extends "01">(): (_len: PH, fn: (a: any) => any) => uncurryN_01;
...
export type unfold_00 = {
    ...
    <X extends "11">(): <T, TResult>(fn: (seed: T) => [TResult, T] | false, seed: T) => unfold_11<T, TResult>;
    <X extends "1">(): <T, TResult>(fn: (seed: T) => [TResult, T] | false) => unfold_10<T, TResult>;
    <X extends "01">(): <T>(_fn: PH, seed: T) => unfold_01<T>;
...
export type union_00 = {
    ...
    <X extends "11">(): <T>(as: List<T>, bs: List<T>) => union_11<T>;
    <X extends "1">(): <T>(as: List<T>) => union_10<T>;
    <X extends "01">(): <T>(_as: PH, bs: List<T>) => union_01<T>;
...
export type unionWith_000 = {
    ...
    <X extends "111">(): <T>(pred: (a: T, b: T) => boolean, list1: List<T>, list2: List<T>) => unionWith_111<T>;
    <X extends "11">(): <T>(pred: (a: T, b: T) => boolean, list1: List<T>) => unionWith_110<T>;
    <X extends "101">(): <T>(pred: (a: T, b: T) => boolean, _list1: PH, list2: List<T>) => unionWith_101<T>;
    <X extends "1">(): <T>(pred: (a: T, b: T) => boolean) => unionWith_100<T>;
    <X extends "011">(): <T>(_pred: PH, list1: List<T>, list2: List<T>) => unionWith_011<T>;
    <X extends "01">(): <T>(_pred: PH, list1: List<T>) => unionWith_010<T>;
    <X extends "001">(): <T>(_pred: PH, _list1: PH, list2: List<T>) => unionWith_001<T>;
...
export type unionWith_100<T> = {
    ...
    <X extends "11">(): (list1: List<T>, list2: List<T>) => unionWith_111<T>;
    <X extends "1">(): (list1: List<T>) => unionWith_110<T>;
    <X extends "01">(): (_list1: PH, list2: List<T>) => unionWith_101<T>;
...
export type unionWith_010<T> = {
    ...
    <X extends "11">(): (pred: (a: T, b: T) => boolean, list2: List<T>) => unionWith_111<T>;
    <X extends "1">(): (pred: (a: T, b: T) => boolean) => unionWith_110<T>;
    <X extends "01">(): (_pred: PH, list2: List<T>) => unionWith_011<T>;
...
export type unionWith_001<T> = {
    ...
    <X extends "11">(): (pred: (a: T, b: T) => boolean, list1: List<T>) => unionWith_111<T>;
    <X extends "1">(): (pred: (a: T, b: T) => boolean) => unionWith_101<T>;
    <X extends "01">(): (_pred: PH, list1: List<T>) => unionWith_011<T>;
...
export type uniqBy_00 = {
    ...
    <X extends "11">(): <T, U>(fn: (a: T) => U, list: List<T>) => uniqBy_11<T, U>;
    <X extends "1">(): <T, U>(fn: (a: T) => U) => uniqBy_10<T, U>;
    <X extends "01">(): <T>(_fn: PH, list: List<T>) => uniqBy_01<T>;
...
export type uniqWith_00 = {
    ...
    <X extends "11">(): <T>(pred: (x: T, y: T) => boolean, list: List<T>) => uniqWith_11<T>;
    <X extends "1">(): <T>(pred: (x: T, y: T) => boolean) => uniqWith_10<T>;
    <X extends "01">(): <T>(_pred: PH, list: List<T>) => uniqWith_01<T>;
...
export type unless_000 = {
    ...
    <X extends "111">(): <T, U>(pred: Pred<T>, whenFalseFn: (a: T) => U, obj: T) => unless_111<T, U>;
    <X extends "11">(): <T, U>(pred: Pred<T>, whenFalseFn: (a: T) => U) => unless_110<T, U>;
    <X extends "101">(): <T>(pred: Pred<T>, _whenFalseFn: PH, obj: T) => unless_101<T>;
    <X extends "1">(): <T>(pred: Pred<T>) => unless_100<T>;
    <X extends "011">(): <T, U>(_pred: PH, whenFalseFn: (a: T) => U, obj: T) => unless_011<T, U>;
    <X extends "01">(): <T, U>(_pred: PH, whenFalseFn: (a: T) => U) => unless_010<T, U>;
    <X extends "001">(): <T>(_pred: PH, _whenFalseFn: PH, obj: T) => unless_001<T>;
...
export type unless_100<T> = {
    ...
    <X extends "11">(): <U>(whenFalseFn: (a: T) => U, obj: T) => unless_111<T, U>;
    <X extends "1">(): <U>(whenFalseFn: (a: T) => U) => unless_110<T, U>;
    <X extends "01">(): (_whenFalseFn: PH, obj: T) => unless_101<T>;
...
export type unless_010<T, U> = {
    ...
    <X extends "11">(): (pred: Pred<T>, obj: T) => unless_111<T, U>;
    <X extends "1">(): (pred: Pred<T>) => unless_110<T, U>;
    <X extends "01">(): (_pred: PH, obj: T) => unless_011<T, U>;
...
export type unless_001<T> = {
    ...
    <X extends "11">(): <U>(pred: Pred<T>, whenFalseFn: (a: T) => U) => unless_111<T, U>;
    <X extends "1">(): (pred: Pred<T>) => unless_101<T>;
    <X extends "01">(): <U>(_pred: PH, whenFalseFn: (a: T) => U) => unless_011<T, U>;
...
export type until_000 = {
    ...
    <X extends "111">(): <T, U>(pred: Pred<T>, fn: (val: T) => U, init: U) => until_111<T, U>;
    <X extends "11">(): <T, U>(pred: Pred<T>, fn: (val: T) => U) => until_110<T, U>;
    <X extends "101">(): <T, U>(pred: Pred<T>, _fn: PH, init: U) => until_101<T, U>;
    <X extends "1">(): <T>(pred: Pred<T>) => until_100<T>;
    <X extends "011">(): <T, U>(_pred: PH, fn: (val: T) => U, init: U) => until_011<T, U>;
    <X extends "01">(): <T, U>(_pred: PH, fn: (val: T) => U) => until_010<T, U>;
    <X extends "001">(): <U>(_pred: PH, _fn: PH, init: U) => until_001<U>;
    <T>(pred: Pred<T>): until_100<T>;
};
export type until_100<T> = {
    <U>(_fn: PH, init: U): until_101<T, U>;
    <U>(fn: (val: T) => U, init: U): until_111<T, U>;
    <X extends "11">(): <U>(fn: (val: T) => U, init: U) => until_111<T, U>;
    <X extends "1">(): <U>(fn: (val: T) => U) => until_110<T, U>;
    <X extends "01">(): <U>(_fn: PH, init: U) => until_101<T, U>;
    <U>(fn: (val: T) => U): until_110<T, U>;
};
export type until_010<T, U> = {
    (_pred: PH, init: U): until_011<T, U>;
    (pred: Pred<T>, init: U): until_111<T, U>;
    <X extends "11">(): (pred: Pred<T>, init: U) => until_111<T, U>;
    <X extends "1">(): (pred: Pred<T>) => until_110<T, U>;
    <X extends "01">(): (_pred: PH, init: U) => until_011<T, U>;
...
export type until_001<U> = {
    ...
    <X extends "11">(): <T>(pred: Pred<T>, fn: (val: T) => U) => until_111<T, U>;
    <X extends "1">(): <T>(pred: Pred<T>) => until_101<T, U>;
    <X extends "01">(): <T>(_pred: PH, fn: (val: T) => U) => until_011<T, U>;
...
export type update_000 = {
    ...
    <X extends "111">(): <T>(index: number, value: T, list: List<T>) => update_111<T>;
    <X extends "11">(): <T>(index: number, value: T) => update_110<T>;
    <X extends "101">(): <T>(index: number, _value: PH, list: List<T>) => update_101<T>;
    <X extends "1">(): (index: number) => update_100;
    <X extends "011">(): <T>(_index: PH, value: T, list: List<T>) => update_011<T>;
    <X extends "01">(): <T>(_index: PH, value: T) => update_010<T>;
    <X extends "001">(): <T>(_index: PH, _value: PH, list: List<T>) => update_001<T>;
    (index: number): update_100;
};
export type update_100 = {
    <T>(_value: PH, list: List<T>): update_101<T>;
    <T>(value: T, list: List<T>): update_111<T>;
    <X extends "11">(): <T>(value: T, list: List<T>) => update_111<T>;
    <X extends "1">(): <T>(value: T) => update_110<T>;
    <X extends "01">(): <T>(_value: PH, list: List<T>) => update_101<T>;
    <T>(value: T): update_110<T>;
};
export type update_010<T> = {
    (_index: PH, list: List<T>): update_011<T>;
    (index: number, list: List<T>): update_111<T>;
    <X extends "11">(): (index: number, list: List<T>) => update_111<T>;
    <X extends "1">(): (index: number) => update_110<T>;
    <X extends "01">(): (_index: PH, list: List<T>) => update_011<T>;
...
export type update_001<T> = {
    ...
    <X extends "11">(): (index: number, value: T) => update_111<T>;
    <X extends "1">(): (index: number) => update_101<T>;
    <X extends "01">(): (_index: PH, value: T) => update_011<T>;
...
export type useWith_00 = {
    ...
    <X extends "11">(): <T>(fn: Variadic<T>, transformers: List<Function>) => useWith_11<T>;
    <X extends "1">(): <T>(fn: Variadic<T>) => useWith_10<T>;
    <X extends "01">(): (_fn: PH, transformers: List<Function>) => useWith_01;
...
export type values_0 = {
    ...
    <X extends "1", K extends "Struct">(): <T>(obj: Struct<T>) => values_Struct_1<T>;
    <X extends "1", K extends "Object">(): (obj: Object) => values_Object_1;
...
export type valuesIn_0 = {
    ...
    <X extends "1", K extends "Struct">(): <T>(obj: Struct<T>) => valuesIn_Struct_1<T>;
    <X extends "1", K extends "Object">(): (obj: Object) => valuesIn_Object_1;
...
export type view_00 = {
    ...
    <X extends "11", K extends "smart_approach__unreliable">(): <T, U>(lens: Lens<T, U>, obj: T) => view_smart_approach__unreliable_11<T, U>;
    <X extends "1", K extends "smart_approach__unreliable">(): <T, U>(lens: Lens<T, U>) => view_smart_approach__unreliable_10<T, U>;
    <X extends "01", K extends "smart_approach__unreliable">(): <T>(_lens: PH, obj: T) => view_smart_approach__unreliable_01<T>;
    <X extends "11", K extends "lens_with_type_manually_set">(): <T>(lens: ManualLens<T>, obj: Struct<any>) => view_lens_with_type_manually_set_11<T>;
    <X extends "1", K extends "lens_with_type_manually_set">(): <T>(lens: ManualLens<T>) => view_lens_with_type_manually_set_10<T>;
    <X extends "01", K extends "lens_with_type_manually_set">(): (_lens: PH, obj: Struct<any>) => view_lens_with_type_manually_set_01;
    <X extends "11", K extends "unknown_lens__manually_supply_return_type__does_this_add_to_the_above_case_">(): (lens: UnknownLens, obj: Struct<any>) => view_unknown_lens__manually_supply_return_type__does_this_add_to_the_above_case__11;
    <X extends "1", K extends "unknown_lens__manually_supply_return_type__does_this_add_to_the_above_case_">(): (lens: UnknownLens) => view_unknown_lens__manually_supply_return_type__does_this_add_to_the_above_case__10;
    <X extends "01", K extends "unknown_lens__manually_supply_return_type__does_this_add_to_the_above_case_">(): (_lens: PH, obj: Struct<any>) => view_unknown_lens__manually_supply_return_type__does_this_add_to_the_above_case__01;
...
export type when_000 = {
    ...
    <X extends "111">(): <T, U>(pred: Pred<T>, whenTrueFn: (a: T) => U, obj: T) => when_111<T, U>;
    <X extends "11">(): <T, U>(pred: Pred<T>, whenTrueFn: (a: T) => U) => when_110<T, U>;
    <X extends "101">(): <T>(pred: Pred<T>, _whenTrueFn: PH, obj: T) => when_101<T>;
    <X extends "1">(): <T>(pred: Pred<T>) => when_100<T>;
    <X extends "011">(): <T, U>(_pred: PH, whenTrueFn: (a: T) => U, obj: T) => when_011<T, U>;
    <X extends "01">(): <T, U>(_pred: PH, whenTrueFn: (a: T) => U) => when_010<T, U>;
    <X extends "001">(): <T>(_pred: PH, _whenTrueFn: PH, obj: T) => when_001<T>;
    <T>(pred: Pred<T>): when_100<T>;
};
export type when_100<T> = {
    (_whenTrueFn: PH, obj: T): when_101<T>;
    <U>(whenTrueFn: (a: T) => U, obj: T): when_111<T, U>;
    <X extends "11">(): <U>(whenTrueFn: (a: T) => U, obj: T) => when_111<T, U>;
    <X extends "1">(): <U>(whenTrueFn: (a: T) => U) => when_110<T, U>;
    <X extends "01">(): (_whenTrueFn: PH, obj: T) => when_101<T>;
    <U>(whenTrueFn: (a: T) => U): when_110<T, U>;
};
export type when_010<T, U> = {
    (_pred: PH, obj: T): when_011<T, U>;
    (pred: Pred<T>, obj: T): when_111<T, U>;
    <X extends "11">(): (pred: Pred<T>, obj: T) => when_111<T, U>;
    <X extends "1">(): (pred: Pred<T>) => when_110<T, U>;
    <X extends "01">(): (_pred: PH, obj: T) => when_011<T, U>;
...
export type when_001<T> = {
    ...
    <X extends "11">(): <U>(pred: Pred<T>, whenTrueFn: (a: T) => U) => when_111<T, U>;
    <X extends "1">(): (pred: Pred<T>) => when_101<T>;
    <X extends "01">(): <U>(_pred: PH, whenTrueFn: (a: T) => U) => when_011<T, U>;
...
export type where_00 = {
    ...
    <X extends "11", K extends "heterogeneous_version">(): <T extends Obj<any>>(spec: {
            [P in keyof K]?: Pred<T[P]>;
        }, testObj: T) => where_heterogeneous_version_11<T>;
    <X extends "1", K extends "heterogeneous_version">(): <T extends Obj<any>>(spec: {
            [P in keyof K]?: Pred<T[P]>;
        }) => where_heterogeneous_version_10<T>;
    <X extends "01", K extends "heterogeneous_version">(): <T extends Obj<any>>(_spec: PH, testObj: T) => where_heterogeneous_version_01<T>;
    <X extends "11", K extends "homogeneous_version">(): <T>(spec: Obj<Pred<T>>, testObj: Obj<T>) => where_homogeneous_version_11<T>;
    <X extends "1", K extends "homogeneous_version">(): <T>(spec: Obj<Pred<T>>) => where_homogeneous_version_10<T>;
    <X extends "01", K extends "homogeneous_version">(): <T>(_spec: PH, testObj: Obj<T>) => where_homogeneous_version_01<T>;
    <X extends "11", K extends "DIY__fill_in_the_type_params_yourself__version">(): <T, U>(spec: T, testObj: U) => where_DIY__fill_in_the_type_params_yourself__version_11<T, U>;
    <X extends "1", K extends "DIY__fill_in_the_type_params_yourself__version">(): <T>(spec: T) => where_DIY__fill_in_the_type_params_yourself__version_10<T>;
    <X extends "01", K extends "DIY__fill_in_the_type_params_yourself__version">(): <U>(_spec: PH, testObj: U) => where_DIY__fill_in_the_type_params_yourself__version_01<U>;
...
export type whereEq_00 = {
    ...
    <X extends "11", K extends "heterogeneous_version">(): <T extends Obj<any>>(spec: Partial<T>, testObj: T) => whereEq_heterogeneous_version_11<T>;
    <X extends "1", K extends "heterogeneous_version">(): <T extends Obj<any>>(spec: Partial<T>) => whereEq_heterogeneous_version_10<T>;
    <X extends "01", K extends "heterogeneous_version">(): <T extends Obj<any>>(_spec: PH, testObj: T) => whereEq_heterogeneous_version_01<T>;
    <X extends "11", K extends "homogeneous_version">(): <T>(spec: Obj<T>, testObj: Obj<T>) => whereEq_homogeneous_version_11<T>;
    <X extends "1", K extends "homogeneous_version">(): <T>(spec: Obj<T>) => whereEq_homogeneous_version_10<T>;
    <X extends "01", K extends "homogeneous_version">(): <T>(_spec: PH, testObj: Obj<T>) => whereEq_homogeneous_version_01<T>;
    <X extends "11", K extends "DIY__fill_in_the_type_params_yourself__version">(): <T, U>(spec: T, testObj: U) => whereEq_DIY__fill_in_the_type_params_yourself__version_11<T, U>;
    <X extends "1", K extends "DIY__fill_in_the_type_params_yourself__version">(): <T>(spec: T) => whereEq_DIY__fill_in_the_type_params_yourself__version_10<T>;
    <X extends "01", K extends "DIY__fill_in_the_type_params_yourself__version">(): <U>(_spec: PH, testObj: U) => whereEq_DIY__fill_in_the_type_params_yourself__version_01<U>;
...
export type without_00 = {
    ...
    <X extends "11">(): <T>(list1: List<T>, list2: List<T>) => without_11<T>;
    <X extends "1">(): <T>(list1: List<T>) => without_10<T>;
    <X extends "01">(): <T>(_list1: PH, list2: List<T>) => without_01<T>;
...
export type xprod_00 = {
    ...
    <X extends "11">(): <K, V>(as: List<K>, bs: List<V>) => xprod_11<K, V>;
    <X extends "1">(): <K>(as: List<K>) => xprod_10<K>;
    <X extends "01">(): <V>(_as: PH, bs: List<V>) => xprod_01<V>;
...
export type zip_00 = {
    ...
    <X extends "11">(): <K, V>(list1: List<K>, list2: List<V>) => zip_11<K, V>;
    <X extends "1">(): <K>(list1: List<K>) => zip_10<K>;
    <X extends "01">(): <V>(_list1: PH, list2: List<V>) => zip_01<V>;
...
export type zipObj_00 = {
    ...
    <X extends "11">(): <T>(keys: List<Prop>, values: List<T>) => zipObj_11<T>;
    <X extends "1">(): (keys: List<Prop>) => zipObj_10;
    <X extends "01">(): <T>(_keys: PH, values: List<T>) => zipObj_01<T>;
...
export type zipWith_000 = {
    ...
    <X extends "111">(): <T, U, TResult>(fn: (x: T, y: U) => TResult, list1: List<T>, list2: List<U>) => zipWith_111<T, U, TResult>;
    <X extends "11">(): <T, U, TResult>(fn: (x: T, y: U) => TResult, list1: List<T>) => zipWith_110<T, U, TResult>;
    <X extends "101">(): <T, U, TResult>(fn: (x: T, y: U) => TResult, _list1: PH, list2: List<U>) => zipWith_101<T, U, TResult>;
    <X extends "1">(): <T, U, TResult>(fn: (x: T, y: U) => TResult) => zipWith_100<T, U, TResult>;
    <X extends "011">(): <T, U>(_fn: PH, list1: List<T>, list2: List<U>) => zipWith_011<T, U>;
    <X extends "01">(): <T>(_fn: PH, list1: List<T>) => zipWith_010<T>;
    <X extends "001">(): <U>(_fn: PH, _list1: PH, list2: List<U>) => zipWith_001<U>;
...
export type zipWith_100<T, U, TResult> = {
    ...
    <X extends "11">(): (list1: List<T>, list2: List<U>) => zipWith_111<T, U, TResult>;
    <X extends "1">(): (list1: List<T>) => zipWith_110<T, U, TResult>;
    <X extends "01">(): (_list1: PH, list2: List<U>) => zipWith_101<T, U, TResult>;
...
export type zipWith_010<T> = {
    ...
    <X extends "11">(): <U, TResult>(fn: (x: T, y: U) => TResult, list2: List<U>) => zipWith_111<T, U, TResult>;
    <X extends "1">(): <U, TResult>(fn: (x: T, y: U) => TResult) => zipWith_110<T, U, TResult>;
    <X extends "01">(): <U>(_fn: PH, list2: List<U>) => zipWith_011<T, U>;
...
export type zipWith_001<U> = {
    ...
    <X extends "11">(): <T, TResult>(fn: (x: T, y: U) => TResult, list1: List<T>) => zipWith_111<T, U, TResult>;
    <X extends "1">(): <T, TResult>(fn: (x: T, y: U) => TResult) => zipWith_101<T, U, TResult>;
    <X extends "01">(): <T>(_fn: PH, list1: List<T>) => zipWith_011<T, U>;
