...
export type flip_0 = {
    <T1, T2, R>(fn: (v1: T1, v2: T2) => R): flip_2_1<T1, T2, R>;
    <T1, T2, T3, R>(fn: (v1: T1, v2: T2, v3: T3) => R): flip_3_1<T1, T2, T3, R>;
    <T1, T2, T3, T4, R>(fn: (v1: T1, v2: T2, v3: T3, v4: T4) => R): flip_4_1<T1, T2, T3, T4, R>;
    <T1, T2, T3, T4, T5, R>(fn: (v1: T1, v2: T2, v3: T3, v4: T4, v5: T5) => R): flip_5_1<T1, T2, T3, T4, T5, R>;
    <X extends "1", K extends "2">(): <T1, T2, R>(fn: (v1: T1, v2: T2) => R) => flip_2_1<T1, T2, R>;
    <X extends "1", K extends "3">(): <T1, T2, T3, R>(fn: (v1: T1, v2: T2, v3: T3) => R) => flip_3_1<T1, T2, T3, R>;
    <X extends "1", K extends "4">(): <T1, T2, T3, T4, R>(fn: (v1: T1, v2: T2, v3: T3, v4: T4) => R) => flip_4_1<T1, T2, T3, T4, R>;
    <X extends "1", K extends "5">(): <T1, T2, T3, T4, T5, R>(fn: (v1: T1, v2: T2, v3: T3, v4: T4, v5: T5) => R) => flip_5_1<T1, T2, T3, T4, T5, R>;
    <X extends "1", K extends "6">(): <T1, T2, T3, T4, T5, T6, R>(fn: (v1: T1, v2: T2, v3: T3, v4: T4, v5: T5, v6: T6) => R) => flip_6_1<T1, T2, T3, T4, T5, T6, R>;
    <T1, T2, T3, T4, T5, T6, R>(fn: (v1: T1, v2: T2, v3: T3, v4: T4, v5: T5, v6: T6) => R): flip_6_1<T1, T2, T3, T4, T5, T6, R>;
};
export type flip_2_1<T1, T2, R> = CurriedFunction2<T2, T1, R>;
export type flip_3_1<T1, T2, T3, R> = CurriedFunction3<T2, T1, T3, R>;
export type flip_4_1<T1, T2, T3, T4, R> = CurriedFunction4<T2, T1, T3, T4, R>;
export type flip_5_1<T1, T2, T3, T4, T5, R> = CurriedFunction5<T2, T1, T3, T4, T5, R>;
export type flip_6_1<T1, T2, T3, T4, T5, T6, R> = CurriedFunction6<T2, T1, T3, T4, T5, T6, R>;
/**
