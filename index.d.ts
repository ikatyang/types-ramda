...
export { __, add, addIndex, adjust, all, allPass, always, and, any, anyPass, ap, aperture, append, apply, applySpec, ascend, assoc, assocPath, binary, bind, both, call, clamp, dec, descend, divide, inc, map, mathMod, mean, median, modulo, multiply, nAry, negate, or, prepend, product, subtract, sum, unary };
