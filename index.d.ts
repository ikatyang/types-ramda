...
export { __, add, addIndex, adjust, all, allPass, always, and, any, anyPass, ap, aperture, append, apply, applySpec, ascend, assoc, assocPath, binary, bind, both, call, clamp, clone, comparator, complement, concat, cond, contains, countBy, dec, defaultTo, descend, difference, differenceWith, dissoc, dissocPath, divide, drop, dropLast, dropLastWhile, dropRepeats, dropRepeatsWith, dropWhile, inc, intersection, intersectionWith, map, mathMod, mean, median, modulo, multiply, nAry, negate, or, prepend, product, subtract, sum, symmetricDifference, symmetricDifferenceWith, take, takeLast, takeLastWhile, takeWhile, unary, union, unionWith };
