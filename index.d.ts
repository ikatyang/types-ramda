...
export { __, add, addIndex, adjust, all, allPass, always, and, any, anyPass, ap, aperture, append, apply, applySpec, ascend, assoc, assocPath, binary, bind, both, call, dec, descend, divide, inc, map, mathMod, modulo, multiply, nAry, or, prepend, subtract, unary };
